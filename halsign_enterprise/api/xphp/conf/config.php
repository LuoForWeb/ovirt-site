...
(
		...
		/*系统信息*/
		'SYSTEM_INFO' => array(
		    'system_name' => 'Halsign backup and recovery system',
		    'company' => 'Halsign Co. Ltd.',
		    'copyright' => 'Copyright',
		    'years' => '2019',
		    'version' => 'vStorage: V5.2  @version@',                         //软件版本号
		    'enterprise' => '@enterprise@',                   //软件版本     
		    
		    //授权处使用
		    'company_name' => '北京红山世纪科技有限公司',               
		    'company_tel' => '400-1020-696',
		    'company_email' => '----',
		),
    
        //远程地址
        'REMOTE' => array(
            'website' => "http://www.halsign.com/",
