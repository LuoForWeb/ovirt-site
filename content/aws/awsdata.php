...
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="backupdata-wrapper" id="aws-data">
    <div class="backupdata-wrapper__head">
        <i class="levelchild viconfont vicon-vmdata"></i>
        <span class="backupdata-wrapper__head__title"><?php echo $LANG['UI_DATA_AWS'] ?></span>
    </div>
    ...
    <div class="backupdata-wrapper__content row">
        <div class="col-md-4 timepoint-wrapper">
            <div class="timepoint-wrapper__head">
                ...
                <span class="timepoint-wrapper__head__title"><?php echo $LANG['UI_DATA_INSTANCE_JOB'] ?></span>
            </div>
            <div class="timepoint-wrapper__content">
                ...
                <div class="timepoint-wrapper__content__tree tree-wrapper">
                                ...
                                <div class="portlet-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label style="padding-right: 20px;">
                                                    <input type="checkbox" name="weekFilter" class="icheck">
                                                    <i class="viconfont vicon-remark-week"></i>
                                                    <?php echo $LANG['WEB_VM_GFS_WEEK_POINT']?>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="margin-top: 10px;">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label style="padding-right: 20px;">
                                                    <input type="checkbox" name="monthFilter" class="icheck">
                                                    <i class="viconfont vicon-remark-month"></i>
                                                    <?php echo $LANG['WEB_VM_GFS_MONTH_POINT']?>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="margin-top: 10px;">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label style="padding-right: 20px;">
                                                    <input type="checkbox" name="yearFilter" class="icheck">
                                                    <i class="viconfont vicon-remark-year"></i>
                                                    <?php echo $LANG['WEB_VM_GFS_YEAR_POINT']?>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="tree-wrapper__ztree vcenter-tree">
                        ...
                        <ul id="vcenter_tree" class="ztree"></ul>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-8 tabledata-wrapper">
            <div class="tabledata-wrapper__head">
                ...
                <span
                        class="tabledata-wrapper__head__title"><?php echo $LANG['UI_DATA_BACKUP_POINT'] ?></span>
                <span id="vmdataUrl" class="tabledata-wrapper__head__taskname"></span>
            </div>
            <div class="tabledata-wrapper__content">
                <div class="alert alert-block alert-info fade in" id="tabletips">
                    ...
                    <ol class="alert-ol">
                        ...
                        <li><?php echo $LANG['UI_OBS_TIMEPOINT_MANAGER_TWO'] ?></li>
                        <li><?php echo $LANG['UI_DATA_VM_TIPS3'] ?></li>
                        <li><?php echo $LANG['UI_DATA_VM_TIPS4'] ?></li>
                    </ol>
                </div>

                <div id="vmtable" class="tabledata-wrapper__content__table display-none">
                    ...
                    <div class="table-tips alert alert-block alert-info fade in" id="marktips">
    ...
    <div class="modal-body">
        <div class="portlet-body">
            ...
            <div class="list-option" id="startTimeDiv">
                <div class="row">
                    <label class="control-label col-md-4 col-md-3_en"><?php echo $LANG['UI_DATA_TIMEPOINT_RANGE'] ?> ：
                    </label>
                    <div class="col-md-6">
            ...
            <div class="list-option">
                <div class="row">
                    <!-- 时间点类型 -->
                    <label class="control-label col-md-4 col-md-3_en"><?php echo $LANG['UI_PUBLIC_TYPE'] ?> ：
                    </label>
                    <div class="col-md-5">
            ...
            <div class="list-option">
                <div class="row">
                    <!-- 时间点类型 -->
                    <label class="control-label col-md-4  col-md-3_en"><?php echo $LANG['UI_BACKUP_MARKING']?> ：
                    </label>
                    <div class="col-md-4 col-md-4_en">
                        <label style="padding-right: 20px;" class="pr10_en">
                            <input type="checkbox" name="weekCheck1" class="icheck">
                            <i class="viconfont vicon-remark-week"></i>
                            <?php echo $LANG['WEB_VM_GFS_WEEK_POINT']?>
                        </label>
                    </div>
                    <div class="col-md-4  col-md-5_en">
                        <label style="padding-right: 20px;">
                            <input type="checkbox" name="monthCheck1" class="icheck">
                            <i class="viconfont vicon-remark-month"></i>
                            <?php echo $LANG['WEB_VM_GFS_MONTH_POINT']?>
                        </label>
                    </div>
                ...
                <div class="row">
                    <!-- 时间点类型 -->
                    <label class="control-label col-md-4 col-md-3_en">
                    </label>
                    <div class="col-md-4 col-md-4_en">
                        <label style="padding-right: 20px;" class="pr10_en">
                            <input type="checkbox" name="yearCheck1" class="icheck">
                            <i class="viconfont vicon-remark-year"></i>
                            <?php echo $LANG['WEB_VM_GFS_YEAR_POINT']?>
                        </label>
                    </div>
        ...
        <div class="portlet-body">
            <div style="margin-top: 10px;">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <label style="padding-right: 20px;">
                            <input type="checkbox" name="weekCheck" class="icheck">
                            <i class="viconfont vicon-remark-week"></i>
                            <?php echo $LANG['UI_VM_GFS_RETENTION_WEEKLY'] ?>
                        </label>
                    </div>
                </div>
            </div>
            <div style="margin-top: 10px;">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <label style="padding-right: 20px;">
                            <input type="checkbox" name="monthCheck" class="icheck">
                            <i class="viconfont vicon-remark-month"></i>
                            <?php echo $LANG['UI_VM_GFS_RETENTION_MONTHLY'] ?>
                        </label>
                    </div>
                </div>
            </div>
            <div style="margin-top: 10px;">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <label style="padding-right: 20px;">
                            <input type="checkbox" name="yearCheck" class="icheck">
                            <i class="viconfont vicon-remark-year"></i>
                            <?php echo $LANG['UI_VM_GFS_RETENTION_YEARLY'] ?>
                        </label>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="./scripts/aws/awsdata.js"></script>
