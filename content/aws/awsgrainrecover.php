	...
	<div class="col-md-12 page-content-col">
		<div class="portlet box blue-hoki" id="recovercontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-vmrecovera"></i><?php echo $LANG['UI_BACKUP_NEW_GRANULAR_JOB']?>
				</div>
			</div>
				    ...
				    <div class="form-body form-body__instant">	
						<div class="form-group">
							<label class="control-label col-md-3">
								<?php echo $LANG['UI_BACKUP_AWS_TARGET_STORAGE']?>
							</label>
...
<!--							        <select class="bs-select width45p pointshowtype-display" data-show-subtext="true" id="pointshowtype">-->
							...
							<div class="col-md-7 col-md-offset-3 col-tree">
								<div class="two_tree">
    								...
    								<div><span class="help-block ">
    									<?php echo $LANG['UI_GRAIN_AWS_POINT']?>
    								</span></div>
								</div>
								<div class="alert alert-block alert-info fade in display-hide"  id="nopointtips">
									...
									<ul class="alert-ul">
										...
										<li>
											<strong><?php echo $LANG['UI_RECOVERY_AWS_NO_TIMEPOINT']?></strong><a id="tobackup"><small><?php echo $LANG['UI_RECOVERY_AWS_NO_TIMEPOINT_TIPS']?></small></a>
										</li>
									</ul>
								</div>
...
<script src="./scripts/aws/awsgrainrecover.js" type="text/javascript"></script>