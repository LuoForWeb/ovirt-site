...
<!-- BEGIN PAGE CONTENT-->
<div class="row job-detail" id="aws-jobDetail">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#vms" data-toggle="tab">
                            <i class="viconfont vicon-pt_report_vm_report "></i> <?php echo $LANG['UI_TASK_AWS_INSTANCE_LIST'] ?> </a>
                    </li>
                    <li id="historyli">
                                ...
                                <div class="col-md-12" style="display: inline-flex">
                                    <div class="search input-group mr12">
                                        <input type="search" maxlength="128" id="searchInput" class="searchinput customSearch" autocomplete="off"
                                               ...
                                               placeholder="<?php echo $LANG['UI_TASK_INSTANCE_SEARCH_TIPS'] ?>">
                        ...
                        <div class="table-container" style="margin-top: 10px;">
                            ...
                            <div class="alert alert-block alert-info fade in display-hide" id="vmbackuptips">
                                ...
                                <ul class="alert-ul">
                                    ...
                                    <li>
                                        <?php echo $LANG['UI_BACKUP_SELECT_INSTANCE_BACKUP_TIPS'] ?>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="config-detail-wrap__group strategy-group threadDiv">
                ...
                <div class="strategy-group__form">
                    <div class="backup_style">
                        ...
                        <!-- 代理 -->
                        <div class="strategy-group__form__item transportAgentdiv">
                            <div class="strategy-group__form__item__label col-md-4">
                                <?php echo $LANG['UI_BACKUP_AWS_APPLIANCE_SELECT'] ?>
                            </div>
                            <div id="transportAgent" class="strategy-group__form__item__value col-md-8">
                            </div>
                        </div>
                        <!-- 加密传输 -->
                ...
                <div class="backup_style">
                    ...
                    <div class="snapshotDiv">
                        ...
                        <div class="strategy-group__form">
                            ...
                            <!-- 高速模式 -->
                            <div class="strategy-group__form__item highLeveldiv">
                                <div class="strategy-group__form__item__label col-md-4 highLevelLabel">
                                    <?php echo $LANG['UI_BACKUP_MODE_HIGH_SPEED'] ?></div>
                                <div id="highLevel" class="strategy-group__form__item__value col-md-8"></div>
                            </div>
                            <!-- 提前创建快照 -->
                            ...
                            <!-- 快照超时时间 -->
                            <div class="strategy-group__form__item snapshottimeoutDiv">
                                <div class="strategy-group__form__item__label col-md-4">
                                    <?php echo $LANG['UI_BACKUP_SNAPSHOT_TIMEOUT'] ?></div>
                                <div id="snapshottimeout" class="strategy-group__form__item__value col-md-8"></div>
                            </div>
                        </div>
                    </div>
                    <!--END SNAPSHOT GROUP -->
...
<script type="text/javascript" src="./scripts/aws/aws_job_details.js"></script>
