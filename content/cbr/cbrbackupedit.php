...
<div class="row" style="height:100%;">
    <div class="col-md-12" style="height:100%;">
        <input id="s_taskuuid" value="<?php echo $_GET['taskuuid']; ?>" class="display-none"></input>
        ...
        <div class="portlet box blue-hoki backup-page" id="cbrbackupcontent">
            <div class="portlet-title" style="height:5%;">
                <div class="caption">
                    <i class="viconfont vicon-xiugai"></i><?php echo $LANG['UI_BACKUP_EDIT_TASK'] ?>
                </div>
            </div>
                                                ...
                                                <div class="form-group src-wrap">
                                                    ...
                                                    <div class="src-wrap__content">
                                                        <div class="src-wrap__content__search cbr_tree_div">
                                                            <select class="bs-select width100p" data-show-subtext="true" id="asyncshowtype" disabled>
                                                            ...
                                                            <div class="vm_tree_div">
                                                                <div class="input-icon width100p">
                                                                    <input type="text" maxlength="128" placeholder="<?php echo $LANG['UI_COPY_SEARCH_AS_KEYWORD'] ?>" class="form-control" id="searchcbr"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="src-wrap__content__ztree">
                                                            ...
                                                            <div class="alert alert-block alert-info fade in display-hide"  id="nodatatips">
                                                                ...
                                                                <ol class = "alert-ol">
                                                                    ...
                                                                    <li>
                                                                        <a id="toaddcbr"><small><?php echo $LANG['UI_CBR_SYNC_ADD_CBR_STORAGE_FIRST'] ?></small></a>
                                                                    </li>
                                                                </ol>
                                                            </div>
                                                                        ...
                                                                        <div id="store" class="panel-collapse collapse ">
                                                                            <div class="panel-body">
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="form-group display-none encryptStorageDiv">
                                                                                        ...
                                                                                        <div class="col-md-2 mt5">
                                                                                            <a class="popovers" data-container="body" data-trigger="hover"
                                                                                            data-placement="right" data-content="<?php echo $LANG['UI_BACKUP_DATA_ENCRYPT_TIPS'] ?>">
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="form-group display-none passwordModeDiv">
                                                                                        <label class="control-label col-md-4 passwordAutolabel"><?php echo $LANG['UI_BACKUP_PASSOWRD_AUTO'] ?></label>
                                                                                        <div class="col-md-4">
                                                                                    ...
                                                                                    <div class="form-group display-none passwordDiv">
                                                                                        ...
                                                                                        <div class="col-md-4">
                                                                                            <input type="password" autocomplete="off" maxlength="128" class="form-control" id="password" placeholder="" oninput="value=value.replace(/[\u4E00-\u9FA5]|[\uFE30-\uFFA0]|\s+/g,'')"/>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="form-group display-none passwordDiv">
                                                                                        ...
                                                                                        <div class="col-md-4">
                                                                                            <input type="password" autocomplete="off" maxlength="128" class="form-control" id="repassword" placeholder="" oninput="value=value.replace(/[\u4E00-\u9FA5]|[\uFE30-\uFFA0]|\s+/g,'')"/>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-md-4">
                                                                                            <div id="spinnerDay">
                                                                                                <div class="input-group spinner-group">
                                                                                                    ...
                                                                                                    <div class="spinner-buttons input-group-btn spinner-group-btn">
                                                                                                        <button type="button" class="btn spinner-up default input-sm  vmbackup-input-sm_en ">
                                                                                                        <i class="fa fa-angle-up"></i>
                                                                                                        </button>
                                                                                                        <button type="button" class="btn spinner-down default input-sm vmbackup-input-sm_en">
                                                                                                        <i class="fa fa-angle-down"></i>
                                                                                                        </button>
                                                                                                    </div>
                                                                                                </div>
                                    ...
                                    <div class="tab-pane" id="tab4">
                                        <div class="tab-pane__body">
                                            <div class="tab-pane__body__form">
                                                ...
                                                <div class="form-group mb0 mt10">
                                                    <label class="control-label col-md-3"><?php echo $LANG['UI_BACKUP_AWS_COMPUTE_NODE'] ?>:</label>
                                                    <div class="col-md-9">
...
<script src="./scripts/cbr/cbrbackupedit.js" type="text/javascript"></script>
