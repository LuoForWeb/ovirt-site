...
<div class="panel-body">
    <div class="tabbable-custom pdlr15  col-md-10" >
        ...
        <div class="form-group transportmodediv">
            ...
            <div class="col-md-2 mt10 alltips">
            ...
            <div class="col-md-2 mt10  nbdtips display-none">
                <a class="popovers" data-container="body" data-trigger="hover" data-html="true"
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                ...
                                <div class="form-group ptDiskDiv">
                                    ...
                                    <div class="col-md-2 vmbackup-mt10_en mt5_cn">
                                        <a class="popovers" data-container="body" data-trigger="hover" data-html="true"
                                           data-placement="right" data-content="<?php echo $LANG['UI_BACKUP_SINGLE_VM_RECOVERY_PARALLEL_DISK_TRANSFER_COUNT_TIPS']?>">
                                            <i class="viconfont vicon-tishi"></i>
                                        </a>
                                    </div>
                                </div>
