...
<h3 class="breadcrumb">
    ...
    <span class="curent"><?php echo $LANG['UI_REPORT_TEMPLATE_MICROSOFT'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="report-detail">
    <div class="report-detail__header">
        <span class="report-detail__header__title">
            <i class="viconfont vicon-overview-m365 me-4"></i>
            <span class="report-detail__header__title__text"><?php echo $LANG['UI_REPORT_TEMPLATE_MICROSOFT'] ?></span>
        </span>
        <button type="button" id="m365_export" class="btn green-haze <?php if (!in_array('p_vm_report_export', $_SESSION['permissionArr'])) {
            echo 'display-none';
        } ?>">
    ...
    <div class="report-detail__content hover-scroll-y">
        ...
        <div class="report-detail-boxes app-detail-boxes display-none">
            <div class="report-detail-boxes__item box-wrapper app-total-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="app_total_num"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_MANAGE_APP_TOTAL_NUM'] ?></span>
                </div>
                <div class="box-wrapper__right app-total-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper app-online-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="app_online_num"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_ONLINE_APP_TOTAL_NUM'] ?></span>
                </div>
                <div class="box-wrapper__right app-online-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper app-offline-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="app_offline_num"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_OFFLINE_APP_TOTAL_NUM'] ?></span>
                </div>
                <div class="box-wrapper__right app-offline-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper app-protected-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="app_protected_num"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_PROTECTED_APP'] ?></span>
                </div>
                <div class="box-wrapper__right app-protected-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper app-backup-data-box display-none">
                <div class="box-wrapper__left">
                    <span class="nums-wrapper">
                        <span class="box-wrapper__left__nums" id="app_backup_data"></span>
                        <span class="box-wrapper__left__unit" id="app_backup_data_unit"></span>
                    </span>
        ...
        <div class="charts-wrapper echart-wrapper display-none">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="all_tab">
                    <div class="tab-content__echart" id="m365_report_all_chart"></div>
                ...
                <div class="tab-pane fade" id="success_tab">
                    <div class="tab-content__echart" id="m365_report_success_chart"></div>
                        <div class="tab-content__nodata display-none">
                            <div class="tab-content__nodata__img">
                                <img src="./img/platform/report/nodata.svg" alt="">
                            </div>
                ...
                <div class="tab-pane fade" id="failed_tab">
                    <div class="tab-content__echart" id="m365_report_failed_chart"></div>
                        <div class="tab-content__nodata display-none">
                            <div class="tab-content__nodata__img">
                                <img src="./img/platform/report/nodata.svg" alt="">
                            </div>
        ...
        <div class="data-detail-wrapper">
            <div class="data-detail-wrapper__toolbar toolbar-wrap">
                <div class="obs-manager-toolbar">
                    <div class="tool-left">
                        ...
                        <div class="tool-left-item me-10">
                            <div id="m365_report_filter_wrapper" class="position-relative"></div>
                        </div>
                        <div class="tool-left-item">
                            <div id="m365_report_daterangepicker_wrapper" class="position-relative"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="data-detail-wrapper__content">
                <table id="m365_report_table"></table>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="./scripts/platform/reports/appDetail.js"></script>
