...
<h3 class="breadcrumb">
    ...
    <span class="curent"><?php echo $LANG['UI_PLATFORM_OBS_MANAGER'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="report-detail">
    <div class="report-detail__header">
        <span class="report-detail__header__title">
            ...
            <span class="report-detail__header__title__text"><?php echo $LANG['UI_PLATFORM_OBS_MANAGER'] ?></span>
        </span>
        <button type="button" id="obs_export" class="btn green-haze <?php if (!in_array('p_vm_report_export', $_SESSION['permissionArr'])) {
            echo 'display-none';
        } ?>">
    ...
    <div class="report-detail__content hover-scroll-y">
        ...
        <div class="report-detail-boxes obs-detail-boxes display-none">
            <div class="report-detail-boxes__item box-wrapper obs-total-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="obs_total_num"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_TOTAL_OBS'] ?></span>
                </div>
                <div class="box-wrapper__right obs-total-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper obs-normal-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="obs_normal_num"></span>
            ...
            <div class="report-detail-boxes__item box-wrapper obs-offline-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="obs_offline_num"></span>
        ...
        <div class="charts-wrapper echart-wrapper display-none">
            ...
            <div class="tab-content">
                <div class="tab-content__echart" id="obs_task_running_chart"></div>
        ...
        <div class="data-detail-wrapper">
            <div class="data-detail-wrapper__toolbar toolbar-wrap">
                <div class="obs-manager-toolbar">
                    <div class="tool-left">
                        ...
                        <div class="tool-left-item">
                            <div id="obs_report_filter_wrapper" class="position-relative"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="data-detail-wrapper__content">
                <table id="obs_report_table"></table>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="./scripts/platform/reports/obsDetail.js"></script>
