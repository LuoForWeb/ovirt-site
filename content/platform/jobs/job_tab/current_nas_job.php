...
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet-body" id="current_nas_job">
				<!-- search -->
				<div class="table-toolbar-wrapper">
					...
					<div class="table-toolbar-wrapper__right">
						<div class="table-actions-wrapper page-right">
							...
							<input type="search" maxlength="128" class="nasjob_search table-group-action-input form-control input-inline input" placeholder="<?php echo $LANG['UI_JOB_SEARCH_JOB_NAME'] ?>" aria-controls="example">
							<input id="nasjob_searchbtn" type="button" class="btn btn-search" value="<?php echo $LANG['UI_PUBLIC_SEARCH'] ?>">
							<button type="button" id="nasjob_searchAll" class="btn green-haze">
				...
				<div class="row">
					<div class="col-md-12">
						<div id="nas_searchDiv" class="searchDiv display-none"><?php echo $LANG['UI_PUBLIC_SEARCH_CONDITION'] ?> <span class="searchContent"></span><span class="clearSearch"><?php echo $LANG['UI_SEARCH_CLEAR'] ?></span> </div>
					</div>
				</div>
				<div class="table-container">
					<table class="table table-striped table-hover" id="nasJobTable">
					<thead>
					<tr role="row" class="heading">
						...
						<th width="16%">
							<?php echo $LANG['UI_NAS_DEVICE_NAME'] ?>
						</th>
						<th width="14%">
		...
		<!-- BEGIN MODAL -->
		<div id="nasJobModal" class="modal xmodal fade form-horizontal high-search" tabindex="-1" data-backdrop="static">
				...
				<div class="portlet-body">
						...
						<div class="row">
							<label class="control-label col-md-4"><?php echo $LANG['UI_JOB_CREATE_MODIFY_TIME_RANGE'] ?> ：
								...
								<div class="col-md-5 daterangepickerdiv">
									<input type="text" id="daterangepickerCurrentNas" class="form-control" autocomplete="off">
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<input style="width:322px; height:34px;" id="nas_taskName" type="text" maxlength="64" class="table-group-action-input form-control input-inline input input-sm" aria-controls="example">
							</div>
						</div>
					</div>
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="nas_tasktype">
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="nas_node" >
								</select>
							</div>
						</div>
					</div>
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="nas_status">
									<option value="0"><?php echo $LANG['UI_PUBLIC_ALL'] ?></option>
			...
			<div class="modal-footer">
				...
				<button type="button"class="btn btn-primary" id="nas_serach_submit"><?php echo $LANG['UI_PUBLIC_YES'] ?></button>
			</div>
		</div>	
		<!-- END MODAL -->
...
<script type="text/javascript" src="./scripts/platform/jobs/job_tab/current_nas_job.js"></script>
