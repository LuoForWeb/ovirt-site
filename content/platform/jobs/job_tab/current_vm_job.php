...
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet-body" id="current_vm_job">
				<!-- search -->
				<div class="table-toolbar-wrapper">
					...
					<div class="table-toolbar-wrapper__right">
						<div class="table-actions-wrapper page-right">
							...
							<input type="search" maxlength="128" class="vmjob_search table-group-action-input form-control input-inline input" placeholder="<?php echo $LANG['UI_JOB_SEARCH_JOB_NAME'] ?>" aria-controls="example">
							<input id="vm_searchbtn" type="button" class="btn btn-search default" value="<?php echo $LANG['UI_PUBLIC_SEARCH'] ?>">
							<button type="button" id="vmjob_searchAll" class="btn green-haze">
				...
				<div class="row">
					<div class="col-md-12">
						<div id="vm_searchDiv" class="searchDiv display-none"><?php echo $LANG['UI_PUBLIC_SEARCH_CONDITION'] ?> <span class="searchContent"></span><span class="clearSearch"><?php echo $LANG['UI_SEARCH_CLEAR'] ?></span> </div>
					</div>
				</div>
				<div class="table-container">
					<table class="table table-striped table-hover" id="vmJobTable">
					<thead>
		...
		<!-- BEGIN MODAL -->
		<div id="vmJobModal" class="modal xmodal fade form-horizontal high-search" tabindex="-1"  data-backdrop="static">
				...
				<div class="portlet-body">
					...
					<div class="list-option" >
						<div class="row">
							...
							<div class="col-md-5 daterangepickerdiv">
								<input type="text" id="daterangepickerCurrentVmJob" class="form-control" autocomplete="off">
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<input style="width:323px; height:34px;" id="vm_taskName" type="text" maxlength="64" class="table-group-action-input form-control input-inline input input-sm" aria-controls="example">
							</div>
						</div>
					</div>
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="vm_tasktype">
									...
									<option value="37"><?php echo $LANG['WEB_PLATFORM_DES_SURE_BACKUP'] ?></option>
									<option value="51"><?php echo $LANG['UI_PLATFORM_SYNC_CBR'] ?></option>
								</select>
							</div>
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="vm_node" >
								</select>
							</div>
						</div>
					</div>
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="vmjob_status">
									<option value="0"><?php echo $LANG['UI_PUBLIC_ALL'] ?></option>
			...
			<div class="modal-footer">
				...
				<button type="button"class="btn btn-primary" id="vm_serach_submit"><?php echo $LANG['UI_PUBLIC_YES'] ?></button>
			</div>
		</div>	
		<!-- END MODAL -->
...
<script type="text/javascript" src="./scripts/platform/jobs/job_tab/current_vm_job.js"></script>
