...
<h3 class="breadcrumb">
	...
	<li>
		<a class="ajaxify" name="safety" href="./content/platform/users/users.php">
			<?php echo $LANG['UI_PLATFORM_USER'] ?>
		</a>
	</li>
	<span>></span>
	<span class="curent"><?php echo $LANG['UI_PLATFORM_EDIT_USER'] ?></span>
</h3>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="row">
	<div class="col-md-12">
	   ...
	   <input id="pageUri" value="<?php echo $_SERVER['REQUEST_URI']; ?>" class="display-none"></input>
		...
		<div class="portlet box blue-hoki" id="edituserContent">
				...
				<form action="#" id="form_sample_2" class="form-horizontal">
					<div class="form-body">
						...
						<div class="form-group domainDiv display-none">
							<label class="control-label col-md-3"><?php echo $LANG['UI_USER_EXTERNAL_PROVIDER'] ?><span class="required">
							* </span>
							</label>
							<div class="col-md-4">
								<select class="form-control select2me" id="domainlist" name="domainlist">
									<option value=""><?php echo $LANG['UI_USER_EXTERNAL_PROVIDER_TIPS'] ?></option>
								</select>
							</div>
						</div>				
