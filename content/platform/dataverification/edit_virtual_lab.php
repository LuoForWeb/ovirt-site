...
<h3 class="breadcrumb">
    ...
    <span>></span>
    <span class="curent"><?php if (empty($_GET['uuid'])) {
        echo $LANG['UI_PUBLIC_ADDNEW'];
    } else {
    ...
    <div class="col-md-12 col-manager" >
        ...
        <div class="portlet box blue-hoki" id="labContent">
            <div class="portlet-title">
                <div class="caption">
                    <i class="viconfont vicon-virtual_lab_manager"></i><?php echo $LANG['UI_VIRTUAL_LAB_EDIT'] ?>
                </div>
            </div>
                            ...
                            <div class="tab-content bakuptab overflowy-auto" style="height: calc(100% - 45px);">
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control select2me " name="data_source_type" id="data_source_type">
                                                    ...
                                                    if (!empty($_SESSION['authfun'])) {
                                                        ...
                                                        if ($_SESSION['authfun']['dataVerificationVM']) {
                                ...
                                <div class="tab-pane" id="tab2">
                                    <div class="row tab-pane__row">
                                        <div class="col-md-12">
                                            <div class="form-group host_tree_div data-resource1" id="selectHost">
                                            ...
                                            <div class="form-group display-hide data-resource1" id="nohosttips">
                                                <label class="control-label col-md-4">
                                                    <span class="required">* </span>
                                            ...
                                            <div class="form-group data-resource2 display-hide">
                                        ...
                                        <div class="col-md-12 proxySettingsDiv display-none">
                                            <div class="form-group data-resource1">
                                            ...
                                            <div class="form-group data-resource1 display-hide">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-icon right width364">
                                                        <i class="fa"></i>
                                                        <input type="text" maxlength="128" class="form-control" name="ipaddress" id="ipaddress">
                                                        <div><span class="help-block ">
                                            ...
                                            <div class="form-group data-resource1 display-hide">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-icon right width364">
                                                        <i class="fa"></i>
                                                        <input type="text" maxlength="128" class="form-control" name="subnetmask" id="subnetmask">
                                                        <div><span class="help-block ">
                                            ...
                                            <div class="form-group data-resource1 display-hide">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-icon right width364">
                                                        <i class="fa"></i>
                                                        <input type="text" maxlength="128" class="form-control" name="gateway" id="gateway">
                                                        <div><span class="help-block ">
                                    ...
                                    <div class="row tab-pane__row">
                                        <div class="col-md-12 col-steptwo">
                                            ...
                                            <div class="form-group data-resource1">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="bootstrap-mutiple-select select2me selectpicker show-tick ignore" multiple data-live-search="true" data-actions-box="true" id="productnetwork">
                                                    </select>
                                                    <div><span class="help-block ">
...
<script src="./scripts/platform/dataverification/edit_virtual_lab.js" type="text/javascript"></script>