	...
	<div class="col-md-12">
		...
		<div class="portlet box blue-hoki">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-vmdata"></i><?php echo $LANG['WEB_OS_HOST_BACKUP_DATA']?>
				</div>
			</div>
			     ...
			     <div class="row">
			         <div class="col-md-4">
			             <div class="portlet">
			                <div class="portlet-title">
                				<div class="caption">
                					<i class="viconfont vicon-os_protect"></i><?php echo $LANG['WEB_OS_HOST_TASK_LIST']?>
                				</div>
                			</div>
                			<div class="portlet-body batchDeleteDiv">
                			    ...
                			    <div class="os_center_tree" >
        							...
        							<ul id="os_tree_data" class="ztree ztree-fa tree-scroll bd1de5" ></ul>
								</div>
                			</div>
			             </div>
			         </div>
			         <div class="col-md-8">
			             <div class="portlet ">
							...
							<div class="alert alert-block alert-info fade in" id="tabletips">
                                ...
                                <ol class = "alert-ol">
                                    <li>
                                        <?php echo $LANG['WEB_OS_HOST_DATA_TIPS1']?>
                                    </li>
                                    <li>
                                        <?php echo $LANG['WEB_OS_HOST_DATA_TIPS2']?>
                                    </li>
                                    <li>
                			...
                			<div class="portlet-body display-none" id="dbtable">
                			    ...
                			    <div class="table-container">
                					...
                					<tr role="row" class="heading">
                						...
                						<th width="15%">
                							<?php echo $LANG['WEB_OS_PARTITION_INFORMATION']?>
                						</th>
										<th width="8%">
...
<script type="text/javascript" src="./scripts/os/osdata.js"></script>
