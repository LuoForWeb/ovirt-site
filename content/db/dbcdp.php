	...
	<div class="col-md-12">
		<div class="portlet box blue-hoki full-height-content full-height-content-scrollable" id="dbcdpcontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-dbcdpbackup"></i><?php echo $LANG['UI_BACKUP_NEW_TASK']?>
				</div>
			</div>
...
<!-- 															<option value="1">选择备份目的主机</option> -->
                                    							...
                                    							<div class="col-md-4" >
                                    								<div class="spinnerNum">
                                    		                        	<div class="input-group" >
                                    			                        	<input type="text" id="logsize" onkeyup="value=value.replace(/[^\d]/g,'')" style="text-align: center;" class="spinner-input form-control" maxlength="8">
															...
															<div class="form-group tkdivs display-none">
                                    							...
                                    							<div class="col-md-4" >
                                    								<div class="spinnertakeover">
                                    		                        	<div class="input-group" >
                                    			                        	<input type="text" id="takeoverstep" onkeyup="value=value.replace(/[^\d]/g,'')" style="text-align: center;" class="spinner-input form-control" maxlength="8">
                                    			                        	<div class="spinner-buttons input-group-btn">
                                    			                        		<button type="button" class="btn spinner-up default">
                                    			                        			<i class="fa fa-angle-up"></i>
                                    			                        		</button>
								...
								<div class="tab-pane" id="tab4">
									...
									<div class="form-group mb0">
										...
										<div class="col-md-7">
											<p class="form-control-static  producthostshow"></p>
										</div>
									</div>
									<div class="form-group mb0">
										<label class="control-label col-md-3">数据库:</label>
										<div class="col-md-7">
											<p class="form-control-static  dbshow"></p>
										</div>
									</div>
									<h4 class="form-section"></h4>
									<div class="form-group mb0">
...
<script src="./scripts/db/dbcdp.js" type="text/javascript"></script>
