        ...
        <div class="row" style="height:100%;">
            <div class="col-md-12" style="height:100%;">
                ...
                <div class="portlet box blue-hoki" id="dbcdpbackupcontent">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="levelchild viconfont vicon-xinjianbeifen1"></i><?php echo $LANG['UI_DB_CDP_CREATE_EDIT_JOB'];?>
                        </div>
                    </div>
                                        ...
                                        <ul class="nav nav-pills steps">
                                            <li>
                                                <a href="#tab1" data-toggle="tab" class="step">
                                                    ...
                                                    <span class="desc">
                                                        <?php echo $LANG['UI_DB_CDP_BACKUP_SOURCE'];?>
                                            ...
                                            <li>
                                                <a href="#tab2" data-toggle="tab" class="step">
                                                    ...
                                                    <span class="desc">
                                                        <?php echo $LANG['UI_DB_CDP_SYNC_TARGET'];?>
                                                        <i class="fa fa-check"></i>
                                                    </span>
                                                </a>
                                            </li>
                                                ...
                                                <div class="row tab-pane__row">
                                                        ...
                                                        <div class="form-group src-wrap">
                                                            ...
                                                            <div class="src-wrap__content">
                                                                <div class="src-wrap__content__search">
                                                                    <select id="dbtype" class="bs-select mb10 form-control" style="height: 34px" data-show-subtext="true"></select>
                                                                </div>
                                                    ...
                                                    <div class="col-md-8 notipsDiv">
                                                        <div class="alert alert-block alert-info fade in" id="step1tips">
                                                            ...
                                                            <ol class="alert-ol">
                                                                <li>
                                                                    <?php echo $LANG['UI_DB_BACKUP_TIPS1'];?>
                                                                </li>
                                                                <li>
                                                                    <?php echo $LANG['UI_DB_CDP_CREATE_EDIT_TIP1'];?>
                                                                </li>
                                                                <li>
                                                                    <?php echo $LANG['UI_DB_CDP_CREATE_EDIT_TIP2'];?>
                                                                </li>
                                                            </ol>
                                                            <div class="alert-line"></div>
                                                            <p><?php echo $LANG['UI_DB_CDP_CREATE_EDIT_COMMENT'];?></p>
                                                        </div>
                                                        <!-- 没有可用数据库提示 -->
                                                    ...
                                                    <div class="col-md-8 plr30 display-hide" id="dbtreediv">
                                                ...
                                                <div class="row vol-cdp-backup-tab">
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="form-group dbMapDetaildiv">
                                                            ...
                                                            <div id="instanceMapList" class="col-md-9"></div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4 form-group-content">
                                                                ...
                                                                <a class="popovers ml15"
                                                                   ...
                                                                   data-trigger="hover"
                                                                   data-placement="right"
                                                                   data-content="<?php echo $LANG['UI_DB_CDP_BACKUP_AUTO_TAKEOVER_NOTES'];?>">
                                                                    <i class="viconfont vicon-tishi"></i>
                                                                </a>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div id="takeoverConfig" class="panel-collapse collapse in">
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="form-group takeoverNetConf display-none">
                                                                                <label class="control-label col-md-3 applianceselectlabel col-md-5_en"><?php echo $LANG['UI_VOL_CDP_TASK_TAKEOVER_NET_CONF']; ?></label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-2 mt8 pl0 col-md-1_en">
                                                                                    <a class="popovers"
                                                                                       data-container="body"
                                                                                       data-trigger="hover"
                                                                                       data-placement="right" data-content="<?php echo $LANG['UI_VOL_CDP_HEARTBEAT_NOT_ENABLE_TIME_TIPS'];?>">
                                                                                        <i class="viconfont vicon-tishi"></i>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="col-md-1 mt8 pl0 pr0 w-25px w-70px_en"><?php echo $LANG['WEB_PALTFORM_DC_TIME'];?></label>
                                                                            ...
                                                                            <div class="tab-content level1">
                                                                                ...
                                                                                <div class="tab-pane fade active in" id="tab_data_copy">
                                                                                    <div class="col-md-12 pt40">
                                                                                        ...
                                                                                        <div class="form-group use_dbms_Switch_div">
                                                                                        ...
                                                                                        <div class="form-group sync_big_object_Switch_div">
                                                                                        ...
                                                                                        <div class="form-group timed_gen_txn_Switch_div display-none">
                                                                                        ...
                                                                                        <div class="form-group replay_ddl_Switch_div">
                                                                                        ...
                                                                                        <div class="form-group ignore_nonsupport_data_type_Switch_div">
                                                                                ...
                                                                                <div class="tab-pane fade" id="tab_cache_strategy">
                                                                                    <div class="col-md-12 pt40">
                                                                                        <div class="form-group source_fileCacheSizeDiv">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <button class="fileCachePathButton unlimit_limit_toggle" data-value = "source_cache_button"><?php echo $LANG['UI_DB_CDP_BACKUP_SWITCH_TO_UNLIMITED'];?></button>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <input id="source_fileCachePath" class="form-control select2me input-sm" value="/opt/vinchin/agent/dbcdp_cache/" max-length="128" readonly>
                                                                                            </div>
                                                                                            <div class="col-md-4 source_fileCachePath_div">
                                                                                        ...
                                                                                        <div class="form-group backup_fileCacheSizeDiv">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <button class="fileCachePathButton unlimit_limit_toggle" data-value = "backup_cache_button"><?php echo $LANG['UI_DB_CDP_BACKUP_SWITCH_TO_UNLIMITED'];?></button>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label class="control-label col-md-4 fileCachePathlabel"><?php echo $LANG['UI_DB_CDP_BACKUP_STANDBY_FILE_CACHE_PATH'];?></label>
                                                                                            <div class="col-md-4">
                                                                                                <input id="backup_fileCachePath" class="form-control select2me input-sm" value="/opt/vinchin/agent/dbcdp_cache/" max-length="128" readonly>
                                                                                            </div>
                                                                                            <div class="col-md-4 backup_fileCachePath_div">
                                                ...
                                                <div class="tab-pane__body">
                                                    <div class="tab-pane__body__form">
                                                        ...
                                                        <div class="form-group mb0 mb10">
                                                            ...
                                                            <div class="col-md-9">
                                                                <p class="form-control-static synAppShow"></p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb0 mb10">
                                                        ...
                                                        <div class="form-group mb0 mb10">
                                                            <label class="control-label col-md-3"><?php echo $LANG['UI_VOL_CDP_STANDBY'];?></label>
                                                            <div class="col-md-9">
                                                                <p class="form-control-static  standbyShow"></p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb0 mb10">
                                                        ...
                                                        <div class="form-group mb0 mb10" id="takeOverNetdiv">
                                                            <label class="control-label col-md-3"><?php echo $LANG['UI_DB_CDP_CREATE_EDIT_NETWORK_TAKEOVER'];?></label>
                                                            <div class="col-md-9">
                ...
                <div id="speedlimitModal" class="modal xmodal fade form-horizontal " tabindex="-1" data-focus-on="input:first" data-backdrop="static">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="speed_submit" type="button" class="btn btn-primary"><?php echo $LANG['UI_PUBLIC_YES'] ?></button>
                    </div>
                </div>
        ...
        <script src="./scripts/dbcdp/dbcdpedit.js" type="text/javascript"></script>
