	...
	<div class="col-md-12 col-manager">
				...
				<form action="#" id="form_sample_2" class="form-horizontal">
					<div class="form-body">
						...
						<div class="form-group" id="vmtypediv">
							...
							<a href="javascript:;" id="agentInit" class="display-none" style="position:relative;top:8px;"><?php echo $LANG['UI_VCENTER_DOWNLOAD_AGENT'] ?></a>
						</div>
						...
						<div class="form-group display-hide ip-port">
							<label class="control-label col-md-4"><?php echo $LANG['UI_VECNTER_ADD_VC_IP_PORT'] ?></label>
							<div class="col-md-2">
						...
						<div class="form-group openstackDiv display-hide" id="domainDiv">
                        ...
                        <div class="form-group display-hide huaweikvmLoginDiv">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2me" id="huaweikvmUserType">
                                    ...
                                    <option value="2" selected><?php echo $LANG['UI_VECNTER_ADD_VC_USER_TYPE_INTERFACE'] ?></option>
                                </select>
						...
						<div class="form-group icsDiv display-none">
							<label class="control-label col-md-4">AccessKey ID</label>
							<div class="col-md-4">
								<div class="input-icon right ">
									<i class="fa"></i>
									<input type="text" maxlength="128" class="form-control" id="accessId" />
						...
						<div class="form-group icsDiv display-none">
							<label class="control-label col-md-4">AccessKey Secret</label>
							<div class="col-md-4">
								<div class="input-icon right ">
									<i class="fa"></i>
						...
						<div class="form-group engineDiv display-none">
							<label class="control-label col-md-4"><?php echo $LANG['UI_VCENTER_ENGINE_BACKUP_USER_NAME'] ?></label>
							<div class="col-md-4">
								<div class="input-icon right ">
									<i class="fa"></i>
						...
						<div class="form-group highsafeCheckDiv display-none">
							<label class="control-label col-md-4 form-group-label"><?php echo $LANG['UI_VCENTER_WINHONG_HIGH_SAFE'] ?></label>
							<div class="col-md-4 form-group-content">
						...
						<div class="form-group highsafeDiv display-none">
							<label class="control-label col-md-4"><?php echo $LANG['UI_VCENTER_WINHONG_HIGH_SAFE_IP'] ?></label>
							<div class="col-md-4">
								<div class="input-icon right ">
									<i class="fa"></i>
						...
						<div class="form-group display-hide loginDiv">
							...
							<div class="col-md-4">
								<select class="form-control select2me" id="loginType">
		...
		<div id="agentModal" class="modal xmodal fade form-horizontal " tabindex="-1" data-focus-on="input:first" data-backdrop="static">
			<div class="modal-header ">
				...
				<h4 class="modal-title"><i class="viconfont vicon-ge_download"></i> <?php echo $LANG['UI_VCENTER_DOWNLOAD_AGENT'] ?>
				</h4>
			</div>
				...
				<div class="portlet-body">
					<div class="list-option">
						<div class="row">
							...
							<!-- 版本 -->
							<div class="version_pick_wrapper">
...
<script src="./scripts/vm/add_vcenter.js" type="text/javascript"></script>