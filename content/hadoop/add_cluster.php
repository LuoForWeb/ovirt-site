...
<h3 class="breadcrumb">
    ...
    <span>></span>
    <span class="curent"><?php echo $LANG['WEB_HADOOP_ADD_CLUSTER']?></span>
</h3>
<div class="row row-manager">
	<div class="col-md-12 col-manager" id='AddClusterDiv'>
		<!-- BEGIN TAB PORTLET-->
		<div class="portlet box blue-hoki" >
			<div class="portlet-title">
				<div class="caption" >
					<i class="viconfont vicon-danchuangtianjia mt2"></i><?php echo $LANG['WEB_HADOOP_ADD_CLUSTER']?>
				</div>
        </div>
                                    ...
                                    <div class="panel panel-default strategy-panel">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle accordion-toggle-styled collapsed popovers" data-container="body" data-trigger="hover" data-placement="top" data-toggle="collapse" data-parent=".strategyOne" href="#nodeinfo" aria-expanded="true" >
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3" style="padding-left: 0;padding-top: 5px">
                                                            <label>
                                                                <input type="checkbox" id="sslConnect" checked data-checkbox="icheckbox_square-blue"
                                                                    class="icheck">
...
?>
<script src="./scripts/hadoop/add_cluster.js" type="text/javascript">
