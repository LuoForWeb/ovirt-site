...
$allPermission = $_SESSION['permission'];
?>
...
<h3 class="breadcrumb">
    ...
    <span class="curent"><?php echo $LANG['UI_RECOVERY_FOR_OBS'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="row recover-page">
    <div class="col-md-12" style="height: 100%;">
        <div class="portlet box blue-hoki" id="obs_recover_content">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <i
                        class="levelchild viconfont vicon-huifu1"></i><?php echo $LANG['UI_OBS_CREATE_OBS_RECOVER_TASK'] ?>
                </div>
            </div>
                            ...
                            <div class="form-body-content">
                                ...
                                <div class="tab-content bakuptab">
                                        ...
                                        <div class="row tab-pane__row">
                                            <div class="col-md-4 tab-pane__row__source">
                                                <div class="form-group src-wrap">
                                                    ...
                                                    <div class="src-wrap__content has-daterangepicker">
                                                        <div class="src-wrap__content__search">
                                                            <select class="bs-select width100p form-control"
                                                                data-show-subtext="true" id="storage_select">
                                                            </select>
                                                            <div class="vm_tree_div">
                                                                <div class="input-icon width100p">
                                                                    <input type="text" maxlength="128"
                                                                        placeholder="<?php echo $LANG['WEB_OS_SEARCH_NAME'] ?>"
                                                                        class="form-control" id="searchfs" onkeyup="customInputValidate('string', this.value, $(this))" />
                                                                </div>
                                                            </div>
                                                            <div class="src-wrap__content__daterangepicker mt10">
                                                                <input type="text" id="daterangepicker"
                                                                    placeholder="<?php echo $LANG['UI_OBS_SEARCH_BY_BACKUP_DATE'] ?>"
                                                        ...
                                                        <div class="src-wrap__content__itree">
                                                            <div class="fs_tree vcenter-tree">
                                                                <ul id="agent_point_tree"
                                                                    class="ztree bd1de5 ztree-fa tree_div"></ul>
                                                            </div>
                                                            <div class="alert alert-block alert-info fade in display-hide"
                                                                ...
                                                                <ol class="alert-ol">
                                                                    ...
                                                                    <li>
                                                                        <a id="tobackup"
                                                                            class="alert-link"><?php echo $LANG['UI_OBS_BACKUP_THE_OBS_FIRST'] ?></a>
                                                                    </li>
                                                                </ol>
                                                            </div>
                                                            <div class="alert alert-block alert-info fade in display-hide"
                                                                id="nosearchtips" style="margin-right:12px">
                                                                <button type="button" class="close"
                                                                    data-dismiss="alert"></button>
                                                                <ul class="alert-ul">
                                                                    <strong
                                            ...
                                            <div class="col-md-8 VMList-div">
                                                <div class="addTitle">
                                                    <span><?php echo $LANG['UI_OBS_SELECT_THE_OBJECT_THAT_YOU_WANT_TO_RECOVER'] ?></span>
                                                </div>
                                                <div class="addIt-list">
                                                    <div class="recover-source-wrapper display-none">
                                                        <div class="input-group reco-search-group">
                                                            <input id="reco-search-input" type="text"
                                                                class="form-control"
                                                                placeholder="<?php echo $LANG['UI_RECOVERY_FILE_SEARCH_INPUT_TIPS'] ?>"
                                                                aria-describedby="reco-search-btn">
                                                            <span name="start" class="input-group-addon"
                                                                id="reco-search-btn"><?php echo $LANG['UI_PUBLIC_SEARCH'] ?></span>
                                                        </div>
                                                        <div id="seachdes" class="addIt-list__search">
                                                            <div class="ispinner">
                                                            ...
                                                            <span class="colorgreen selectall"
                                                                style="cursor: pointer;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $LANG['UI_RECOVERY_FILE_SELECT_ALL'] ?></span>
                                                            <span class="colorgreen cancelselect"
                                                                style="cursor: pointer;">&nbsp;&nbsp;<?php echo $LANG['UI_RECOVERY_FILE_DESELECT'] ?></span>
                                                            <span class="colorgreen clearval"
                                                                style="cursor: pointer;">&nbsp;&nbsp;<?php echo $LANG['UI_RECOVERY_FILE_CLEAR_FILTER'] ?></span>
                                                        </div>
                                                    ...
                                                    <div class="alert alert-block alert-info fade in" id="step1tips">
                                                        ...
                                                        <p>
                                                            <?php echo $LANG['UI_RECOVERY_OBS_TIPS1'] ?>
                                                        </p>
                                                        <p>
                                                            <?php echo $LANG['UI_RECOVERY_OBS_TIPS2'] ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        ...
                                        <div class="row tab-pane__row">
                                            <div class="col-md-12 col-steptwo-recover">
                                                <div class="form-group " id="recoverpath">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control select2me" id="deviceSelect">
                                                            <?php
                                                            if (in_array("obs_protect", $allPermission)) {
                                                                echo '<option value="4"> ' . $LANG["UI_PLATFORM_OBS"] . ' </option>';
                                                            }
                                                            ?>
                                                            <?php
                                                            if (in_array("filebackup", $allPermission)) {
                                                                echo '<option value="1"> ' . $LANG["UI_FILE_RECOVERY_AGENT"] . ' </option>';
                                                            }
                                                            ?>
                                                            <?php
                                                            if (in_array("nas_protect", $allPermission)) {
                                                                echo '<option value="2"> ' . $LANG["UI_PLATFORM_NAS_DEVICE"] . ' </option>';
                                                            }
                                                            ?>
                                                            <?php
                                                            if (in_array("hadoop_protect", $allPermission)) {
                                                                echo '<option value="3"> ' . $LANG["WEB_HADOOP_CLUSTER"] . ' </option>';
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group form-select-host">
                                                    <label class="control-label col-md-4">
                                                        <span class="required">* </span>
                                                        <span
                                                            class="devicelabel"><?php echo $LANG['UI_OBS_SELECT_THE_OBS'] ?></span>
                                                    </label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="form-group" id="recoverpath">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control select2me" id="pathtype">
                                                            <option value="2">
                                                                <?php echo $LANG['UI_RECOVERY_FILE_DIY_PATH'] ?>
                                                            </option>
                                                            <option value="1">
                                                                <?php echo $LANG['UI_RECOVERY_FILE_OLD_PATH'] ?>
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        <div class="row row-stepthree">
                                            <div class="nav-tabs-wrapper col-md-offset-1 col-md-10">
                                                <ul class="nav nav-tabs nav-line-tabs" id="obs_recovery_mode_tabs">
                                                ...
                                                <div class="tab-content hover-scroll-y" id="obs_recovery_mode_tab_content">
                                                    <!-- BEGIN COMMON STRATEGY -->
                                                    <div class="tab-pane obs-recovery-mode-tab-pane active" id="tab_common">
                                                                            ...
                                                                            <div id="recoveryTime" class="panel-collapse collapse in">
                                                                                <div class="panel-body">
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="form-group display-none setOnceTime">
                                                    ...
                                                    <!-- END COMMON STRATEGY -->
                                                    <!-- BENGIN TRANSMIT STRATEGY -->
                                                    <div class="tab-pane obs-recovery-mode-tab-pane" id="tab_transfer">
                                                        <div class="panel-body">
                                                            <div class="tabbable-custom pdlr15  col-md-10">
                                                                ...
                                                                <!-- 传输代理 -->
                                                                <div class="form-group transfer-agency-form-group display-hide">
                                                                    <label class="control-label col-md-3 form-group-label appliance_agency_flag_label"><?php echo $LANG['UI_PLATFORM_APPLIANCE'] ?></label>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <label
                                                                        class="control-label col-md-3 transferlabel form-group-label">
                                                                        <?php echo $LANG['UI_BACKUP_ENCRYPTION_TRANSFER'] ?></label>
                                                                ...
                                                                if ($_SESSION['authfun']['multithread']) {
                                                                    echo '
																		<!-- 传输线程-->
																		<div class="form-group transmit-thread-form-group">
                                                    ...
                                                    <!-- BEGIN HIGH CONFIG -->
                                                    <div class="tab-pane obs-recovery-mode-tab-pane" id="tab_other">
                                                            ...
                                                            <div class="advance-config-wrap__row row m0">
                                                                <div class="col-md-2 col-sm-2 col-xs-2 nav-tab-radios">
                                                                    <ul class="nav nav-tabs tabs-left">
                                                                        ...
                                                                        <!-- <li class="dwm permission-recover-li">
                                                                            <a href="#permission_recover_pane"
                                                                                data-toggle="tab" aria-expanded="true">
                                                                ...
                                                                <div class="col-md-10 col-sm-10 col-xs-10 pe-0 advance-config-wrap__row__content">
                                                                    <div class="tab-content level1">
                                                                        <div class="tab-pane fade in active" id="abnormal_handle_pane">
                                                                            <div class="abnormal-handle-form">
                                                                                <!-- 文件 & NAS & Hadoop 跳过目录树恢复 -->
                                                                                <div class="form-group advanced-config-file-form-group">
                                                                                    <label class="control-label col-md-5 file-skip-dir-tree-label form-group-label"><?php echo $LANG['UI_RECOVERY_FILE_SKIP_DIR_TREE_RECOVERY'] ?></label>
                                                                                    <div class="col-md-3 form-group-content">
                                                                                        <input type="checkbox"
                                                                                            id="file_skip_dir_tree_flag"
                                                                                            class="make-switch" data-on-color="primary"
                                                                                        ...
                                                                                        <a class="popovers ml15" data-container="body"
                                                                                            data-trigger="hover" data-html="true"
                                                                                            data-placement="right"
                                                                                            data-content="<?php echo $LANG['UI_RECOVERY_FILE_SKIP_DIR_TREE_RECOVERY_TIPS'] ?>">
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <!-- 对象存储 跳过目录树恢复 -->
                                                                                <div class="form-group advanced-config-obs-form-group remove-prefix-form-group">
                                                                                    <label class="control-label col-md-5 obs-skip-dir-tree-label form-group-label"><?php echo $LANG['UI_OBS_REMOVE_PREFIX'] ?></label>
                                                                                    <div class="col-md-3 form-group-content">
                                                                                        <input type="checkbox"
                                                                                        ...
                                                                                        <a class="popovers ml15" data-container="body"
                                                                                            data-trigger="hover" data-html="true"
                                                                                            data-placement="right"
                                                                                            data-content="<?php echo $LANG['UI_OBS_SKIP_DIR_RECOVER_TIP'] ?>">
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>

                                                                                <!-- 文件 & NAS & Hadoop 同名文件处理 -->
                                                                                <div class="form-group advanced-config-file-form-group">
                                                                                    <label class="control-label col-md-5 file-same-name-label form-group-label"><?php echo $LANG['UI_RECOVERY_FILE_PROCESS_SAME_FILE'] ?></label>
                                                                                    <div class="col-md-3 form-group-content">
                                                                                        <select name="" id="file_same_name_handle_type"
                                                                                            class="form-control">
                                                                                            <option value="1">
                                                                                                <?php echo $LANG['UI_RECOVERY_FILE_PROCESS_SAME_FILE_COVER'] ?>
                                                                                            </option>
                                                                                            <option value="2">
                                                                                                <?php echo $LANG['UI_RECOVERY_FILE_PROCESS_SAME_FILE_KEEP_LATEST'] ?>
                                                                                            </option>
                                                                                            <option value="3">
                                                                                                <?php echo $LANG['UI_RECOVERY_FILE_PROCESS_SAME_FILE_ADD'] ?>
                                                                                            </option>
                                                                                            <option value="4">
                                                                                                <?php echo $LANG['UI_RECOVERY_FILE_PROCESS_SAME_FILE_RENAME'] ?>
                                                                                            </option>
                                                                                            <option value="5">
                                                                                                <?php echo $LANG['UI_FILE_COPY_REPLACE'] ?>
                                                                                            </option>
                                                                                        </select>
                                                                                    </div>
                                                                                    <div class="col-md-1 pd0" style="margin-top: 10px">
                                                                                        <a class="popovers" data-container="body"
                                                                                            data-trigger="hover" data-html="true"
                                                                                            data-placement="right"
                                                                                            data-content="<?php echo $LANG['UI_RECOVERY_FILE_PROCESS_SAME_FILE_TIPS'] ?>"
                                                                                            data-original-title="" title="">
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                ...
                                                                                <div class="form-group advanced-config-obs-form-group">
                                                                                    <label class="control-label col-md-5 obs-same-name-label form-group-label"><?php echo $LANG['UI_RECOVERY_OBS_PROCESS_SAME_OBS'] ?></label>
                                                                                    <div class="col-md-3 form-group-content">
                                                                                ...
                                                                                <!-- 文件 & NAS & Hadoop 无效快捷方式清理 -->
                                                                                <div class="form-group display-none">
                                                                                    <label class="control-label col-md-5 clear-shortcut-label form-group-label"><?php echo $LANG['UI_RECOVERY_FILE_INVALID_SHORTCUT_CLEAN'] ?></label>
                                                                                    <div class="col-md-3 form-group-content">
                                                                                        <input type="checkbox" id="clear-shortcut"
                                                                                            class="make-switch" data-on-color="primary"
                                                                                            data-size="small" data-off-color="info"
                                                                                            data-on-text="<?php echo $LANG['UI_PUBLIC_ON'] ?>"
                                                                                            data-off-text="<?php echo $LANG['UI_PUBLIC_OFF'] ?>">
                                                                                        <a class="popovers ml15" data-container="body"
                                                                                            data-trigger="hover" data-html="true"
                                                                                            data-placement="right"
                                                                                            data-content="<?php echo $LANG['UI_RECOVERY_FILE_INVALID_SHORTCUT_CLEAN_TIPS'] ?>">
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="tab-pane fade in" id="permission_recover_pane">
                                                                            <div class="abnormal-handle-form">
                                                                                <!-- 文件 & NAS & Hadoop 文件权限恢复 -->
                                                                                <div class="form-group file-permission-recover-form-group display-none">
                                                                                    <label class="control-label col-md-5 file-permission-recovery-label form-group-label"><?php echo $LANG['UI_FILE_RECOVERY_PERMISSION'] ?></label>
                                                                                    <div class="col-md-3 form-group-content">
                                                                                        <input type="checkbox"
                                                                                            id="file_permission_recovery_flag"
                                                                                            class="make-switch" data-on-color="primary"
                                                                                            data-size="small" data-off-color="info"
                                                                                            data-on-text="<?php echo $LANG['UI_PUBLIC_ON'] ?>"
                                                                                            data-off-text="<?php echo $LANG['UI_PUBLIC_OFF'] ?>">
                                                                                ...
                                                                                <!-- 对象存储 对象权限恢复 -->
                                                                                <div class="form-group obs-permission-recover-form-group display-hide">
                                                                                    <label class="control-label col-md-5 obs-permission-recovery-label form-group-label"><?php echo $LANG['UI_OBS_RECOVERY_PERMISSION'] ?></label>
                                                                                    <div class="col-md-3 form-group-content">
                                                                                        <input type="checkbox"
                                                                                        ...
                                                                                        <a class="popovers ml15" data-container="body"
                                                                                            data-trigger="hover" data-html="true"
                                                                                            data-placement="right"
                                                                                            data-content="<?php echo $LANG['UI_OBS_RECOVERY_PERMISSION_TIPS'] ?>">
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="retry-strategy-content">
                                                                                ...
                                                                                <div class="retry-strategy-content__group retry-group-wrap">
                                                                                    ...
                                                                                    <div class="retry-group-wrap__content">
                                                                                        <!-- 网络重连次数 -->
                                                                                        <div class="form-group network-retry-times-form-group">
                                                                                            <label class="control-label col-md-5 networkRetryTimeLabel"><?php echo $LANG['UI_STRATEGY_NETWORK_RETRY_TIMES'] ?></label>
                                                                                            <div class="col-md-7">
                                                                                        ...
                                                                                        <!-- 网络重连间隔时间 -->
                                                                                        <div class="form-group network-retry-interval-form-group">
                                                                                            <label class="control-label col-md-5 retrytimelabel"><?php echo $LANG['UI_STRATEGY_NETWORK_RETRY_INTERVAL'] ?></label>
                                                                                            <div class="col-md-7">
                                                                                    ...
                                                                                    <div class="retry-strategy-content__group retry-group-wrap">
                                                                                        ...
                                                                                        <div class="retry-group-wrap__content">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div class="col-md-7">
                                                                                                    <input type="checkbox" checked id="op_retry_flag" data-size="small" class="make-switch" data-on-color="primary" data-off-color="info" data-on-text="" data-off-text="">
                                                                                            ...
                                                                                            <div class="operation-retry-wrap">
                                                                                                <!-- 操作重连次数 -->
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-5 retrytimelabel"><?php echo $LANG['UI_STRATEGY_OP_RETRY_TIMES'] ?></label>
                                                                                                    <div class="col-md-7">
                                                                                                        <div id="op_retry_times_spinner" class="max-w-150px">
                                                                                                            <div class="input-group spinner-group">
                                                                                                                <input type="text" id="op_retry_times"
                                                                                                                    onkeyup="value=value.replace(/[^\d]/g,'')"
                                                                                                                    class="spinner-input form-control input-sm"
                                                                                                                    maxlength="3">
                                                                                                                <div class="spinner-buttons input-group-btn spinner-group-btn">
                                                                                                ...
                                                                                                <!-- 操作重连间隔时间 -->
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-5 retrytimelabel"><?php echo $LANG['UI_STRATEGY_OP_RETRY_INTERVAL'] ?></label>
                                                                                                    <div class="col-md-7">
                                                                                                        <div id="op_retry_interval_spinner" class="max-w-150px">
                                                                                                            <div class="input-group spinner-group">
                                                                                                                <input type="text" id="op_retry_interval" onkeyup="value=value.replace(/[^\d]/g,'')" class="spinner-input form-control input-sm" maxlength="3">
                                                                                                                <div class="spinner-buttons input-group-btn spinner-group-btn">
                                                                                                                    <button type="button" class="btn spinner-up default input-sm">
                                                                                                                        <i class="fa fa-angle-up"></i>
                                                                                                                    </button>
                                                                                    ...
                                                                                    <div class="retry-strategy-content__group retry-group-wrap">
                                                                                        ...
                                                                                        <div class="retry-group-wrap__content">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div class="col-md-7">
                                                                                                    <input type="checkbox" checked id="task_retry_flag" data-size="small" class="make-switch" data-on-color="primary" data-off-color="info" data-on-text="" data-off-text="">
                                                                                            ...
                                                                                            <div class="task-retry-wrap">
                                                                                                <!-- 重连对象 -->
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-5 form-group-label"><?php echo $LANG['UI_STRATEGY_TASK_RETRY_OBJECT'] ?></label>
                                                                                                    <div class="col-md-4">
                                                                                                        <select class="form-control select2me inline-block" id="task_retry_object">
                                                                                                            <option value="1">
                                                                                                ...
                                                                                                <!-- 任务重连次数 -->
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-5 retrytimelabel"><?php echo $LANG['UI_STRATEGY_TASK_RETRY_TIMES'] ?></label>
                                                                                                    <div class="col-md-7">
                                                                                                        <div id="task_retry_times_spinner" class="max-w-150px">
                                                                                                            <div class="input-group spinner-group">
                                                                                                                <input type="text" id="task_retry_times" onkeyup="value=value.replace(/[^\d]/g,'')" class="spinner-input form-control input-sm" maxlength="3">
                                                                                                                <div class="spinner-buttons input-group-btn spinner-group-btn">
                                                                                                                    <button type="button" class="btn spinner-up default input-sm">
                                                                                                                        <i class="fa fa-angle-up"></i>
                                                                                                                    </button>
                                                                                                ...
                                                                                                <!-- 任务重连间隔时间 -->
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-5 retrytimelabel"><?php echo $LANG['UI_STRATEGY_TASK_RETRY_INTERVAL'] ?>
                                                                                                    </label>
                                                                                                    <div class="col-md-7">
                                                                                                        <div id="task_retry_interval_spinner" class="max-w-150px">
                                                                                                            <div class="input-group spinner-group">
                                                                                                                <input type="text" id="task_retry_interval" onkeyup="value=value.replace(/[^\d]/g,'')" class="spinner-input form-control input-sm" maxlength="3">
                                                                                                                <div class="spinner-buttons input-group-btn spinner-group-btn">
                                                                                                                    <button type="button" class="btn spinner-up default input-sm">
                                                                                                                        <i class="fa fa-angle-up"></i>
                                                                                                                    </button>
                                    ...
                                    <div class="tab-pane" id="tab4">
                                        <div class="tab-pane__body">
                                            <div class="tab-pane__body__form">
                                                ...
                                                <div class="form-group mb0 mt10">
                                                    <label
                                                        class="control-label col-md-3"><?php echo $LANG['UI_RECOVERY_FILE_DATA_SRC'] ?>:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group mb0 mt10">
                                                    <label
                                                        class="control-label col-md-3"><?php echo $LANG['UI_RECOVERY_FILE_DATA_SRC_TASK'] ?>:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group mb0 mt10">
                                                    <label
                                                        class="control-label col-md-3"><?php echo $LANG['UI_RECOVERY_BACKUP_POINT'] ?>:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group mb0 mt10">
                                                    <label
                                                        class="control-label col-md-3"><?php echo $LANG['UI_OBS_RECOVER_OBS_LIST'] ?>:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group mb0 mt10 recover2agentdiv">
                                                    <label
                                                        class="control-label col-md-3"><?php echo $LANG['UI_RECOVERY_GOAL'] ?>:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group mb0 mt10">
                                                    <label
                                                        class="control-label col-md-3"><?php echo $LANG['UI_RECOVERY_FILE_PATH'] ?>:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group mb0 mt10">
                                                    <label
                                                        class="control-label col-md-3"><?php echo $LANG['UI_RECOVERY_TYPE'] ?>:</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group mb0 transferDiv display-none">
                                                    <label
                                                        class="control-label col-md-3"><?php echo $LANG['UI_BACKUP_TRANSFER_STRATEGY'] ?>:</label>
                                                    <div class="col-md-9">
                                                        <p class="form-control-static transfershow"></p><br>
                                                    </div>
                                                </div>
                                                <div class="form-group confirm-config-safety-form-group mb0 mt10">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-control-static">
                                                            <div class="confirm-integrity-check-abnormal-handle"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group mb0 highDiv">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-control-static">
                                                            ...
                                                            <div class="clearshortcutshow"></div>
                                                            <div class="permissionrecoveryshow"></div>
                                                            <div class="confirm-advanced-config-network-retry-times"></div>
                                                            <div class="confirm-advanced-config-network-retry-interval"></div>
                                                            <div class="confirm-advanced-config-op-retry"></div>
                                                            <div class="confirm-advanced-config-op-retry-times display-none"></div>
                                                            <div class="confirm-advanced-config-op-retry-interval display-none"></div>
                                                            <div class="confirm-advanced-config-task-retry"></div>
                                                            <div class="confirm-advanced-config-task-retry-object display-none"></div>
                                                            <div class="confirm-advanced-config-task-retry-times display-none"></div>
                                                            <div class="confirm-advanced-config-task-retry-interval display-none"></div>
                                                            <div class="confirm-advanced-config-overload-protection"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-offset-6 col-md-6">
                                    <a href="javascript:;" class="btn default button-previous">
                                        ...
                                        <?php echo $LANG['UI_PUBLIC_PREV_STEP'] ?> </a>
    ...
    <div id="speedlimitModal" class="modal xmodal fade form-horizontal " tabindex="-1" data-focus-on="input:first"
        ...
        <div class="modal-header ">
            ...
            <h4 class="modal-title"><i class="iconfont icon-xiansucelve"></i>
...
<script type="text/javascript" src="./scripts/backupData/clipboard.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
<script src="./scripts/s3/obsrecover.js" type="text/javascript"></script>