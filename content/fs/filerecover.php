...
<h3 class="breadcrumb">
	...
	<span class="curent"><?php echo $LANG['UI_PLATFORM_FILERECOVER'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="row recover-page">
	<div class="col-md-12" style="height: 100%;">
		<div class="portlet box blue-hoki" id="filerecovercontent">
		...
		<input id="externalItemUuid" value="<?php echo $_GET['item_uuid']; ?>" class="display-none"></input>
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-huifu1"></i><?php echo $LANG['UI_FILE_NEW_TASK_RECOVER'] ?>
				</div>
			</div>
														...
														<div class="src-wrap__content__search">
															...
															<div class="vm_tree_div">
																<div class="input-icon width100p">
																	...
																	<!--                                                                    <div class="date-picker-div btn-group">-->
																	<!--                                                                        <button class="btn table-toolbar-btn mt5" id="daterangepicker" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">-->
																	<!--                                                                            <i class="icon-time"></i>-->
																	<!--                                                                            --><?php //echo $LANG['UI_JOB_TIME_RANGE'] ?>
																	<!--                                                                        </button>-->
																	<!--                                                                    </div>-->
														...
														<div class="src-wrap__content__itree"
															...
															<div class="alert alert-block alert-info fade in display-hide"
																...
																<ol class="alert-ol">
																	...
																	<li>
																		<a id="tobackup"
																			class="alert-link"><?php echo $LANG['UI_RECOVERY_TO_BAK'] ?></a>
																	</li>
																</ol>
															</div>
															<div class="alert alert-block alert-info fade in display-hide"
									...
									<div class="tab-pane" id="tab3">
										<div class="row row-stepthree">
											<div class="nav-tabs-wrapper col-md-offset-1 col-md-10">
												<ul class="nav nav-tabs fs-nav-tabs nav-line-tabs" id="fs_recovery_mode_tabs">
												...
												<div class="tab-content fs-tab-content hover-scroll-y"
													id="fs_recovery_mode_tab_content">
															...
															<div class="advance-config-wrap__row row m0">
																...
																<div class="col-md-10 col-sm-10 col-xs-10 pe-0 advance-config-wrap__row__content">
																	<div class="tab-content level1">
																		<div class="tab-pane fade active in" id="abnormal_handle_pane">
																		...
																		<div class="tab-pane fade" id="permission_handle_pane">
																			<div class="abnormal-handle-form">
																		...
																		<!-- 重试 -->
																		<div class="tab-pane" id="retry_strategy_pane">
									...
									<div class="tab-pane" id="tab4">
										<div class="tab-pane__body">
											<div class="tab-pane__body__form">
												...
												<div class="form-group mb0 mt10">
													<label
														class="control-label col-md-3"><?php echo $LANG['UI_STRATEGY_TIME'] ?>:</label>
													<div class="col-md-9">
...
<script src="./scripts/fs/filerecover.js" type="text/javascript"></script>