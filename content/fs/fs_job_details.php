...
<!-- BEGIN PAGE CONTENT-->
<div class="row job-detail" id="fsJobDetail">
        ...
        <div class="job-detail__halfbottom__portlet">
            <div class="portlet-title">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#files" data-toggle="tab" id="srcList">
                        </a>
                    </li>
                    <li>
            ...
            <div class="portlet-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane overflow-y-auto" id="files">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12 file-table-toolbar">
                                    <div class="search input-group mr12 is-backup-static-info">
                                        <input class="file-detail-search customSearch" autocomplete="off" type="text" maxlength="64" placeholder="<?php echo $LANG['UI_FILE_SRC_NAME_SEARCH'] ?>">
                                        <div class="position0">
                                    ...
                                    <div class="btn-group dropdown-wrapper fsStartDiv">
                                        ...
                                        <ul class="dropdown-menu min-width100" role="menu">
                                            <li class="startFullTable"><a class="btn dropdown-menu__item me-0" type="button"><i class="viconfont vicon-ge_play"></i><?php echo $LANG['UI_BACKUP_FULL'] ?></a></li>
                                            <li class="startIncrTable"><a class="btn dropdown-menu__item me-0" type="button"><i class="viconfont vicon-ge_increment"></i><?php echo $LANG['UI_BACKUP_INCREMENT'] ?></a></li>
                                            <li class="startDiffTable"><a class="btn dropdown-menu__item me-0" type="button"><i class="viconfont vicon-ge_differentia_backup"></i><?php echo $LANG['UI_BACKUP_DIFFERENCE'] ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="drawer-content drawer-content-scrollable" role="document">
        ...
        <div class="drawer-body config-detail-wrap config-detail-drawer-backup">
            ...
            <div class="config-detail-wrap__group strategy-group">
                ...
                <div class="strategy-group__title is-backup-static-info">
            ...
            <div class="config-detail-wrap__group strategy-group">
                ...
                <div class="strategy-group__form">
                    ...
                    <div class="strategy-group__form__item backup-transfer-encrypt-method-form-item display-none">
                     ...
                     <!-- 扫描线程 -->
                     <div class="strategy-group__form scan-thread-num-form is-backup-static-info">
                        <div class="strategy-group__form__item">
                            <div class="strategy-group__form__item__label col-md-4">
                                <?php echo $LANG['UI_FILE_BAK_SCAN_THREAD'] ?></div>
                            <div id="scan_thread_num" class="strategy-group__form__item__value col-md-8"></div>
                        </div>
                    </div>
                     <!-- 扫描文件速度 -->
                     <div class="strategy-group__form scan-file-speed-form is-backup-static-info">
                        <div class="strategy-group__form__item">
                            <div class="strategy-group__form__item__label col-md-4">
                                <?php echo $LANG['UI_FILE_BAK_SCAN_FILE'] ?></div>
                            <div id="scan_file_speed" class="strategy-group__form__item__value col-md-8"></div>
                        </div>
                    </div>
                    <?php
                    if ($authfun['multithread']) {
                        echo '
                                <!-- 传输线程 -->
                                <div class="strategy-group__form__item transfer-thread-num-form">
                                    <div class="strategy-group__form__item__label col-md-4">
                                        ' . $LANG['WEB_KUBE_RECOVERY_TRANSFER_THREADS'] . '
                                    </div>
                                    <div id="backup_transfer_thread_num" class="strategy-group__form__item__value col-md-8">
                                    </div>
                                </div>
                            ';
                    }
            ...
            <div class="config-detail-wrap__group strategy-group safeDiv">
                <div class="strategy-group__header">
                ...
                <div class="strategy-group__form is-backup-static-info">
                    ...
                    <div class="strategy-group__form__item integrity-form-item">
                        <div class="strategy-group__form__item__label col-md-4">
                            <?php echo $LANG['UI_CBR_SYNC_INTEGRALITY_CHECK'] ?></div>
                        <div id="integrity_check_flag" class="strategy-group__form__item__value col-md-8">
                        </div>
                    </div>
                </div>
                <!-- 恢复完整性校验异常处理 -->
                <div class="strategy-group__form is-recovery-static-info integrity-form-item">
                    <div class="strategy-group__form__item">
                        <div class="strategy-group__form__item__label col-md-4">
            ...
            <div class="config-detail-wrap__group strategy-group">
                <div class="strategy-group__header">
                    <i class="viconfont vicon-gaojipeizhi me-4"></i><span
                        class="strategy-group__header__text"><?php echo $LANG['UI_USER_HIGH_SETTING'] ?></span>
                </div>
                ...
                <div class="is-backup-static-info">
                    <div class="strategy-group__title">
                ...
                <?php
					...
					if ($authfun['fileArchiveMode']) {
						echo '
						<div class="is-backup-static-info">
                            <div class="strategy-group__title">
                                <span class="decoration me-4"></span><span class="strategy-group__title__text">'. $LANG['UI_PLATFORM_ARCHIVE'] .'</span>
                            </div>
                            <div class="strategy-group__form">
                                <!-- 归档 -->
                                <div class="strategy-group__form__item archive-transmit-form-item">
                                    <div class="strategy-group__form__item__label col-md-4">
                                        '. $LANG['UI_PLATFORM_ARCHIVE'] .'</div>
                                    <div id="archivecheck" class="strategy-group__form__item__value col-md-8"></div>
                                </div>
                                <!-- 归档目标 -->
                                <div class="strategy-group__form__item archive-select-form-item">
                                    <div class="strategy-group__form__item__label col-md-4">
                                        '. $LANG['UI_FILE_ARCHIVE_DESTINATION'] .'</div>
                                    <div id="archiveSelect" class="strategy-group__form__item__value col-md-8"></div>
                                </div>
                            </div>
                        </div>
						';
                ...
                <div class="permissionDiv">
                    ...
                    <div class="strategy-group__form">
                        ...
                        <div class="strategy-group__form__item permission-form-item is-backup-static-info">
                            <div class="strategy-group__form__item__label col-md-4">
                                <?php echo $LANG['UI_ROLE_PERMISSION'] ?></div>
                            <div id="permission" class="strategy-group__form__item__value col-md-8"></div>
                        </div>
                        <!-- 文件权限恢复 -->
                ...
                <div class="">
                    ...
                    <div class="strategy-group__form">
                        <!-- 跳过文件告警智能判断 -->
                        <div class="strategy-group__form__item passfilealarm-form-item is-backup-static-info">
                            <div class="strategy-group__form__item__label col-md-4">
                        ...
                        <!-- 跳过文件告警个数 -->
                        <div class="strategy-group__form__item pass-des-form-item is-backup-static-info">
                            <div class="strategy-group__form__item__label col-md-4">
                        ...
                        <!-- 跳过目录树恢复 -->
                        <div class="strategy-group__form__item file-skip-dir-form-item is-recovery-static-info">
                            <div class="strategy-group__form__item__label col-md-4">
                                <?php echo $LANG['UI_RECOVERY_FILE_SKIP_DIR_TREE_RECOVERY'] ?></div>
                            <div id="file_skip_dir" class="strategy-group__form__item__value col-md-8"></div>
                        </div>
                         <!-- 同名文件处理 -->
                        <div class="strategy-group__form__item file-same-name-form-item is-recovery-static-info">
                            <div class="strategy-group__form__item__label col-md-4">
                         ...
                         <!-- 无效快捷方式清理 -->
                        <div class="strategy-group__form__item clear-shortcut-form-item is-recovery-static-info">
                            <div class="strategy-group__form__item__label col-md-4">
                                <?php echo $LANG['UI_RECOVERY_FILE_INVALID_SHORTCUT_CLEAN'] ?></div>
                            <div id="clear_shortcut" class="strategy-group__form__item__value col-md-8"></div>
                        </div>
                    </div>
                </div>
                <!-- END ABNORMAL GROUP -->
...
<script type="text/javascript" src="./scripts/fs/fs_job_details.js"></script>
