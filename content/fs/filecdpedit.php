	...
	<div class="col-md-12">
		...
		<div class="portlet box blue-hoki full-height-content full-height-content-scrollable" id="filecdpcontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="iconfont icon-fscdp"></i><?php echo $LANG['UI_BACKUP_NEW_TASK']?>
				</div>
			</div>
						...
						<div class="form-body">
							...
							<div class="tab-content bakuptab">
								<div class="tab-pane active" id="tab1">
									<h4 class="block">请选择您需要实时同步的文件</h4>
									<div
...
<!-- 															<option value="1">选择备份目的主机</option> -->
												...
												<div class="col-md-1 mt10">
													<a class="popovers" data-container="body"
														...
														echo "实时同步:实时同步数据到备份主机" . "<br><br>" .  
														     "实时同步+历史数据:实时备份数据到备份主机,当生产主机删除或修改文件后,会保存删除或修改的文件到备份主机历史目录" . "<br><br>";
														...
														<div class="col-md-12 ">
															...
															<div class="form-group ">
																...
																<div class="col-md-1 mt10">
																	<a class="popovers" data-container="body"
																		data-trigger="hover" data-placement="right"
																		data-content="开启配置后同步端会完全跟生产端数据一致,多余的数据会删除,如果关闭此项,生产端数据删除后,同步端数据不会删除">
																		<i class="fa fa-info-circle fa-lg"></i>
																	</a>
																</div>
															</div>
															<div class="form-group ">
																<label class="control-label col-md-3 " id="emptydirlabel">空目录备份</label>
																<div class="col-md-4">
																...
																<div class="col-md-1 mt10">
																	<a class="popovers" data-container="body"
																		data-trigger="hover" data-placement="right"
																		data-content="开启配置后同步端会备份生产端的空目录,关闭后不同步空目录">
																		<i class="fa fa-info-circle fa-lg"></i>
																	</a>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-md-4">
																	<select class="form-control select2me" id="ransomwaretype">
																		...
																		<option value="2">指定文件类型同步</option>
																	</select>
																</div>
																<div class="col-md-1 mt10">
																	<a class="popovers" data-container="body"
														...
														<div class="col-md-12 ">
															...
															<div class="form-group display-none timefilterdiv">
																...
																<div class="col-md-4">
																	<select class="form-control select2me" id="timefiltertype">
																		<option value="1">按天过滤(备份最近几天)</option>
																		<option value="2">按月过滤(备份最近几月)</option>
            															<option value="3">按年过滤(备份最近几年)</option>
																	</select>
																</div>
															</div>
															<div class="form-group display-none timefilterdiv">
                                    						...
                                    						<div class="form-group ">
																...
																<div class="col-md-1 mt10">
																	<a class="popovers" data-container="body"
																		data-trigger="hover" data-placement="right"
																		data-content="按名称排除指定文件/文件夹,不备份">
																		<i class="fa fa-info-circle fa-lg"></i>
																	</a>
																</div>
															</div>
															<div class="form-group display-none namefilterdiv">
                                                    			...
                                                    			* </span>
                                                    			...
                                                    			<div class="col-md-4">
                                                    				...
                                                    				<div><span class="help-block ">
                                                    					排除指定名称文件/文件夹不备份,可以使用通配符?和*,?表示匹配一个字符,*表示匹配多个字符,多个匹配项使用逗号分隔
                                                    				</span></div>
                                                    			</div>
                                                    		</div>
														</div>
														...
														<div class="col-md-12 ">
															<div class="form-group">
																...
																<div class="col-md-1 mt10">
																	<a class="popovers" data-container="body"
																		data-trigger="hover" data-placement="right"
																		data-content="全天备份所有时间内都会进行同步,指定时间段备份只会在指定的时间段内同步数据">
																		<i class="fa fa-info-circle fa-lg"></i>
																	</a>
																</div>
															</div>
								...
								<div class="tab-pane" id="tab4">
									...
									<div class="form-group mb0">
										<label class="control-label col-md-3">备份文件/文件夹:</label>
										<div class="col-md-7">
...
<script src="./scripts/fs/filecdpedit.js" type="text/javascript"></script>