	...
	<div class="col-md-12" style="height: 100%;">
		<div class="portlet box blue-hoki backup-page" id="filebackupcontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="viconfont vicon-xiugai"></i><?php echo $LANG['UI_BACKUP_FILE_EDIT_TASK'] ?>
				</div>
			</div>
												...
												<div class="src-wrap__content">
													<div class="src-wrap__content__search">
														...
														<div class="vm_tree_div">
															<div class="searchDiv display-none">
																<div>
																		...
																		<div class="abnormal-handle-form">
																			...
																			if ($authfun['fileArchiveMode']) {
																				echo '
																						...
																						<div class="archivedes form-group" style="color: red;">
																	 						<label class="control-label col-md-4"></label>
																							 <div class="col-md-3">
																								' . $LANG["UI_FILE_PERMANENT_EDIT_DES"] . '
																							 </div>
																	 					</div> 
																						';
																			}
											...
											<div class="form-group mb0 mt10">
												...
												<div class="col-md-9">
													<p class="form-control-static">
														<span class="transferinfoshow"></span><br>
...
<script src="./scripts/fs/filebackupedit.js" type="text/javascript"></script>