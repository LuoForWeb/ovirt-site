    ...
    <div class="col-md-12" style="height:100%;">
        ...
        <div class="portlet box blue-hoki backup-page" id="dbbackupcontent">
            <div class="portlet-title">
                <div class="caption">
                    <i class="viconfont vicon-xiugai"></i> <?php echo $LANG['UI_DB_MODIFY_BACKUP_JOB'] ?>
                </div>
            </div>
                                    ...
                                    <div class="row tab-pane__row">
                                            ...
                                            <div class="form-group src-wrap">
                                                ...
                                                <div class="src-wrap__content">
                                                    <div class="src-wrap__content__search">
                                                        <select class="bs-select width100p" data-show-subtext="true" id="dbtype">
                                                            <option value="0">&nbsp;</option> <!-- 默认不选中 -->
                                                        </select>
                                        ...
                                        <div class="col-md-8 notipsDiv">
                                            <div class="alert alert-block alert-info fade in" id="step1tips">
                                                ...
                                                <!--												<p>-->
                                                <?php //echo $LANG['UI_DB_BACKUP_TIPS_PS'] ?><!--</p>-->
                                            </div>
                                            <!-- 没有可用数据库提示 -->
                                            <div class="alert alert-block alert-info fade in display-hide"
                                                 id="noDBTips">
                        ...
                        <div class="form-actions form-actions--modify">
                            <div class="row">
                                <div class="col-md-offset-6 col-md-6">
                                    ...
                                    <a href="javascript:;" class="btn green-haze button-submit" style="visibility: hidden">
...
<script src="./scripts/dbprotect/dbbackupedit.js" type="text/javascript"></script>