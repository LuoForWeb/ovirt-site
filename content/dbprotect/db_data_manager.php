	...
	<div class="col-md-12">
		...
		<div class="portlet box blue-hoki">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-vmdata"></i><?php echo $LANG['UI_DB_BACKUP_DATA']?>
				</div>
			</div>
			     ...
			     <div class="row">
			         <div class="col-md-4">
			             <div class="portlet">
			                <div class="portlet-title">
                				<div class="caption">
                					<i class="viconfont vicon-ge_database_tasks"></i><?php echo $LANG['UI_DB_JOB_LIST']?>
                				</div>
                			</div>
                			<div class="portlet-body batchDeleteDiv">
                    			...
                    			<div id="nodeCheck" style="margin-top:10px;margin-bottom:10px;">
                    			    <select class="bs-select width50p dataBorder" style="height:34px;padding-left: 12px" data-show-subtext="true" id="nodeselect" >
                    			        
                                    </select>
<!--                                    <div class="input-icon right float-right width45p">-->
<!--                    				    <input type="text" maxlength="128" placeholder="--><?php //echo $LANG['UI_COPY_SEARCH_AS_KEYWORD']?><!--" class="form-control " id="searchvm"/>-->
<!--                    		        </div>-->
                			    ...
                			    <div class="vcenter-tree" >
        							...
        							<ul id="database_tree" class="ztree ztree-fa tree-scroll" ></ul>
								</div>
                			</div>
			             </div>
			         </div>
			         <div class="col-md-8">
			             <div class="portlet ">
			                <div class="portlet-title">
                				<div class="caption">
                					<i class="viconfont vicon-ge_time_point"></i><?php echo $LANG['UI_DATA_BACKUP_POINT']?>
                			...
                			<div class="alert alert-block alert-info fade in"  id="tabletips">
                                ...
                                <ol class = "alert-ol">
                                    <li><?php echo $LANG['UI_DB_DATA_TIPS1']?></li>
                                    <li><?php echo $LANG['UI_DB_DATA_TIPS2']?></li>
                                    <li><?php echo $LANG['UI_DATA_VM_TIPS3']?></li>
                                    <li><?php echo $LANG['UI_DATA_VM_TIPS4']?></li>
                                </ol>
							</div>
                			<div class="portlet-body display-none" id="dbtable">
                				<!-- search -->
                			    ...
                			    <div class="table-container">
                					<table class="table table-hover lh2" id="datatable">
                					<thead>
                			...
                			<div class="alert alert-block alert-info fade in display-none" id="marktips">
                                ...
                                <ul class="alert-ul">
                                    <strong class="alert-ul-head"><?php echo $LANG['UI_PUBLIC_TIPS']?>:</strong>
                                    <li>
                                        <?php echo $LANG['UI_DATA_STAR_TIPS']?>
                                    </li>
                                </ul>
							</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <label style="padding-right: 20px;">
                                    ...
                                    <i class="viconfont vicon-remark-forever"></i><?php echo $LANG['WEB_VM_GFS_FOREVER_POINT']?>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-option" id="startTimeDiv">
                        <div class="row">
                            ...
                            <div class="col-md-5 daterangepickerdiv">
                                <input type="text" id="daterangepickerDbData" class="form-control" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <select class="form-control select2me" id="timepointType">
                                    <option data-type="all" value="0"><?php echo $LANG['UI_PUBLIC_ALL']?></option>
                                    <option data-type="full" value="1"><?php echo $LANG['UI_BACKUP_FULL']?></option>
                                    <option data-type="incr" value="2"><?php echo $LANG['UI_BACKUP_INCREMENT']?></option>
                                    <option data-type="diff" value="3"><?php echo $LANG['UI_BACKUP_DIFFERENCE']?></option>
                                    <option data-type="log" value="4"><?php echo $LANG['UI_DB_BACKUP_LOG']?></option>
                                    <option data-type="archiveLog" value="4"><?php echo $LANG['UI_BACKUP_ARCHIVE_LOG']?></option>
                                </select>
                            </div>
...
<script type="text/javascript" src="./scripts/dbprotect/db_data_manager.js"></script>
