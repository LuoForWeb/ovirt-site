    ...
    "BakTreeConf" => array(
        ...
        1 => array(
            ...
            "child" => array(
                ...
                array("title" => Xphp::$_lang['UI_PLATFORM_GLOBAL_STRATEGY'], "name" => "global_strategy", "bakFuntion" => "backupGlobalStrategy", "recFunction" => "recoveryGlobalStrategy"),
                array("title" => Xphp::$_lang['UI_GLOBAL_STRATEGY_SPEED_LIMIT'], "name" => "global_speed_limit_strategy", "bakFuntion" => "backupGlobalSpeedLimitStrategy", "recFunction" => "recoveryGlobalSpeedLimitStrategy"),
        ...
        */
        ...
        5 => array(
            ...
            "child" => array(
                ...
                array("title" => Xphp::$_lang['UI_CLIENT_MANAGER'], "name" => "bd_agent_manager", "bakFuntion" => "backupAgentManager", "recFunction" => "recoveryAgentManager"),
...
//                array("title" => Xphp::$_lang['UI_PLATFORM_APPLIANCE'], "name" => "appliance", "bakFuntion" => "backupApplianceManager", "recFunction" => "recoveryApplianceManager"),
                array("title" => Xphp::$_lang['UI_PLATFORM_VIRTUAL_LAB'], "name" => "sr_virtual_manager", "bakFuntion" => "backupSrvirtualManager", "recFunction" => "recoverySrvirtualManager"),
                array("title" => Xphp::$_lang['UI_PLATFORM_NAS_DEVICE'], "name" => "nas_device_manager", "bakFuntion" => "backupNasDeviceManager", "recFunction" => "recoveryNasDeviceManager"),
                array("title" => Xphp::$_lang['WEB_PLATFORM_DES_M365'], "name" => "platform_m365", "bakFuntion" => "backupM365Manager", "recFunction" => "recoveryM365Manager"),
                array("title" => Xphp::$_lang['WEB_PLATFORM_DES_HADOOP'], "name" => "platform_hadoop", "bakFuntion" => "backupHadoopManager", "recFunction" => "recoveryHadoopManager"),
                array("title" => Xphp::$_lang['WEB_PLATFORM_DES_OBS'], "name" => "platform_obs", "bakFuntion" => "backupObsManager", "recFunction" => "recoveryObsManager"),
            ),
        ),
