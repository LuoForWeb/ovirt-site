...
use app\v1\complete_machine_os\v0\service\Service;
 ...
 */
class MachineOsJobController extends JobController
{
    /**
     * 启动任务 demo
    ...
    public function startJob(string $taskUuid, int $startType)
    {
        ...
        return $this->opUnifyMsg($taskUuid, $opName, $msg, false, true,$submodule_type);
    }
     ...
     * @return void
     */
    private function opUnifyMsg(string $taskUuid, string $opName, array $msg, $sync = false, $command = false,$submodule_type)
    {
        $mbResult = (new Service())->opUnifyMsg($taskUuid, $opName, $msg, $sync, $command, $submodule_type);
