...
class FileJobController extends JobController
{
    ...
    public function startJob(string $taskUuid, int $startType)
    {
        ...
        return $this->opUnifyMsg($taskUuid, $opName, $msg, false, true, 1);
    }
     ...
     * @return void
     */
    private function opUnifyMsg(string $taskUuid, string $opName, array $msg, $sync = false, $command = false , $submodule_type = 0)
    {
