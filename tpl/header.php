...
<head>
    ...
    <link href="./assets/global/plugins/bootstrap-drawer/css/bootstrap-drawer.css" rel="stylesheet" type="text/css" />
    ...
    //获取主题布局
    $theme_layout = $_SESSION['theme_layout'];
    if (!empty($theme_skin)) {
        echo '<link href="../css/themeSkin/' . $theme_skin . '.css" rel="stylesheet" type="text/css"/>';
    }
    if (!empty($theme_layout)) {
        echo '<link href="../css/themeSkin/' . $theme_layout . '.css" rel="stylesheet" type="text/css"/>';
    }
    ?>
</head>
<!-- END HEAD -->