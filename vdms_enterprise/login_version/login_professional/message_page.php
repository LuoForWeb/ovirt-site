...
<div class="reset-content" style="display: <?php echo $show == 'reset_success' ? 'block' : 'none'; ?>">
    <div class="form-content">
        ...
        <div class="tips">
            <div class="success"><img src="/img/platform/resetPwdSuccess.png" alt=""></div>
        ...
        <div class="form-action">
            <a href="/login.php"><button class="btn" type="submit"><?php echo $LANG['UI_RESETPWDSUCCESS_LOGIN'];?></button></a>
            <div class="line"></div>
            <div class="returnBack"><a href="/forget_pwd"><?php echo $LANG['UI_RESETPWDSUCCESS_RETURNBACK'];?></a></div>
            <div class="line"></div>
        </div>
    </div>
</div>
