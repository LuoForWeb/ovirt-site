...
return [
    'log' => [ // 模块名
        'Index' => [ // 类名
            ...
            'logs_jobs_running_logs_error_detail'    => [
                'get'       => 'getRunningLogErrorDetail',  // 获取单个任务运行日志的错误详情
            ],
            'logs_jobs_running_logs_script_detail'    => [
                'get'       => 'getRunningLogScriptDetail',  // 获取单个任务运行日志的脚本详情
            ],
        ],
    ],
