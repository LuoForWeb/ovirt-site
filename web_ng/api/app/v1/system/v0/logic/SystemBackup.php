 ...
 * @LastEditTime: 2026-01-16 14:24:44
 * @Version: 2.0
...
class SystemBackup extends Base
{
    ...
    public function systemBackupAuto($params)
    {
        ...
        //生成备份文件,并生成相对URL地址
        $result = $this->exportAutoBakFile($backup_uuid, $node_uuid, $storage_uuid, $nodes);
        if (!$result) {
            //写日志
     ...
     * @return bool
     */
    private function exportAutoBakFile($backup_uuid, $nodeuuid, $storageuuid, $nodes)
    {
        $BACKUP_DIR = xphp_get_config('app', 'TMP_PATH') . "systembak";
