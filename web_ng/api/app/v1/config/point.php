 ...
 * @LastEditTime: 2026-03-13 10:05:35
 * @Version: 2.0
...
return [
    ...
    // bd_backup_timepoint中worm_flag值对应枚举
    'WORM_FLAG_MAP' => [
        'UNKNOWN' => 0 , // 未知
        'CONFIGED' => 1, // 已配置, // 已配置
        'UNSET' => 2, // 未配置
    ...
    'WORM_FLAG_MAP_DES' => [
        0 => xphp_get_lang('WEB_PLATFORM_PUBLIC_UNKNOWN'), // 未知
        1 => xphp_get_lang('UI_DB_NEW_INSTANCE_CONFIG_CONFIGURED'), // 已配置
        2 => xphp_get_lang('UI_DB_NEW_INSTANCE_CONFIG_UNCONFIGURED'), // 未配置
        3 => xphp_get_lang('UI_PUBLIC_EXPIRED'), // 已过期
    ],
];
