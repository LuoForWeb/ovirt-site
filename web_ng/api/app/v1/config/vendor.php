...
//            'SUGON_CLOUD_VIEW_SRM' => 7,    // shu guang, sugon
        ...
        '56' => 'ZStack ZSphere',        // ZStack ZSphere
        '59' => 'NexaVM nSSV',        // NexaVM nSSV, OEM of ZStack ZSphere
        '16' => 'Huawei FusionCompute KVM',// huawei fusion sphere kvm
        '32' => 'Winhong CNware WinStack',                 //winhong kvm
        '28' => 'XCP-ng',               // XCP-ng
        '33' => 'SmartX',                 //smartx kvm
        '58' => 'Arcfra',                 //arcfra kvm
        '42' => 'Proxmox VE',               // Proxmox
        '53' => 'Lenovo AIO',               // Lenovo AIO
        '55' => 'Volcano Cloud',               // Volcano Cloud
        '43' => 'FusionOneCompute KVM',           //Xfusion kvm
        '48' => 'CloudView',           //CloudView KVM
        '61' => 'Nutanix AHV',           //Nutanix AHV KVM
...
//          '13' => 'SDC OS(电科凌云)',             // dianke lingyun sdcos
    ...
    'CLOUDHYPERVISORTYPE' => array(
        ...
        '60' => 'NexaVM nCSSV',        // NexaVM nCSSV, OEM of ZStack Cloud
        '30' => 'XSKY XECCP',                  //XSKY
    ),
...
//                     ),
        ...
        array(
            'text' => 'NexaVM nCSSV',              //NexaVM nCSSV
            'version' => array(
                array(
                    'text' => '3.x/4.x/5.x',
                    'value' => 'stack-cloud.RHEL',
        ...
        array(
            'text' => 'ZStack ZSphere',              //ZStack ZSphere
            'version' => array(
                array(
                    'text' => '3.x/4.x/5.x',
                    'value' => 'stack-cloud.RHEL',
    ...
    //value全部大写,和配置文件AGENT_ENVIRONMENT字段一致,方便调用
    'CLIENT_VENDOR' => array(
        array(
            'text' => 'Windows',
            'value' => 'WINDOWS'
...
//        ),
        ...
        array(
            'text' => '中科红旗RedFlag x86_64',
            'value' => 'ZKRedFlagX86'
        ),
        array(
            'text' => '中科红旗RedFlag aarch64',
            'value' => 'ZKRedFlagAARCH64'
        )
    ),
