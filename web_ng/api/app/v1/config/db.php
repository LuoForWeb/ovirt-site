...
return [
    ...
    //数据库恢复方式描述
    'DB_RECOVERY_DES' => array(
        0 => 'Unknown',
        1 => xphp_get_lang('UI_DB_ORIGINAL_COVERAGE_RECOVERY'), //原机覆盖恢复
        2 => xphp_get_lang('UI_DB_ADD_NEW_DATABASE_RECOVERY'), //新建恢复
        3 => xphp_get_lang('UI_DB_DM_FILE_DIR_RECOVERY'), //指定文件夹恢复
        4 => xphp_get_lang('UI_DB_DM_REDIRECT_RECOVERY'), //重定向目录恢复
        5 => xphp_get_lang('UI_DB_EXPORT_REDIRECT_RECOVERY'), //导出恢复
        6 => xphp_get_lang('UI_DB_PDB_RECOVER'), //PDB恢复
        7 => xphp_get_lang('UI_DB_RESTORE_ARCHIVELOG'), //还原归档日志
        8 => xphp_get_lang('UI_DB_FULL_RECOVERY'), //完全恢复
        9 => xphp_get_lang('UI_DB_INCOMPLETE_RECOVERY'), //不完全恢复
    ),
