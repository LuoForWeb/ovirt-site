...
use app\v1\user\v0\logic\Group;
        ...
        if (xphp_three_powers()) {
            ...
            if ($checkAuth['global_observer']) {
                ...
                $sqlParams = array_merge(
                    $sqlParams,
                    array('a508b813-19c7-eb4e-d6fa-bb61b25a4de9','a508b813-19c7-eb4e-d6fa-bb61b25a4de9')
                );
...
from bd_user_group bug left join mt_user_group_tenant mugt on bug.user_group_uuid = mugt.user_group_uuid 
    ...
    public function getRoleUserGroup($params = [])
    {
        ...
        $userGroupList = v1_array_sort($userGroupList, 'user_group_name', 'asc', $start, $length);
