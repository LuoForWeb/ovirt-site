...
class PfOpcodePrivate extends OpcodeHandler
{
    ...
    private function initOpcodeDes()
    {
        ...
        $this->opDes = array(
            'PT_LICENSE_OP_QUERY_THUMBPRINT' => 'WEB_PT_LICENSE_OP_QUERY_THUMBPRINT',
            'PT_LICENSE_OP_ADD_LICENSE' => 'WEB_PT_LICENSE_OP_ADD_LICENSE',
            'PT_LICENSE_OP_MODIFY_LICENSE' => 'WEB_PT_LICENSE_OP_MODIFY_LICENSE',
            'PT_LICENSE_OP_DELETE_LICENSE' => 'WEB_PT_LICENSE_OP_DELETE_LICENSE',
            'PT_LICENSE_OP_ADD_VM_LICENSE' => 'WEB_PT_LICENSE_OP_ADD_VM_LICENSE',
            'PT_LICENSE_OP_DEL_VM_LICENSE' => 'WEB_PT_LICENSE_OP_DEL_VM_LICENSE',
            'PT_LICENSE_OP_ADD_AGENT' => 'WEB_PT_LICENSE_OP_ADD_AGENT',
            'PT_LICENSE_OP_MODIFY_AGENT' => 'WEB_PT_LICENSE_OP_MODIFY_AGENT',
            'PT_LICENSE_OP_DEL_AGENT' => 'WEB_PT_LICENSE_OP_DEL_AGENT',
            'PT_LICENSE_OP_ADD_AGENT_LICENSE' => 'WEB_PT_LICENSE_OP_ADD_AGENT_LICENSE',
            'PT_LICENSE_OP_MODIFY_AGENT_LICENSE' => 'WEB_PT_LICENSE_OP_MODIFY_AGENT_LICENSE',
            'PT_LICENSE_OP_DEL_AGENT_LICENSE' => 'WEB_PT_LICENSE_OP_DEL_AGENT_LICENSE',
            'PT_LICENSE_OP_MODIFY_NAS_LICENSE' => 'WEB_PT_LICENSE_OP_MODIFY_NAS_LICENSE',
            'PT_QUERY_AGENT_INFO_OP_QUERY_DIR_LIST' => 'WEB_PT_AGENT_OP_QUERY_DIR_LIST',
            'PT_QUERY_AGENT_INFO_OP_QUERY_RECOVERY_DIR_LIST' => 'WEB_PT_AGENT_OP_QUERY_RECOVERY_DIR_LIST',
            'PT_SYSTEM_BACKGROUND_OP_DO_COMMAND' => 'WEB_PT_SYSTEM_BACKGROUND_OP_DO_COMMAND',
            'PT_SYSTEM_BACKGROUND_OP_DO_COMMAND_WITH_DETAIL' => 'WEB_PT_SYSTEM_BACKGROUND_OP_DO_COMMAND_WITH_DETAIL',
            'PT_LICENSE_OP_MODIFY_HADOOP_CLUSTER_LICENSE' => 'WEB_PT_LICENSE_OP_MODIFY_HADOOP_CLUSTER_LICENSE',
            'PT_LICENSE_OP_QUERY_MACHINE_SN' => 'WEB_PT_LICENSE_OP_QUERY_MACHINE_SN',
        );
    }
}