 ...
 */
class DbJobController extends AuthBase
{
    /**
     * @var \app\v1\db\v0\logic\DbJobController
     */
    private $logic;
    ...
    {
        parent::__construct();
        $this->logic = new \app\v1\db\v0\logic\DbJobController();
    }
    ...
    {
        $this->checkParams('start_backup_job');
        $result = $this->logic()->startBackupJob($this->param);
