...
class DbJobInfo extends AuthBase
{
    ...
    public function getDbJobInfo()
    {
        ...
        $result = $this->logic()->getDbJobInfo($this->param);
     ...
     * @return void
     */
    public function getDbJobObjectInfo()
    {
        $this->checkParams('get_db_job_object_info');
        $result = $this->logic()->getDbJobObjectInfo($this->param['jobs_uuid'], $this->param);
        $this->outputHandle($result);
    }
