...
class VirtualLab extends Base
{
    ...
    public function getVirtualLabList($params = [])
    {
        ...
        //获取数据
        $sql = "select distinct svl.virtual_lab_uuid, svl.hypervisor_type, svl.virtual_lab_name, svl.proxy_name, svl.proxy_ip, svl.proxy_netmask, svl.proxy_gateway, svl.storage_uuid, svl.proxy_network_name, svl.proxy_status, svl.task_progress, unix_timestamp(svl.create_time) create_time, svl.hypervisor_type, svl.network_map, svl.error_code, vh.host_ip, vh.host_name,
