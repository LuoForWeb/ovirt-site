...
return array(
    ...
    'UPDATE_PATCH_DES' => array(
        ...
        ('UI_SETTINGS_PATCH_SPACE_NOT_ENOUGH'),         //"系统空间不足",11
    ),
    ...
    'CDP_TASK_RUNNING_STAGE' => array(
        ...
        22 => ('WEB_VOL_CDP_TASK_BACKUP_WAIT_CONVERT_TO_CDP'),
        40 => ('WEB_PLATFORM_DES_SERVERDATA_CONSIST_CHECK'),
        41 => ('WEB_PLATFORM_DES_STANDBY_CONSIST_CHECK'),
        42 => ('WEB_PLATFORM_DES_SERVERDATA_REALTIME_CONSIST_CHECK'),
    ...
    // 虚拟化子模块类型描述
    'VM_SUBMODULE_TYPE_DES' => [
        ('WEB_PLATFORM_PUBLIC_UNKNOWN'),
        ('UI_PLATFORM_VM_VIRTUAL'),
        ('UI_PLATFORM_PRIVATE_CLOUD'),
        3 => ('UI_PLATFORM_PUBLIC_CLOUD')
    ]
