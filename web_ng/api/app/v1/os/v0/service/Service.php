...
namespace app\v1\os\v0\service;
...
class Service extends Base
{
    ...
    public function opUnifyMsg(string $taskUuid, string $opName, array $msg, $sync = false, $command = false)
    {
        ...
        return $this->mbOSMsg($nodeuuid, $opName, json_encode($msg), $sync, $command);
    }
   ...
   /**
     ...
     * $date 2024/3/29
     */
    public function getOSBackupAgentInfo($nodeuuid,$opName,$msg,$flag = true)
    {
        $mbResult = $this->mbOSMsg($nodeuuid,$opName,$msg,$flag);
        return $mbResult;
    }
