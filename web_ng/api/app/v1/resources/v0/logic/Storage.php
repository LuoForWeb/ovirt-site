...
class Storage extends Base
{
    ...
    public function getStorageDetail(string $storagesuuid)
    {
        ...
        return [
            ...
            'cloud_cache_pages' => intval($storageConfig['cloud_cache_pages']),
    ...
    public function addCloudStorage(&$params = []): array
    {
        ...
        $msg = array(
            ...
            'node_uuid_list' => $params['node_list'],
            'cloud_cache_pages' => $params['cloud_cache_pages'], // 缓存大小
        );
        //添加告警配置
    ...
    public function editStorageInfo($params = [])
    {
        ...
        if ($storagetype == $storageTypeArr['CLOUD']) {
            ...
            // 缓存开关配置 cloud_cache_pages
            $storageConfig['cloud_cache_pages'] = intval($params['cloud_cache_pages']);
        ...
        $descriptionParam = array($usemodeDes, $data[0]['storage_nickname'], $storagename);
        if ($result) {
    ...
    private function getStorageConfig($type, $config, $storageuuid)
    {
        ...
        switch ($type) {
            ...
            case $dbstoragetype['CLOUD']:
                ...
                $details['cloud_cache_pages'] = intval($config['cloud_cache_pages']);
