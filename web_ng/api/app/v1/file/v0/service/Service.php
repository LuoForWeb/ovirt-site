...
namespace app\v1\file\v0\service;
...
class Service extends Base
{
     ...
     * @return void
     */
    public function opUnifyMsg(string $taskUuid, string $opName, array $msg, $sync = false, $command = false, $submodule_type = 0)
    {

        $nodeuuid = (new Node())->getNodeUUIDWithTaskUUID($taskUuid);   //任务UUID对应的存储节点uuid

        return $this->mbFSMsg($nodeuuid, $opName, json_encode($msg), $sync, $command, $submodule_type);
    }
