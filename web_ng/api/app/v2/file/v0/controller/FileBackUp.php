...
// ----------------------------新框架迁移结束--------------------------------------------------
    ...
    //  * @return json
    //  */
    // public function createBackupSearchJob()
    // {
    //     $return = $this->logic()->createBackupSearchJob($this->param);
    //     if ($return['result']) {
    ...
    //  * @return json
    //  */
    // public function stopBackupSearchJob()
    // {
    //     $return = $this->logic()->stopBackupSearchJob($this->param);
    //     if ($return['result']) {
    //         return $this->success();
    //     }
    //     return $this->error($return['msg'], [], $return['code']);
    ...
    //  * @return json
    //  */
    // public function getBackupSearchInfo()
    // {
    //     $return = $this->logic()->getBackupSearchInfo($this->param);
    ...
    //  * @return json
    //  */
    // public function checkOtherPath()
    // {
    //     $return = $this->logic()->checkOtherPath($this->param);
    //     return $this->success('', $return);
    // }
}
