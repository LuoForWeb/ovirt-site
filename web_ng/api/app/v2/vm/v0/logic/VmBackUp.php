...
use app\v2\common\logic\Unification;
...
class VmBackUp extends Backup
{
    ...
    {
        if (v2_license_get_expire_days()['expire_days'] < 0) {
            // 授权无效
        ...
        $transportStrategy = array(
            ...
            'encrypt_flag' => v2_parse_bool_to_flag($params['transport_strategy']['encrypt']), // 加密传输
        ...
        $pfMsg['ignore_resource_limiting_flag'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['ignore_resource_limiting_flag']);
        // 安全策略
        ...
        // 保留快照（公有云使用）
        $pfMsg['keep_snapshot_flag'] = v2_parse_bool_to_flag(false);
        // 快照超时时间（公有云使用）
        $pfMsg['snapshot_timeout'] = intval(3600);
        //CBT模式
        $pfMsg['valid_data_backup'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['cbt_flag']);
        $pfMsg['error_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(false);
        $pfMsg['full_backup_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(false);
        if (xphp_get_config('vm', 'RESET_CBT_LEVEL')['FULL_BACKUP'] == $params['advanced_strategy']['mode']['reset_cbt_level']) {
            $pfMsg['error_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(true);
            $pfMsg['full_backup_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(true);
        ...
        // 高速磁盘CBT
        $pfMsg['highspeed_disk_cbt_flag'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['highspeed_disk_cbt_flag']);
        //V-CBT深度有效数据提取
        $pfMsg['parse_fs_flag'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['parse_fs_flag']);
        //静默快照
        $pfMsg['quiesce_snapshot'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['silent_snapshot_flag']);
        //传输模式
        ...
        //排除交换文件块
        $pfMsg['not_backup_swap_file_flag'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['swap_flag']);
        //排除删除文件块
        $pfMsg['not_backup_deleted_file_flag'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['delete_file_flag']);
        //排除分区间隙
        $pfMsg['not_backup_partition_gap_flag'] = v2_parse_bool_to_flag(
        ...
        $pfMsg['calibreate_strategy_list'] = array(
            "int_create_calibration_algorithm" => v2_parse_bool_to_flag($params['verify_info']['is_check']), //
        ...
        //自动加入备份开关
        $pfMsg['auto_join_flag'] = (string) v2_parse_bool_to_flag($params['src_info']['auto_join_flag']);
        //全局筛选条件
        ...
        //创建存储快照
        $pfMsg['storage_snapshot_enable_flag'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['storage_snapshot_flag']);
        // 传输压缩
        $pfMsg['source_compression'] = $params['transport_strategy']['transfer_compress'];
        // 异步传输
        $pfMsg['async_rw_flag'] = v2_parse_bool_to_flag($params['transport_strategy']['async_transfer']);
        // 重试策略
...
//         }
        ...
        $quiesceSnapshot = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['silent_snapshot_flag']);
        $transportMode = $this->getTransportMode($params['transport_strategy']['mode']);
        //CBT模式
        $cbtMode = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['cbt_flag']);
        //V-CBT
        $parsefsMode = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['parse_fs_flag']);
        //排除交换文件块
        $swapMode = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['swap_flag']);
        //排除删除文件块
        $deletefileMode = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['delete_file_flag']);
        //排除分区间隙
        $gapMode = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['gap_flag']);
        $presnapshot = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['pre_snapshot_flag']);
        //创建存储快照
        $storagesnapshot = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['storage_snapshot_flag']);
        ...
        $detailArr['error_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(false);
        $detailArr['full_backup_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(false);
        if (xphp_get_config('vm', 'RESET_CBT_LEVEL')['FULL_BACKUP'] == $params['advanced_strategy']['mode']['reset_cbt_level']) {
            $detailArr['error_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(true);
            $detailArr['full_backup_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(true);
        } elseif (xphp_get_config('vm', 'RESET_CBT_LEVEL')['ERROR'] == $params['advanced_strategy']['mode']['reset_cbt_level']) {
            $detailArr['error_reset_cbt_flag'] = (string) v2_parse_bool_to_flag(true);
        }
        $detailArr['auto_join_flag'] = (string) v2_parse_bool_to_flag($params['src_info']['auto_join_flag']);
        // 高速磁盘CBT
        $detailArr['highspeed_disk_cbt_flag'] = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['highspeed_disk_cbt_flag']);
        // 传输压缩
        $detailArr['source_compression'] = $params['transport_strategy']['transfer_compress'];
        // 异步传输
        $detailArr['async_rw_flag'] = v2_parse_bool_to_flag($params['transport_strategy']['async_transfer']);
        $result = $result && $this->dbExec(
            $sql,
            array(
                $level,
...
//                }
            ...
            $auto_join_flag = v2_parse_flag_to_bool($detailArr['auto_join_flag']);
            ...
            $info = array(
                ...
                //传输策略
                'bts' => array(
                    'encrypt' => v2_parse_flag_to_bool($data[0]['encrypt_flag']),
                    'compress' => v2_parse_flag_to_bool($data[0]['compress_flag']),
                    ...
                    'async_rw_flag' => v2_parse_flag_to_bool($async_rw_flag),
                ...
                'bss' => array(
                    ...
                    'compress' => v2_parse_flag_to_bool($data[0]['compressed_flag']),
                    'encrypt' => v2_parse_flag_to_bool($data[0]['encrypted_flag']),
                ...
                'mode' => array(
                    ...
                    'keepsnapshot' => v2_parse_flag_to_bool($keep_snapshot_flag),
                    ...
                    'resetcbt' => v2_parse_flag_to_bool($reset_cbt_flag),
                    'fullresetcbt' => v2_parse_flag_to_bool($full_backup_reset_cbt),
                    'snapshotmode' => $data[0]['serial_snapshot_flag'],
                    'parsefsmode' => v2_parse_flag_to_bool($data[0]['parse_fs_flag']),
                    'swapmode' => v2_parse_flag_to_bool($data[0]['not_backup_swap_file_flag']),
                    'deletefilemode' => v2_parse_flag_to_bool($data[0]['not_backup_deleted_file_flag']),
                    'gapmode' => v2_parse_flag_to_bool($data[0]['not_backup_partition_gap_flag']),
                    'threadnum' => intval($data[0]['thread_num']),      //线程数量
                    'presnapshot' => v2_parse_flag_to_bool($data[0]['pre_create_snap_flag']),
                    'storagesnapshot' => v2_parse_flag_to_bool($data[0]['storage_snapshot_enable_flag']),
                    'snapshotdelspeed' => intval($snapshotDelSpeed),
                    'highspeeddiskcbt' => v2_parse_flag_to_bool($highspeed_disk_cbt_flag),
                    'snapshottimeout' => intval($snapshot_timeout),
                    'ignore_resource_limiting_flag' => v2_parse_flag_to_bool($data[0]['ignore_resource_limiting_flag']),
                ),
                //虚拟机信息
                ...
                //安全策略
                'safe_strategy' => [
                    'worm_flag' => v2_parse_flag_to_bool($data[0]['worm_flag']),
                    'worm_protection_time' => $data[0]['worm_protection_time'],
                    'virus_scan_flag' => v2_parse_flag_to_bool($data[0]['virus_scan_flag']),
                    ...
                    'integrity_check_flag' => v2_parse_flag_to_bool($data[0]['integrity_check_flag']),
            ...
            case 'strategy':
                ...
                foreach ($data as $d) {
                    ...
                    $strategyData[] = array(
                        ...
                        'roll_flag' => v2_parse_flag_to_bool($d['roll_flag']),
                        'roll_interval' => v2_sec_to_time($rollInterval),
                        ...
                        'full_backup_compensation_flag' => v2_parse_flag_to_bool($data[0]['full_backup_compensation_flag']),
                    );
                }
    ...
    public function checkTaskLegal($operate, $vmInfo, $taskUuid, $subModuleType)
    {
        ...
        if (
            (xphp_get_config('vm', 'VM_SUB_MODULE')['VM'] == $subModuleType || xphp_get_config('vm', 'VM_SUB_MODULE')['PRIVATE_CLOUD'] == $subModuleType)
    ...
    protected function dbUpdateBdTask(array $nodeInfo, string $taskName, string $taskUuid, array $params, string $cachePath): bool
    {
        ...
        $ignoreResourceLimit = v2_parse_bool_to_flag($params['advanced_strategy']['mode']['ignore_resource_limiting_flag']);
        if ($emptyCachePath) {
            // 存储类型变化则清空缓存路径
            $cachePath = '';
        }
    ...
    protected function dbUpdateBdTransportStrategy(bool $result, string $strategyID, array $transportStrategy): bool
    {
        if (!$result)
            return false;
        $encryptFlag = v2_parse_bool_to_flag($transportStrategy['encrypt']);
    ...
    protected function dbUpdateBdStorageStrategy(bool $result, string $strategyID, array $storageStrategy): bool
    {
        ...
        $passwordAES = v2_pt_pass_encrypt($password);
        if ($oldPass == $password) {
            $passwordAES = $password;
        }
        if ($storageStrategy['auto_create_password_flag']) {
            // 自动生成密码
            $passwordAES = v2_pt_pass_encrypt('/mnt/vm_vinfs');
        }
        if (!$storageStrategy['encrypt_flag']) {
            $passwordAES = '';
        }
        $sqlParams = array(
            v2_parse_bool_to_flag($storageStrategy['deduplication_flag']),
            intval($storageStrategy['block_size']) * 1024,
            v2_parse_bool_to_flag($storageStrategy['compress_flag']),
            v2_parse_bool_to_flag($storageStrategy['encrypt_flag']),
            v2_parse_bool_to_flag($storageStrategy['auto_create_password_flag']),
            $passwordAES,
