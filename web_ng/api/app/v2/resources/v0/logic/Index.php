...
class Index extends Base
{
    ...
    public function pGetUserAllResource($useruuid, $resourceType = '')
    {
        ...
        // }
        return v2_unique_multidim_array($data, 'resource_uuid');
    }
    ...
    public function pGetUserAllResourceSql($useruuid, $resourceType = '', $userType = '', $field = '')
    {
        ...
        if (!empty($field)) {
            $return = " EXISTS (select uuid from ({$return}) v2_auth_all where v2_auth_all.uuid = {$field})";
        }
        return $return;
    }
    ...
    public function pGetTenantAllResource($tenantuuid, $resourceType = '')
    {
        ...
        //获取租户下所有用户
        $tenantHandler = new \app\v2\tenant\v0\logic\Index();
        ...
        return v2_unique_multidim_array($resourceList, 'resource_uuid');
    }
    ...
    private function getResourceFileHost(
        ...
        if ($accurateFlag) {
            ...
            $hostname = v2_escape_wildcard($hostname);
            $ip = $search['agent_ip'];
