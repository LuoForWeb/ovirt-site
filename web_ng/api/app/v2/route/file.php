...
return [
    ...
    'file' => [ // 模块名
        ...
        'FileBackUp' => [ // 类名
            ...
            'file_backup_create_search'  => [
                'post'  =>  'createBackupSearchJob', // 创建搜索消息
            ],
            'file_backup_get_search'  => [
                'post'  =>  'getBackupSearchInfo', // 获取搜索结果
            ],
            'file_backup_stop_search'  => [
                'post'  =>  'stopBackupSearchJob', // 停止搜索
            ],
            'file_backup_check_path'  => [
                'post'  =>  'checkOtherPath', // 文件备份-检测对象上有没有对应的路径（用于应用到其他对象和修改任务）
            ],
        ],
        ### 文件恢复
        'FileRecover' => [
