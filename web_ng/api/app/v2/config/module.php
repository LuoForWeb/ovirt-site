...
return [
    ...
    'MODULE_OPCODE_TYPE' => [
        'UNKNOWN',
        '\app\v2\opcode\PfOpcode', //平台
        '\app\v2\opcode\VmOpcode', //虚拟机
        '\app\v2\opcode\FsOpcode', //文件
        '\app\v2\opcode\DbProtectOpcode', //数据库
        '\app\v2\opcode\OsOpcode', //操作系统
        '\app\v2\opcode\VmOpcode',
        '\app\v2\opcode\VmOpcode',
        '\app\v2\opcode\VmOpcode',
        '\app\v2\opcode\VmOpcode',
        '\app\v2\opcode\VolcdpOpcode', //卷CDP
        11 => '\app\v2\opcode\NasOpcode', //NAS
        12 => '\app\v2\opcode\DbcdpOpcode',  //DBCDP
        14 => '\app\v2\opcode\M365Opcode', //M365
        16 => '\app\v2\opcode\CopyOpcode', //副本
        18 => '\app\v2\opcode\VolcdpOpcode', //容灾主机
        19 => '\app\v2\opcode\OrchestrationOpcode', //策略
        21 => '\app\v2\opcode\ClusterOpcode',  //集群
        22 => '\app\v2\opcode\PfOpcode', //平台
        23 => '\app\v2\opcode\BackupDataOpcode',  //备份数据
        24 => '\app\v2\opcode\ToolOpcode',  //工具
        26 => '\app\v2\opcode\FcOpcode', //文件复制
        28 => '\app\v2\opcode\KubeOpcode',  //Kubernetes
        30 => '\app\v2\opcode\VerifyOpcode', //数据验证
        100 => '\app\v2\opcode\PfOpcodePrivate',//平台私有
        999 => '\app\v2\opcode\FsOpcode', //文件
        1000 => '\app\v2\opcode\NodeOpcode', //节点
