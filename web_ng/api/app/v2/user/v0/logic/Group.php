...
where bu.user_uuid = mur.user_uuid and bu.user_uuid = ? ";
    ...
    public function getUserGroupRole($params = [])
    {
        ...
        $roleList = v2_array_sort($roleList, 'role_name', 'asc', $start, $length);
    ...
    public function initResourcegroup($params = [])
    {
        ...
        $resourceGroupList = v2_array_sort($resourceGroupList, 'resouce_group_name', 'asc', $start, $length);
