...
(
		...
		/*系统信息*/
		'SYSTEM_INFO' => array(
		    'system_name' => 'DatApp backup and recovery system',
		    'company' => 'DatApp Co. Ltd.',
		    'copyright' => 'Copyright',
		    'years' => '2020',
		    'vendor' => 'DatApp',                            //软件内左下角标注
		    ...
		    //授权处使用
		    'company_name' => '深圳市数存科技有限公司',               
		    'company_tel' => '4008-672-818',
		    'company_email' => 'info@datapp.com.cn',
		),
    
        //远程地址
        'REMOTE' => array(
            'website' => "http://www.datapp.com.cn",
...
//             'api_url' => "https://www.vinchin.com:5786/",         //api地址
        ...
        'LISENCE_INFO' => array(
            ...
            //服务授权文件路径
            'serviceFilePath' => "/opt/vinchin/vinsc.service",  //这里取名service,有混淆的意思.
            //服务类型
            'servertype' => array(
                '---',
                '软件标准服务',
