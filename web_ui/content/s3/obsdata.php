...
<div class="backupdata-wrapper">
    <div class="backupdata-wrapper__head">
        ...
        <span class="backupdata-wrapper__head__title"><?php echo $LANG['UI_OBS_BACKUP_DATA'] ?></span>
    </div>
    ...
    <div class="backupdata-wrapper__content row">
        <div class="col-md-4 timepoint-wrapper">
            <div class="timepoint-wrapper__head">
                ...
                <span class="timepoint-wrapper__head__title"><?php echo $LANG['UI_OBS_BACKUP_POINT'] ?></span>
            </div>
                ...
                <div class="timepoint-wrapper__content__tree tree-wrapper">
                    <div class="tree-wrapper__operates">
                        <div class="tree-wrapper__operates__select">
                            <select class="bs-select" data-show-subtext="true" id="storage_select">
                            </select>
                        </div>
        ...
        <div class="col-md-8 tabledata-wrapper">
            <div class="tabledata-wrapper__head">
                ...
                <span
                    class="tabledata-wrapper__head__title"><?php echo $LANG['UI_OBS_POINT'] ?></span>
            ...
            <div class="tabledata-wrapper__content">
                ...
                <div id="filetablediv" class="tabledata-wrapper__content__table display-none">
...
<script type="text/javascript" src="./scripts/s3/obsdata.js"></script>
