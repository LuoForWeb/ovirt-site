    ...
    <div class="col-md-12" style="height:100%;">
        ...
        <div class="portlet box blue-hoki backup-page" id="exchangebackupcontent">
            <div class="portlet-title">
                <div class="caption">
                    <i class="levelchild viconfont vicon-backup c333"></i><?php echo $LANG['UI_MICROSOFT365_CREATE_JOB'] ?>
                </div>
            </div>
...
<!--                                                                        </div>-->
                                                            ...
                                                            <!-- 保留策略 -->
                                                            <div class="form-group reserverDiv">
                                                                <div class="col-md-offset-1 col-md-10 ">
...
<script src="./scripts/exchange/exchange_backup.js" type="text/javascript"></script>
