...
<!-- BEGIN PAGE CONTENT-->
<div class="row job-detail exchange-job-content" id="jobDetail">
                                ...
                                <div class="portlet-body">
                                    <div class="row static-info">
                                        ...
                                        <div class="btn-group  vmStartDiv dropdown-wrapper">
                                                ...
                                                <ul class="dropdown-menu" role="menu" id="exchangeOpList">
                                    ...
                                    <div class="row static-info total-size-div display-none">
                                        <div class="col-md-4 name">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#exchange" data-toggle="tab">
                            <i class="viconfont vicon-zuzhi"></i> <?php echo $LANG['WEB_M365_ORGANIZATION_LIST'] ?>  </a>
                    </li>
                    <li id="historyli">
                        <a href="#exchangeHistory" data-toggle="tab">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="exchange">
                        <div class="table-container">
                            <table class="table table-hover table-borderless" id="exchangetable">
                            </table>
                    ...
                    <div class="tab-pane" id="exchangeHistory">
                        <div class="table-container">
                            <table class="table table-hover table-borderless" id="exchangeHistoryTable">
                            </table>
                        </div>
                    </div>
                </div>
...
<div class="drawer slide" data-placement="right" tabindex="-1" role="dialog" style="width: 600px"
    ...
    <div class="drawer-content drawer-content-scrollable" role="document">
        ...
        <div class="drawer-body config-detail-wrap config-detail-drawer-backup">
            ...
            <div class="config-detail-wrap__group strategy-group transfet-strategy">
                <div class="strategy-group__header">
                ...
                <div class="strategy-group__form">
                    ...
                    <!-- 客户端配置 -->
                    <div class="strategy-group__form__item agent-config-div">
                        <div class="strategy-group__form__item__label col-md-4">
                        <?php echo $LANG['WEB_M365_AGENT_CONFIG'] ?></div>
                        <div id="backup_agent_config" class="strategy-group__form__item__value col-md-8"></div>
                    </div>
                    <!-- 指定客户端 -->
                    <div class="strategy-group__form__item agent-des-div">
                        <div class="strategy-group__form__item__label col-md-4">
                        <?php echo $LANG['WEB_M365_SPECIFY_AGENT'] ?></div>
                        <div id="backup_agent_des" class="strategy-group__form__item__value col-md-8">
                        </div>
                    </div>
                     <!-- 传输网络 -->
...
<script type="text/javascript" src="./scripts/platform/component/job_running_log.js"></script>
 <script type="text/javascript" src="./scripts/exchange/exchange_job_details.js"></script>
