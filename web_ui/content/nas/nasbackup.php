	...
	<div class="col-md-12" style="height: 100%;">
		<div class="portlet box blue-hoki backup-page" id="nasbackupcontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-xinjianbeifen1"></i><?php echo $LANG['UI_NAS_CREATE_BAK_JOB'] ?>
				</div>
			</div>
													...
													<div class="advance-config-wrap">
														<div class="advance-config-wrap__row  row m0">
															<div class="col-md-2 col-sm-2 col-xs-2 nav-tab-radios">
																<ul class="nav nav-tabs tabs-left advance-config-tabs">
															...
															<div class="col-md-10 col-sm-10 col-xs-10 pe-0 advance-config-wrap__row__content">
																<div class="tab-content level1">
																	<!-- 快照 -->
																	<div class="tab-pane active" id="snapshot_handle_pane">
																		<div class = "abnormal-handle-form">
																			<div class="form-group snapshotdiv">
																				...
																				<div class="col-md-6 form-group-content">
																					<input type="checkbox" checked id="silentsnapshotcheck" class="make-switch" data-on-color="primary" data-size="small" data-off-color="info" data-on-text="<?php echo $LANG['UI_PUBLIC_ON'] ?>" data-off-text="<?php echo $LANG['UI_PUBLIC_OFF'] ?>">
...
<script src="./scripts/nas/nasbackup.js" type="text/javascript"></script>