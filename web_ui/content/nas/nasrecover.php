...
<h3 class="breadcrumb">
    ...
    <span class="curent"><?php echo $LANG['UI_NAS_RECOVERY'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="row recover-page">
    <div class="col-md-12" style="height: 100%;">
        <div class="portlet box blue-hoki" id="nasrecovercontent">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <i class="levelchild viconfont vicon-huifu1"></i><?php echo $LANG['UI_NAS_NEW_TASK_RECOVER'] ?>
                </div>
            </div>
                                ...
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="row tab-pane__row">
                                                ...
                                                <div class="src-wrap__content">
                                                    <div class="src-wrap__content__search">
                                                        <select class="bs-select width100p form-control"
                                                            data-show-subtext="true" id="storageSelect">
                                                        </select>
                                                    ...
                                                    <div class="src-wrap__content__itree" style="height: calc(100% - 137px);">
                                                        <div class="alert alert-block alert-info fade in display-hide"
                                                            ...
                                                            <ol class="alert-ol">
                                                                ...
                                                                <li>
                                                                    <a id="tobackup"
                                                                        class="alert-link"><?php echo $LANG['UI_NAS_RECOVER_TO_BACKUP'] ?></a>
                                                                </li>
                                                            </ol>
                                                        </div>
                                                        <div class="nas_tree vcenter-tree">
                                                            <ul id="nas_point_tree"
                                                        ...
                                                        <div class="alert alert-block alert-info fade in display-hide"
                                                            ...
                                                            <button type="button" class="close"
                                                                data-dismiss="alert"></button>
                                                            <h4 class="alert-heading">
                                                                <strong><?php echo $LANG['UI_RECOVERY_FILE_TIPS'] ?></strong>
                                                            </h4>
                                                            <p>
                                        ...
                                        <div class="col-md-8 VMList-div">
                                            <div class="addTitle">
                                                <span><?php echo $LANG['UI_NAS_RECOVERY_SOURCE'] ?></span>
                                            </div>
                                            <div class="addIt-list">
                                                <div class="input-group reco-search-group display-none">
                                                    <input id="reco-search-input" type="text" class="form-control"
                                                ...
                                                <ul id="recoverNasTree" class="ztree"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12 col-steptwo-recover">
                                            ...
                                            <div class="form-group form-select-host">
                                                <label class="control-label col-md-4">
                                                    <span class="required">* </span>
                                                    <span
                                                        class="devicelabel"><?php echo $LANG['UI_NAS_DEVICE_SELECT'] ?></span>
                                                </label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group " id="recoverpath">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select2me" id="pathtype">
                                                        <option value="2">
                                                            <?php echo $LANG['UI_RECOVERY_FILE_DIY_PATH'] ?></option>
                                                        <option value="1">
                                                            <?php echo $LANG['UI_RECOVERY_FILE_OLD_PATH'] ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane" id="tab3">
                                    <div class="row row-stepthree">
                                        <div class="nav-tabs-wrapper col-md-offset-1 col-md-10">
                                            <ul class="nav nav-tabs nas-nav-tabs nav-line-tabs" id="nas_recovery_mode_tabs">
                                                <li class="commonLi active nav-item">
                                                    <a href="#tab_common" class="popovers nav-link" 
                                                ...
                                                <li class="highLi nav-item">
                                                    <a href="#tab_other" class="popovers nav-link" 
                                                        data-container="body" data-trigger="hover" data-placement="top"
                                                        data-toggle="tab">
                                            ...
                                            <div class="tab-content nas-tab-content hover-scroll-y" id="nas_recovery_mode_tab_content">
                                                <div class="tab-pane nas-tab-content__pane active" id="tab_common">
                                                ...
                                                <div class="tab-pane nas-tab-content__pane" id="tab_transfer">
                                                    <div class="panel-body">
                                                        <div class="tabbable-custom pdlr15 col-md-10">
                                                            ...
                                                            <!-- 传输代理 -->
                                                            <div
                                                                class="form-group transfer-agency-form-group display-hide">
                                                                <label
                                                                ...
                                                                <div class="col-md-4 form-group-content">
                                                                    <input type="checkbox" id="appliance_agency_flag"
                                                            ...
                                                            <div class="form-group display-hide applianceselectdiv">
                                                                <label
                                                                    class="control-label col-md-3 applianceselectlabel form-group-label"><?php echo $LANG['UI_APPLIANCE_SELECT'] ?></label>
                                                            ...
                                                            <!-- 传输加密 -->
                                                            <div
                                                                class="form-group encrypt-transfer-form-group display-hide">
                                                                <label
                                                                    class="control-label col-md-3 form-group-label"><?php echo $LANG['UI_BACKUP_ENCRYPTION_TRANSFER'] ?></label>
                                                                <div class="col-md-4 form-group-content">
                                                                    <input type="checkbox" id="transport_encrypt_flag"
                                                                        data-size="small" class="make-switch"
                                                                        data-on-color="primary" data-off-color="info"
                                                                        data-on-text="<?php echo $LANG['UI_PUBLIC_ON'] ?>"
                                                                        data-off-text="<?php echo $LANG['UI_PUBLIC_OFF'] ?>">
                                                                    <a class="popovers ml15" data-container="body"
                                                                        ...
                                                                        data-content="<?php echo $LANG['UI_BACKUP_FILE_NETWORK_ENCRIPT_TRANSFER'] ?>">
                                                                        <i class="viconfont vicon-tishi"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <!-- 传输加密算法 -->
                                                            <div
                                                                class="form-group encrypt-transfer-method-form-group display-none">
                                                                <label
                                                            ...
                                                            if ($authfun['multithread']) {
                                                                echo '
												                	<div class="form-group">
                                                                        <label
                                                                            class="control-label col-md-3 threadnumlabel">' . $LANG['UI_BACKUP_THREAD_NUM'] . '
                                                                        </label>
                                                                        <div class="col-md-3">
                                                                        ...
                                                                        <div class="col-md-2 mt5">
                                                                            <a class="popovers"
                                                                                ...
                                                                                data-content="' . $LANG['UI_BACKUP_FILE_THREADBUM_TIPS'] . '"
                                                                                data-original-title=""
                                                                                title="">
                                                                                <i
                                                ...
                                                <!-- 高级配置 -->
                                                <div class="tab-pane nas-tab-content__pane" id="tab_other">
                                                        ...
                                                        <div class="advance-config-wrap__row  row m0">
                                                            ...
                                                            <div class="col-md-10 col-sm-10 col-xs-10 pe-0 advance-config-wrap__row__content">
                                                                <div class="tab-content level1">
                                                                    <!-- 异常处理 -->
                                                                    <div class="tab-pane active" id="tab_except_handle_conf">
                                                                        <div class = "abnormal-handle-form">
                                                                            <!-- 文件 & NAS & Hadoop 跳过目录树恢复 -->
                                                                            <div
                                                                                class="form-group advanced-config-file-form-group file-skip-dir-tree-div">
                                                                                <label
                                                                                    class="control-label col-md-4 file-skip-dir-tree-label form-group-label"><?php echo $LANG['UI_RECOVERY_FILE_SKIP_DIR_TREE_RECOVERY'] ?></label>
                                                                                <div class="col-md-3 form-group-content">
                                                                                    <input type="checkbox" id="file_skip_dir_tree_flag"
                                                                            ...
                                                                            <div class="form-group advanced-config-obs-form-group">
                                                                                ...
                                                                                <div class="col-md-3 form-group-content">
                                                                                    <input type="checkbox" id="obs_skip_dir_tree_flag"
                                                                                        class="make-switch" data-on-color="primary"
                                                                                        data-size="small" data-off-color="info"
                                                                                        data-on-text="<?php echo $LANG['UI_PUBLIC_ON'] ?>"
                                                                                        data-off-text="<?php echo $LANG['UI_PUBLIC_OFF'] ?>">
                                                                            ...
                                                                            <div class="form-group advanced-config-file-form-group">
                                                                                <label
                                                                                    class="control-label col-md-4 file-same-name-label form-group-label"><?php echo $LANG['UI_RECOVERY_FILE_PROCESS_SAME_FILE'] ?></label>
                                                                                <div class="col-md-3 form-group-content">
                                                                            ...
                                                                            <div class="form-group advanced-config-file-form-group clear-shortcut-div">
                                                                                <label
                                                                                    class="control-label col-md-4 clear-shortcut-label form-group-label"><?php echo $LANG['UI_RECOVERY_FILE_INVALID_SHORTCUT_CLEAN'] ?></label>
                                                                                <div class="col-md-3 form-group-content">
                                                                                    ...
                                                                                    <a class="popovers ml15" data-container="body"
                                                                                        data-trigger="hover" data-html="true"
                                                                                        data-placement="right"
                                                                                        data-content="<?php echo $LANG['UI_NAS_SHOTCUT_TIPS'] ?>">
                                                                                        <i class="viconfont vicon-tishi"></i>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="tab-pane" id="tab_permission_conf">
                                                                        <div class = "abnormal-handle-form">
                                                                            ...
                                                                            <div
                                                                                class="form-group advanced-config-file-form-group file-permission-div">
                                                                                <label
                                                                                    class="control-label col-md-4 file-permission-recovery-label form-group-label"><?php echo $LANG['UI_FILE_RECOVERY_PERMISSION'] ?></label>
                                                                                <div class="col-md-3 form-group-content">
                                                                                    <input type="checkbox"
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="tab-pane__body">
                                        <div class="tab-pane__body__form">
                                            ...
                                            <div class="form-group mb0 mt10">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <!--             									<i class="fa fa-warning tooltips" data-original-title="请输入任务名"></i> -->
                                            ...
                                            <div class="form-group mb0 mt10">
                                                <label
                                                    class="control-label col-md-3"><?php echo $LANG['UI_RECOVERY_FILE_RC_LIST'] ?>:</label>
                                                <div class="col-md-9">
...
<script src="./scripts/nas/nasrecover.js" type="text/javascript"></script>