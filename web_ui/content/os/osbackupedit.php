	...
	<div class="col-md-12" style="height:100%;">
		...
		<div class="portlet box blue-hoki backup-page" id="osbackupcontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-xinjianbeifen1"></i> <?php echo $LANG['WEB_OS_EDIT_HOST_BACKUP_TASK'] ?>
				</div>
			</div>
									...
									<div class="row tab-pane__row">
										...
										<div class="col-md-8 VMList-div">
											...
											<div class="addIt-list">
												<ul class="feeds addVMList" id="addOSList"></ul>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="tabbable-custom col-md-offset-1 col-md-10">
											<ul class="nav nav-tabs">
												<li class="commonLi active">
													<a href="#tab_common" class="popovers" data-content="<?php echo $LANG['UI_BACKUP_COMMON_STRATEGY_DES'] ?>" data-container="body" data-trigger="hover" data-placement="top" data-toggle="tab">
														<i class="viconfont vicon-celve1"></i> <?php echo $LANG['UI_BACKUP_COMMON_STRATEGY'] ?> </a>
												</li>
												<li class="" style="display: block;">
													<a href="#tab_transfer" class="popovers" data-content="<?php echo $LANG['UI_BACKUP_TRANSPORT_TIPS'] ?>" data-container="body" data-trigger="hover" data-placement="top" data-toggle="tab">
														<i class="viconfont vicon-a-chuanshu"></i> <?php echo $LANG['UI_BACKUP_TRANSFER_STRATEGY'] ?> </a>
												</li>
												<li class="highLi">
													<a href="#tab_other" class="popovers" data-content="<?php echo $LANG['UI_BACKUP_HIGH_CONFIG_DES'] ?>" data-container="body" data-trigger="hover" data-placement="top" data-toggle="tab">
														...
														<div class="tabbable-custom col-md-10">
															...
															<div class="form-group">
																...
																<div class="col-md-4 form-group-content">
																	<input type="checkbox" id="transport_encrypt_flag" checked data-size="small" class="make-switch" data-on-color="primary" data-off-color="info" data-on-text="<?php echo $LANG['UI_PUBLIC_ON'] ?>" data-off-text="<?php echo $LANG['UI_PUBLIC_OFF'] ?>">
...
<script src="./scripts/os/osbackupedit.js" type="text/javascript"></script>