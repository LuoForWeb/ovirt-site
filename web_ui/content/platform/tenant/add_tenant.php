...
<h3 class="page-title settings-title">
	<a style="color: #20c99a;" class="ajaxify" name="tenant_manager" href="./content/platform/tenant/tenant_manager.php">
		<i class="levelchild viconfont vicon-tenant" ></i>
...
<div class="row">
	...
	<div class="portlet-title">
		<div class="caption">
			<i class="viconfont vicon-ge_add_task"></i><?php echo $LANG['UI_TENANT_ADD']?>
		</div>
	</div>
        	...
        	<div class="form-group" >
    			...
    			* </span>
    			...
    			<div class="col-md-4">
    				<div class="input-icon right">
    					<i class="fa"></i>
    					<input type="text" maxlength="128" class="form-control" name="username" id="adminname"/>
    					<div><span class="help-block ">
...
<script type="text/javascript" src="./scripts/platform/tenant/add_tenant.js"></script>
