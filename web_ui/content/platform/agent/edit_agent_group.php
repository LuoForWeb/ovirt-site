...
<div class="row">
	<div class="col-md-12">
	<input id="groupuuid" value="<?php  echo $_GET['groupuuid'];?>" class="display-none"></input>
	<!-- BEGIN VALIDATION STATES-->
	<div class="portlet box blue-hoki" id="editAgentGroup">
	<div class="portlet-title">
		<div class="caption">
			<i class="viconfont vicon-ge_modify"></i><?php echo $LANG['UI_AGENT_GROUP_EDIT']?>
		</div>
	</div>
	<div class="portlet-body form">
	<!-- BEGIN FORM-->
	<form action="#" id="form_editAgentGroup" class="form-horizontal">
		<div class="form-body">
...
<script type="text/javascript" src="./scripts/platform/agent/edit_agent_group.js"></script>
