...
<h3 class="breadcrumb">
    ...
    <span class="curent"><?php echo $LANG['UI_REPORT_NAS_REPORT'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="report-detail">
    <div class="report-detail__header">
        <span class="report-detail__header__title">
            ...
            <span class="report-detail__header__title__text"><?php echo $LANG['UI_REPORT_NAS_REPORT'] ?></span>
        </span>
        <button type="button" id="nas_export" class="btn green-haze <?php if (!in_array('p_vm_report_export', $_SESSION['permissionArr'])) {
            echo 'display-none';
        } ?>">
    ...
    <div class="report-detail__content hover-scroll-y">
        ...
        <div class="report-detail-boxes client-detail-boxes display-none">
            <div class="report-detail-boxes__item box-wrapper nas-total-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="nas_total"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_DEVICE_ALL'] ?></span>
                </div>
                <div class="box-wrapper__right nas-total-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper nas-online-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="nas_online"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_DEVICE_ONLINE'] ?></span>
                </div>
                <div class="box-wrapper__right nas-online-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper nas-offline-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="nas_offline"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_DEVICE_OFFLINE'] ?></span>
                </div>
                <div class="box-wrapper__right nas-offline-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper nas-protected-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="nas_protected"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_DEVICE_PROTECT'] ?></span>
                </div>
                <div class="box-wrapper__right nas-protected-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper nas-unprotected-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="nas_unprotected"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_DEVICE_UNPROTECT'] ?></span>
                </div>
                <div class="box-wrapper__right nas-unprotected-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper nas-backup-data-box display-none">
                <div class="box-wrapper__left">
                    <span class="nums-wrapper">
                        <span class="box-wrapper__left__nums" id="nas_backup_data"></span>
                        <span class="box-wrapper__left__unit" id="nas_backup_data_unit"></span>
                    </span>
        ...
        <div class="charts-wrapper echart-wrapper display-none">
            ...
            <div class="tab-content">
                <div class="tab-content__echart" id="nas_task_running_chart"></div>
        ...
        <div class="data-detail-wrapper">
            <div class="data-detail-wrapper__toolbar toolbar-wrap">
                <div class="obs-manager-toolbar">
                    <div class="tool-left">
                        <div class="tool-left-item">
                            <div class="search input-group">
                                <input id="search" class="currentSearch customSearch"
                                    ...
                                    placeholder="<?php echo $LANG['UI_RESOURCE_GROUP_ALLOCATION_APPLIANCE_SEARCH'] ?>">
                        ...
                        <div class="tool-left-item">
                            <div id="nas_report_filter_wrapper" class="position-relative"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="data-detail-wrapper__content">
                <table id="nas_report_table"></table>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="./scripts/platform/reports/nasDetail.js"></script>
