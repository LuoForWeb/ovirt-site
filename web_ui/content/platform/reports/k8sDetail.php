...
<h3 class="breadcrumb">
    ...
    <span class="curent"><?php echo $LANG['UI_KUBERNETES_REPORT'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="report-detail">
    <div class="report-detail__header">
        <span class="report-detail__header__title">
            <i class="viconfont vicon-k8s me-4"></i>
            <span class="report-detail__header__title__text"><?php echo $LANG['UI_KUBERNETES_REPORT'] ?></span>
        </span>
        <button type="button" id="k8s_export" class="btn green-haze <?php if (!in_array('p_vm_report_export', $_SESSION['permissionArr'])) {
            echo 'display-none';
        } ?>">
    ...
    <div class="report-detail__content hover-scroll-y">
        ...
        <div class="report-detail-boxes display-none">
            <div class="report-detail-boxes__item box-wrapper k8s-total-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="k8s_total"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['WEB_PLATFORM_DES_CLUSTER'] ?></span>
                </div>
                <div class="box-wrapper__right obs-total-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper k8s-online-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="k8s_online"></span>
            ...
            <div class="report-detail-boxes__item box-wrapper k8s-offline-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="k8s_offline"></span>
            ...
            <div class="report-detail-boxes__item box-wrapper k8s-protected-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="k8s_protected"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_HOMEPAGE_PROTECTED'] ?></span>
                </div>
                <div class="box-wrapper__right hadoop-protected-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper backup-data-box display-none">
                <div class="box-wrapper__left">
                    <span class="nums-wrapper">
                        <span class="box-wrapper__left__nums" id="backup_data_num"></span>
                        <span class="box-wrapper__left__unit" id="backup_data_unit"></span>
                    </span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_PLATFORM_VOL_CDP_BACKUPSET'] ?></span>
                </div>
        ...
        <div class="charts-wrapper echart-wrapper display-none">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="all_tab">
                    <div class="tab-content__echart" id="k8s_report_all_chart"></div>
                ...
                <div class="tab-pane fade" id="success_tab">
                    <div class="tab-content__echart" id="k8s_report_success_chart"></div>
                        <div class="tab-content__nodata display-none">
                            <div class="tab-content__nodata__img">
                                <img src="./img/platform/report/nodata.svg" alt="">
                            </div>
                ...
                <div class="tab-pane fade" id="failed_tab">
                    <div class="tab-content__echart" id="k8s_report_failed_chart"></div>
                        <div class="tab-content__nodata display-none">
                            <div class="tab-content__nodata__img">
                                <img src="./img/platform/report/nodata.svg" alt="">
                            </div>
        ...
        <div class="data-detail-wrapper">
            <div class="data-detail-wrapper__toolbar toolbar-wrap">
                <div class="obs-manager-toolbar">
                    <div class="tool-left">
                        ...
                        <div class="tool-left-item me-10">
                            <div id="k8s_report_filter_wrapper" class="position-relative"></div>
                        </div>
                        <div class="tool-left-item">
                            <div id="k8s_report_daterangepicker_wrapper" class="position-relative"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="data-detail-wrapper__content">
                <table id="k8s_report_table"></table>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="./scripts/platform/reports/k8sDetail.js"></script>
