...
<h3 class="breadcrumb">
    ...
    <span class="curent"><?php echo $LANG['UI_REPORT_PRIVATE_REPORT'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="report-detail">
    <div class="report-detail__header">
        <span class="report-detail__header__title">
            ...
            <span class="report-detail__header__title__text"><?php echo $LANG['UI_REPORT_PRIVATE_REPORT'] ?></span>
        </span>
        <button type="button" id="private_cloud_export" class="btn green-haze <?php if (!in_array('p_vm_report_export', $_SESSION['permissionArr'])) {
            echo 'display-none';
        } ?>">
    ...
    <div class="report-detail__content hover-scroll-y">
        ...
        <div class="report-detail-boxes display-none">
            ...
            <div class="report-detail-boxes__item box-wrapper vm-platform-box display-none">
                <div class="box-wrapper__left">
                    ...
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_PLATFORM_VM_PRIVATE_CLOUD_PLATFORM'] ?></span>
                </div>
        ...
        <div class="charts-wrapper echart-wrapper display-none">
            ...
            <div class="tab-content">
                <div class="tab-content__echart" id="private_cloud_task_running_chart"></div>
        ...
        <div class="data-detail-wrapper">
            <div class="data-detail-wrapper__toolbar toolbar-wrap">
                <div class="obs-manager-toolbar">
                    <div class="tool-left">
                        ...
                        <div class="tool-left-item">
                            <div id="private_report_filter_wrapper" class="position-relative"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="data-detail-wrapper__content">
                <table id="private_cloud_report_table"></table>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="./scripts/platform/reports/privateDetail.js"></script>
