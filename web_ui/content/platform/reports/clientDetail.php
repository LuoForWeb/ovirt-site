...
<h3 class="breadcrumb">
    ...
    <span class="curent"><?php echo $LANG['UI_JOB_CLIENT_REPORT'] ?></span>
</h3>
<!-- END PAGE HEADER-->
...
<div class="report-detail">
    <div class="report-detail__header">
        <span class="report-detail__header__title">
            ...
            <span class="report-detail__header__title__text"><?php echo $LANG['UI_JOB_CLIENT_REPORT'] ?></span>
        </span>
        <button type="button" id="client_export" class="btn green-haze <?php if (!in_array('p_vm_report_export', $_SESSION['permissionArr'])) {
            echo 'display-none';
        } ?>">
    ...
    <div class="report-detail__content hover-scroll-y">
        ...
        <div class="report-detail-boxes client-detail-boxes display-none">
            <div class="report-detail-boxes__item box-wrapper client-total-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="client_total"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_REPORT_AGENT_ALL'] ?></span>
                </div>
                <div class="box-wrapper__right client-total-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper client-online-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="client_online"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['WEB_AGENT_STATUS_ONLINE'] ?></span>
                </div>
                <div class="box-wrapper__right client-online-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper client-offline-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="client_offline"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['WEB_AGENT_STATUS_OFFLINE'] ?></span>
                </div>
                <div class="box-wrapper__right client-offline-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper client-protected-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="client_protected"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_PROTECTED_CLIENT'] ?></span>
                </div>
                <div class="box-wrapper__right client-protected-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper client-unprotected-box display-none">
                <div class="box-wrapper__left">
                    <span class="box-wrapper__left__nums" id="client_unprotected"></span>
                    <span class="box-wrapper__left__des"><?php echo $LANG['UI_VM_REPORT_NOIN_BACKUP'] ?></span>
                </div>
                <div class="box-wrapper__right client-unprotected-svg"></div>
            </div>
            <div class="report-detail-boxes__item box-wrapper client-backup-data-box display-none">
                <div class="box-wrapper__left">
                    <span class="nums-wrapper">
                        <span class="box-wrapper__left__nums" id="client_backup_data"></span>
                        <span class="box-wrapper__left__unit" id="client_backup_data_unit"></span>
                    </span>
        ...
        <div class="charts-wrapper echart-wrapper display-none">
            ...
            <div class="tab-content">
                <div class="tab-content__echart" id="client_task_running_chart"></div>
            ...
            <div class="data-detail-wrapper__toolbar toolbar-wrap">
                <div class="obs-manager-toolbar">
                    <div class="tool-left">
                        <div class="tool-left-item me-10">
                            <div class="search input-group">
                                <input id="search" class="currentSearch customSearch"
                                    ...
                                    placeholder="<?php echo $LANG['UI_SEARCH_HOST_NAME'] ?>">
                        ...
                        <div class="tool-left-item me-10">
                            <div id="client_report_filter_wrapper" class="position-relative"></div>
                        </div>
                        <div class="tool-left-item">
                            <div id="client_report_daterangepicker_wrapper" class="position-relative"></div>
                        </div>
                    </div>
                </div>
                <div class="vin_toolbar mb-0" id="vin_current_toolbar">
                    <div class="vin_btnToolbar"></div>
                </div>
            </div>
            <div class="data-detail-wrapper__content">
                <table id="client_report_table"></table>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="./scripts/platform/reports/clientDetail.js"></script>
