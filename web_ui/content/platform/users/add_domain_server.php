...
<h3 class="breadcrumb">
    ...
    <li>
        <a class="ajaxify" name="safety" href="./content/platform/users/domain_server.php">
            <span><?php echo $LANG['UI_PLATFORM_SAFETY_DOMAIN'] ?></span>
        </a>
    </li>
    <span>></span>
    <span class="curent"><?php echo $LANG['UI_DOMAIN_SERVER_ADD'] ?></span>
</h3>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="row">
	...
	<div class="portlet box blue-hoki" id="adddomainContent">
		<div class="portlet-title">
			<div class="caption" style="color: #575962;">
				<i class="viconfont vicon-ge_add_task"></i><?php echo $LANG['UI_DOMAIN_SERVER_MANAGE']?>
			</div>
		</div>
	<div class="portlet-body form">
	<!-- BEGIN FORM-->
	<form action="#" id="form_addDomainServer" class="form-horizontal">
	<div class="form-body">
    	...
    	<div class="form-group">
			<label class="control-label col-md-3"><?php echo $LANG['UI_DOMAIN_SERVER_DOMAIN']?><span class="required">
			* </span>
			</label>
			<div class="col-md-4">
				<div class="input-icon right">
...
<script src="./scripts/platform/users/add_domain_server.js" type="text/javascript"></script>