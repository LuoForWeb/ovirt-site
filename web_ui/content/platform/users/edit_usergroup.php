...
<h3 class="breadcrumb">
	...
	<span>></span>
	<span class="curent"><?php echo $LANG['UI_USER_GROUP_MODIFY'] ?></span>
</h3>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="row">
	...
	<!-- BEGIN VALIDATION STATES-->
		<div class="portlet box blue-hoki" id="addcontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="viconfont vicon-ge_modify"></i><?php echo $LANG['UI_USER_GROUP_MODIFY'] ?>
				</div>
			</div>
			<div class="portlet-body form">
				...
				<form action="#" id="form_addUserGroup" class="form-horizontal">
					<div class="form-body">
						<div class="form-group pt70" id="vmtypediv">
							<label class="control-label col-md-3"><?php echo $LANG['UI_PLATFORM_SAFETY_USER_GROUP'] ?><span class="required">
							* </span>
							</label>
							<div class="col-md-4">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" maxlength="128" class="form-control" name="userGroupName" id="userGroupName"/>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<div class="input-icon right">
									<i class="fa"></i>
									<textarea class="form-control" id="userGroupDescription" style="margin: 0px 904.828px 0px 0px; maxlength="128"; height: 150px;"></textarea>
									<div><span class="help-block ">
...
<script src="./scripts/platform/users/edit_usergroup.js" type="text/javascript"></script>