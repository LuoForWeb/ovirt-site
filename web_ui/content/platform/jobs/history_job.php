...
<!-- BEGIN VIEW DRAWER -->
<div class="drawer slide" data-placement="right" tabindex="-1" role="dialog" aria-labelledby="drawer-1-title"
    id="view_log_drawer" style="width: 1000px;">
        ...
        <div class="drawer-body history-running-logs-drawer-body" id="history_logs_drawer_body">
            <div class="logs-container" id="logs_container">
                ...
                <div style="width:100%;height: calc(100% - 40px);overflow-y: scroll;">
                    <div class="show_log-component" id="show_log_component">
