...
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet-body" id="current_fs_job">
				<!-- search -->
				<div class="table-toolbar-wrapper">
					...
					<div class="table-toolbar-wrapper__right">
							...
							<input type="search" maxlength="128" class="fsjob_search table-group-action-input form-control input-inline input" placeholder="<?php echo $LANG['UI_JOB_SEARCH_JOB_NAME'] ?>" aria-controls="example">
							<input id="fsjob_searchbtn" type="button" class="btn btn-search" value="<?php echo $LANG['UI_PUBLIC_SEARCH'] ?>">
							<button type="button" id="fsjob_searchAll" class="btn green-haze">
				...
				<div class="row">
					<div class="col-md-12">
						<div id="fs_searchDiv" class="searchDiv display-none"><?php echo $LANG['UI_PUBLIC_SEARCH_CONDITION'] ?> <span class="searchContent"></span><span class="clearSearch"><?php echo $LANG['UI_SEARCH_CLEAR'] ?></span> </div>
					</div>
				</div>
				<div class="table-container">
					<table class="table table-striped table-hover" id="fsJobTable">
					<thead>
		...
		<!-- BEGIN MODAL -->
		<div id="fsJobModal" class="modal xmodal fade form-horizontal high-search" tabindex="-1" data-backdrop="static">
				...
				<div class="portlet-body">
					...
					<div class="list-option" >
						<div class="row">
							...
							<div class="col-md-5 daterangepickerdiv">
								<input type="text" id="daterangepickerCurrentFsJob" class="form-control" autocomplete="off">
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<input style="width:322px; height:34px;" id="fs_taskName" type="text" maxlength="64" class="table-group-action-input form-control input-inline input input-sm" aria-controls="example">
							</div>
						</div>
					</div>
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="fs_tasktype">
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="fs_node" >
								</select>
							</div>
						</div>
					</div>
					...
					<div class="list-option">
						<div class="row">
							...
							<div class="col-md-5">
								<select class="form-control select2me" id="fs_status">
									<option value="0"><?php echo $LANG['UI_PUBLIC_ALL'] ?></option>
			...
			<div class="modal-footer">
				...
				<button type="button"class="btn btn-primary" id="fs_serach_submit"><?php echo $LANG['UI_PUBLIC_YES'] ?></button>
			</div>
		</div>	
		<!-- END MODAL -->
...
<script type="text/javascript" src="./scripts/platform/jobs/job_tab/current_fs_job.js"></script>
