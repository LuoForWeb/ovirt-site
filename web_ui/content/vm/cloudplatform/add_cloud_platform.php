...
<h3 class="breadcrumb">
	...
	<span>></span>
	<span class="curent"><?php echo $LANG['UI_CLOUD_PLATFORM_ADD_VC'] ?></span>
</h3>
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12 col-manager">
		...
		<div class="portlet box blue-hoki" id="addcontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="viconfont vicon-ge_modify"></i><?php echo $LANG['UI_CLOUD_PLATFORM_ADD_VC'] ?>
				</div>
			</div>
			<div class="portlet-body form">
				...
				<form action="#" id="form_sample_2" class="form-horizontal">
					<div class="form-body">
						<div class="alert alert-info display-none" id="agentdownload">
							<p id="agentdownloadtips"></p>
						</div>
						<div class="form-group" id="vmtypediv">
							...
							<a href="javascript:;" id="agentInit" class="display-none" style="position:relative;top:8px;"><?php echo $LANG['UI_CLOUD_PLATFORM_DOWNLOAD_AGENT'] ?></a>
						</div>
						...
						<div class="form-group display-none" id="awsDiv">
							<label class="control-label col-md-4">
								<span class="required">* </span>
						...
						<div class="form-group <?php echo 'public' == $_GET['cloudType'] ? 'display-none' : '' ?>" id="ipDiv">
							...
							<div class="col-md-4">
								<div class="col-md-3" id="httpTypeDiv" style="padding: 0 !important;">
									<select class="form-control " id="httpType">
										<option value="http://">http://</option>
										<option value="https://">https://</option>
									</select>
								</div>
								<div class="col-md-9" id="ipaddrDiv" style="padding: 0 !important;">
									<input type="text" maxlength="128" class="form-control" name="ipaddr" placeholder="192.168.1.110" />
								</div>
								<div class="col-md-12" style="padding: 0 !important;"><span class="help-block iptips"><?php echo $LANG['UI_CLOUD_PLATFORM_ADD_VC_IP_OR_NAME_TIPS'] ?></span>
						...
						<div class="form-group <?php echo 'public' == $_GET['cloudType'] ? 'display-none' : '' ?>" id="highConfigDiv">
							<label class="control-label col-md-4 form-group-label"><?php echo $LANG['UI_CLIENT_HIGH_CONFIG'] ?></label>
									...
									<div id="highInfo" class="panel-collapse">
										<div class="panel-body">
											<div class="col-md-12">
												...
												<div class="form-group openstackDiv" id="domainDiv">
													...
													<div class="col-md-8">
														<div class="input-icon right">
															<i class="fa"></i>
															<input style="display:none"><!-- for disable autocomplete on chrome -->
															<input type="text" maxlength="128" class="form-control" id="domain" value="Default" />
														</div>
													</div>
												</div>
											</div>
						...
						<div class="form-group applianceDiv applianceSwitchDiv display-none">
						...
						<div class="form-group username-div">
							...
							<div class="col-md-4">
								<div class="input-icon right">
									<i class="fa"></i>
									<input style="display:none"><!-- for disable autocomplete on chrome -->
									<input type="text" maxlength="128" class="form-control" name="username" placeholder="" />
							...
							<!-- 华为云ak/sk获取提示 -->
							<div class="col-md-1 display-none pt-8" id="huaweiCloudAkTips">
								<a class="ml15 popovers" data-container="body" data-trigger="hover" data-html="true"
								   data-placement="right"
								   data-content="<?php echo $LANG['UI_CLOUD_PLATFORM_HUAWEICLOUD_AK_TIPS'] ?>">
									<i class="viconfont vicon-tishi"></i>
								</a>
							</div>
						</div>
						<div class="form-group password-div">
							...
							<div class="col-md-4">
								<div class="input-icon right">
									<i class="fa"></i>
									<input style="display:none"><!-- for disable autocomplete on chrome -->
									<input type="password" autocomplete="off" maxlength="128" class="form-control" name="password" placeholder="" oninput="value=value.replace(/[\u4E00-\u9FA5]|[\uFE30-\uFFA0]|\s+/g,'')" />
									<div><span class="help-block ">
                        ...
                        <div class="form-group zstackRoleDiv display-none">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2me" id="zstackRole">
                                    <option value=""> -- </option>
                                </select>
                                <div><span class="help-block "><?php echo $LANG['UI_CLOUD_PLATFORM_USER_ROLE_TIPS'] ?></span></div>
                            </div>
                            <a href="javascript:;" id="getZstackRole" style="position:relative;top:8px;text-decoration: none">
                                <i class="viconfont vicon-ge_refresh"></i>
                                <?php echo $LANG['UI_PUBLIC_TOOLS_RELOAD'] ?>
                            </a>
                        </div>

						<div class="form-group rname-div">
							<label class="control-label col-md-4">
								<span class="required">* </span>
		...
		<!-- BEGIN SEARCH MODAL -->
		<div id="agentModal" class="modal xmodal fade form-horizontal " tabindex="-1" data-focus-on="input:first" data-backdrop="static">
			<div class="modal-header ">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
				<h4 class="modal-title"><i class="viconfont vicon-ge_download"></i> <?php echo $LANG['UI_CLOUD_PLATFORM_DOWNLOAD_AGENT'] ?>
				</h4>
			</div>
				...
				<div class="portlet-body">
					<div class="list-option">
						<div class="row">
							<!-- 厂商 -->
							<div>
								<label class="control-label col-md-2"> <?php echo $LANG['UI_LOGIN_AGENT_VENDOR'] ?>：
								</label>
								<div class="col-md-8 form-group">
									<span id="agentVendor" class="form-control" style="height: auto !important;"></span>
								</div>
							</div>
							<div style="clear: both"></div>
							<!-- 版本 -->
							<div>
								<label class="control-label col-md-2 versionDiv"><?php echo $LANG['UI_LOGIN_AGENT_VERSION'] ?> ：
								</label>
								<div class="col-md-8 versionDiv form-group">
									<select id="vmAgent" class="form-control select2me">
									</select>
								</div>
							</div>
						</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="downloadAgent"><?php echo $LANG['UI_NODE_DOWNLOAD'] ?></button>
			</div>
		</div>
		<!-- END SEARCH MODAL -->
	</div>
...
<script src="./scripts/vm/cloudplatform/add_cloud_platform.js" type="text/javascript"></script>