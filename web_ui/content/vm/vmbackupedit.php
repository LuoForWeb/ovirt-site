    ...
    <div class="col-md-12" style="height:100%;">
        ...
        <div class="portlet box blue-hoki backup-page" id="vmbackupcontent">
            <div class="portlet-title">
                <div class="caption caption-vm" style="display: none">
                    <i class="icon-action-redo"></i> <?php echo $LANG['UI_BACKUP_EDIT_VM_BACKUP_JOB'] ?>
                </div>
                <div class="caption caption-prcloud" style="display: none">
                    <i class="icon-action-redo"></i> <?php echo $LANG['UI_BACKUP_EDIT_PRIVATE_CLOUD_BACKUP_JOB'] ?>
                </div>
            </div>
                                        ...
                                        <div class="row tab-pane__row">
                                                ...
                                                <div class="form-group src-wrap">
                                                    ...
                                                    <div class="src-wrap__content">
                                                        <div class="src-wrap__content__search">
                                                            ...
                                                            <select class="bs-select width100p" data-show-subtext="true" id="vmshowtype" style="display: none">
                                                                <option data-icon="hostcluster icon-default"
                                                                        value="1"><?php echo $LANG['UI_VCENTER_SHOW_HOST_CLUSTER'] ?></option>
                                                                <option data-icon="vmtmp icon-default"
                                                                        value="2"><?php echo $LANG['UI_VCENTER_SHOW_VM_TEMPLATE'] ?></option>
                                                                <option data-icon="hostvm icon-default"
                                                                        value="3"><?php echo $LANG['UI_VCENTER_SHOW_HOST_VM'] ?></option>
                                                            </select>
                                                        ...
                                                        <div class="src-wrap__content__ztree">
                                                            <div class="three_tree">
                                                                <ul id="vm_tree"
                                                                    class="ztree bd1de5  tree_div display-hide"></ul>
                                                                <ul id="vm_tree_hc"
                                                                    class="ztree bd1de5  tree_div "></ul>
                                                                <ul id="vm_tree_vt"
                                                                    class="ztree bd1de5  tree_div display-hide"></ul>
                                                            </div>
                                                                    ...
                                                                    <li>
                                                                        <?php if ($_SESSION['isThreePowers'] && 5 == $_SESSION['userLevel']) {
                                                                            ...
                                                                            echo $LANG['UI_BACKUP_NO_VM_DATA_TIPS3'];
                                                                                ...
                                                                                <a id="toaddvcenter"><?php echo $LANG['UI_BACKUP_NO_VM_DATA_TIPS1'] ?></a>
                                                                        <?php } ?>
                                                                    </li>
                                                                    <li>
                                            ...
                                            <div class="col-md-8 VMList-div">
                                                    ...
                                                    <?php if (empty($_SESSION['tenantuuid'])) { ?>
                                                            ...
                                                            <span class="vm-filter-span">
                                                                <a href="javascript:void(0)" id="vmFilterBtn">
                                                                    <span class="vm-text display-none"><?php echo $LANG['UI_BACKUP_VM_FILTER'] ?></span>
                                                                    <span class="instance-text display-none"><?php echo $LANG['UI_BACKUP_INSTANCE_FILTER'] ?></span>
                                                                </a>
                                                            </span>
                                                                <span class="ml10">
                                                ...
                                                <div class="addIt-list">
                                                    ...
                                                    <!-- 租户隐藏提示 -->
                                                    <?php if (empty($_SESSION['tenantuuid'])) { ?>
                                                            <div class="alert alert-info display-none vm-select-tips">
                                                                <button type="button" class="close"
                                                                        data-dismiss="alert"></button>
                                                                <h4 class="alert-heading">
                                                            ...
                                                            <div class="alert alert-info display-none instance-select-tips">
                                                                <button type="button" class="close"
                                                                        data-dismiss="alert"></button>
                                                                <h4 class="alert-heading">
                                                                    <strong><?php echo $LANG['UI_PUBLIC_TIPS'] ?></strong></h4>
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="tabbable-custom " >
                                                                ...
                                                                <div class="form-group icsvvdktransportdiv display-none">
                                                                    ...
                                                                    <!--                                                                    <div class="col-md-offset-3 col-md-9 mt5_cn">-->
                                                                    <!--                                                                        <span>--><?php //echo $LANG['UI_BACKUP_TRANSPORT_SELECT_NBD_TIPS'] ?><!--</span>-->
                                                                    <!--                                                                    </div>-->
                                                                </div>
                                                                ...
                                                                <div class="form-group appliancediv display-none">
                                                                    <label class="control-label col-md-3 appliancelabel"><?php echo $LANG['UI_PLATFORM_APPLIANCE'] ?></label>
                                                                    <div class="col-md-4 form-group-content">
                                                                ...
                                                                <div class="form-group parallelTransferDiv">
                                                                    ...
                                                                    <div class="col-md-9 accordion strategyOne parallelTransferDiv" >
                                                                        <div class="panel panel-default strategy-panel">
                                                                            <div class="panel-heading">
                                                                                <h4 class="panel-title">
                                                                                    <a class="accordion-toggle accordion-toggle-styled popovers"
                                                                        ...
                                                                        <div class="tab-pane active" id="tab_high_snapshot">
                                                                            <div class="col-md-12 advanced-detail-conf-district pt40">
                                                                                ...
                                                                                <div class="form-group SnapshotDiv">
                                                                                    ...
                                                                                    <div class="col-md-2 vmbackup-mt10_en mt5_cn">
                                                                                        <a class="popovers vm-text" data-container="body" data-trigger="hover" data-html="true"
                                                                                           data-placement="right" data-content="<?php echo $LANG['UI_BACKUP_MODE_HIGH_SNAPSHOT_TIPS'] ?>">
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                        <a class="popovers instance-text display-none" data-container="body" data-trigger="hover" data-html="true"
                                                                                           data-placement="right" data-content="<?php echo $LANG['UI_BACKUP_MODE_PRIVATE_CLOUD_HIGH_SNAPSHOT_TIPS'] ?>">
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group preSnapshotDiv">
                                                                                    ...
                                                                                    <div class="col-md-2 form-group-content">
                                                                                        <input type="checkbox" id="preSnapshotcheck"  class="make-switch" data-on-color="primary" data-off-color="info" data-size="small"
                                                                                               data-on-text="<?php echo $LANG['UI_PUBLIC_ON'] ?>"
                                                                                               data-off-text="<?php echo $LANG['UI_PUBLIC_OFF'] ?>">
                                                                                        <a class="popovers ml15 vm-text" data-container="body" data-trigger="hover" data-html="true" data-placement="right"
                                                                                           data-content="<?php echo $LANG['UI_BACKUP_PRE_CREATE_SNAPSHOT_TIPS'] ?>" >
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                        <a class="popovers ml15 instance-text display-none" data-container="body" data-trigger="hover" data-html="true" data-placement="right"
                                                                                           data-content="<?php echo $LANG['UI_BACKUP_PRIVATE_CLOUD_PRE_CREATE_SNAPSHOT_TIPS'] ?>" >
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-md-12 advanced-detail-conf-district pt40">
                                                                                ...
                                                                                <div class="form-group swapdiv display-none" >
                                                                                    ...
                                                                                    <div class="col-md-2 form-group-content">
                                                                                        ...
                                                                                        <a class="popovers ml15 instance-text display-none" data-container="body" data-trigger="hover" data-html="true" data-placement="right"
                                                                                           data-content="<?php echo $LANG['UI_BACKUP_MODE_PRIVATE_CLOUD_HIGH_SWAP_TIPS'] ?>" >
                                                                                            <i class="viconfont vicon-tishi"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                        ...
                                        <div class="tab-pane__body">
                                            <div class="tab-pane__body__form">
                                                ...
                                                <div class="form-group mb0 mt10 display-hide">
                                                    <label class="control-label col-md-3 exclude-vm-label"><?php echo $LANG['UI_BACKUP_EXCLUDED_VM'] ?>:</label>
                                                    <div class="col-md-9">
                                                        <p class="form-control-static colorgreen excludevmshow">
                                                        </p>
                                                    </div>
                                                </div>
                                                <h4 class="form-section"></h4>
                                                ...
                                                <div class="form-group mb0 mt10 backupTypeInfoDiv">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p class="form-control-static colorgreen backuptypeinfoshow">
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="form-group mb0 mt10">
                                                ...
                                                <div class="form-group mb0 mt10 showdiv" id="backupmodeshowdiv">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-control-static colorgreen presnapshotshow">
                                                        </div>
                                                        ...
                                                        <div class="form-control-static colorgreen resetcbtshow">
                                                        </div>

                                                        <div class="form-control-static colorgreen storagesnapshotshow">
                                                        </div>
                                                        <div class="form-control-static colorgreen snapshotdelspeedshow">
                                                        </div>
                                                        <div class="form-control-static colorgreen highdiskcbtshow">
                                                        </div>
                                                        ...
                                                        <div class="form-control-static colorgreen retryshow">
                                                        </div>
                                                        <div class="form-control-static colorgreen blocksizeshow">
                                                        </div>
                                                        <div class="form-control-static colorgreen datacontainersizeshow">
                                                        </div>
                                                        <div class="form-control-static colorgreen mergemodeshow">
                                                        </div>
                                                ...
                                                <div class="form-group mb0 mt10 speedlimitDiv">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p class="form-control-static colorgreen speedlimitshow">
                                                        </p>
                                                    </div>
                                                </div>
        ...
        <div id="vmFilterModal" class="modal xmodal fade form-horizontal " tabindex="-1" data-focus-on="input:first" data-backdrop="static">
            <div class="modal-header ">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title vm-text"><i class="viconfont vicon-ge_filter"></i> <?php echo $LANG['UI_BACKUP_VM_FILTER'] ?>
                </h4>
                <h4 class="modal-title instance-text display-none"><i class="viconfont vicon-ge_filter"></i> <?php echo $LANG['UI_BACKUP_INSTANCE_FILTER'] ?>
                </h4>
            </div>
            <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                ...
                                <ul class = "alert-ul">
                                    ...
                                    <li class="vm-text"><?php echo $LANG['UI_BACKUP_VM_NAME_PREFIX_MATCH_TIPS'] ?></li>
                                    <li class="instance-text display-none"><?php echo $LANG['UI_BACKUP_INSTANCE_NAME_PREFIX_MATCH_TIPS'] ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script src="./scripts/vm/vmbackupedit.js" type="text/javascript"></script>
