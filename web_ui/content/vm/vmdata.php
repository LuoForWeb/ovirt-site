...
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="backupdata-wrapper" id="vm-data">
    ...
    <div class="backupdata-wrapper__head">
        ...
        <span class="backupdata-wrapper__head__title"><?php echo $LANG['UI_DATA_VM'] ?></span>
    </div>
    ...
    <div class="backupdata-wrapper__content row">
        <div class="col-md-4 timepoint-wrapper">
            <div class="timepoint-wrapper__head">
                ...
                <span class="timepoint-wrapper__head__title"><?php echo $LANG['UI_VM_DATA_VCENTER_VC'] ?></span>
            </div>
        ...
        <div class="col-md-8 tabledata-wrapper">
            <div class="tabledata-wrapper__head">
                ...
                <span
                        class="tabledata-wrapper__head__title"><?php echo $LANG['UI_FILE_BACKUP_POINT'] ?></span>
...
<script type="text/javascript" src="./scripts/vm/vmdata.js"></script>
