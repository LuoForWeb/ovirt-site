...
<div class="row" id="vm-report">
    <input type="hidden" id="subModuleType" value="3">
	<div class="col-md-12">
		<!-- Begin: life time stats grey-cararra -->
		<div class="portlet box blue-hoki" >
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-vm_overview"></i><?php echo $LANG['UI_OVERVIEW_PUBLIC_CLOUD_INSTANCE_LIST']?>
				</div>
				<div class="tools">
							</div>
			</div>
		...
		<div id="modaldiv" class="modal xmodal fade form-horizontal high-search" tabindex="-1" data-focus-on="input:first" data-backdrop="static">
			...
			<div class="modal-header ">
				...
				<h4 class="modal-title"><i class="levelchild viconfont vicon-ge_add_task"></i> <?php echo $LANG['UI_OVERVIEW_PUBLIC_CLOUD_ADD_INSTANCE_TO_TASK']?></h4>
			</div>
			<div class="modal-body">
                <div class="form-group vmnameDiv">
			        <label class="col-md-3 control-label "><?php echo $LANG['UI_OVERVIEW_PUBLIC_CLOUD_INSTANCE_NAME']?></label>
                ...
                <div class="form-group">
                	...
                	<div class="col-md-8">
                		...
                		<?php echo $LANG['UI_OVERVIEW_PUBLIC_CLOUD_ADD_TO_TASK_TIPS']?> </span>
                	</div>
                </div>
                <div class="alert alert-danger display-none" id="modaltips">
                    ...
                    <ul class="alert-ul">
                        ...
                        <li>
                            <?php echo $LANG['UI_OVERVIEW_PUBLIC_CLOUD_ADD_TO_TASK_WARNING_TIPS']?>
                        </li>
                    </ul>
				</div>
			</div>
			...
			<div class="modal-body">
    			<div class="portlet-body">
    			    ...
    			    <div class="list-option">
    					<div class="row">
    						<!-- 云平台类型 -->
    						<label class="control-label col-md-2"><?php echo $LANG['UI_OVERVIEW_PUBLIC_CLOUD_PLATFORM_TYPE']?> :
							</label>
							<div class="col-md-4">
							...
							<!-- 云平台 -->
    						<label class="control-label col-md-2"><?php echo $LANG['UI_OVERVIEW_PUBLIC_CLOUD_PLATFORM']?> :
							</label>
							<div class="col-md-4">
    				...
    				<div class="list-option">
    					<div class="row">
							...
							<!-- 区域 -->
							<label class="control-label col-md-2"><?php echo $LANG['UI_OVERVIEW_PUBLIC_CLOUD_REGION']?> :
							</label>
							<div class="col-md-4">
								<input style="width:235px; height:34px;" id="region" type="text" maxlength="64" class="table-group-action-input form-control input-inline input input-sm" aria-controls="example">
							</div>
...
<!--导出（p_aws_overview_export）、打印（p_aws_overview_print）权限控制-->
<input type="hidden" id="show_p_aws_overview_export" value="<?php echo (in_array('p_aws_overview_export', $_SESSION['permissionArr']) ? 1: 0);?>"/>
<input type="hidden" id="show_p_aws_overview_print" value="<?php echo (in_array('p_aws_overview_print', $_SESSION['permissionArr']) ? 1 : 0);?>"/>
...
<script type="text/javascript" src="./scripts/aws/awsreport.js"></script>
