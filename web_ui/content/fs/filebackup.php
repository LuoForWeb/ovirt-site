...
<div class="row" style="height: 100%;">
	<div class="col-md-12" style="height: 100%;">
		<div class="portlet box blue-hoki backup-page" id="filebackupcontent">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont  vicon-xinjianbeifen1"></i><?php echo $LANG['UI_BACKUP_FILE_CREATE_NEW_JOB'] ?>
				</div>
			</div>
									...
									<div class="row tab-pane__row">
										<div class="col-md-4 tab-pane__row__source">
											<div class="form-group src-wrap">
												<div class="src-wrap__title">
													<span>
														<i class="levelchild viconfont vicon-ge_backup_host"></i> <?php echo $LANG['UI_BACKUP_SELECT_BAK_HOST'] ?>
													</span>
												</div>
												<div class="src-wrap__content">
													<div class="src-wrap__content__search">
														<div class="alert alert-block alert-info fade in" id="noagent">
															...
															<ol class="alert-ol">
																<li>
																	<?php echo $LANG['UI_BACKUP_FILE_PLEASE_ADD_NEW_AGENT_TIPS2'] ?>
																</li>
																<li>
																	<a id="toAdd" class="alert-link"><?php echo $LANG['UI_BACKUP_FILE_PLEASE_ADD_NEW_AGENT_TIPS1'] ?></a>
																</li>
															</ol>
														</div>
														<div class="vm_tree_div">
															<div class="searchDiv width100p display-none">
																<div>
																	<input type="text" maxlength="128" placeholder="<?php echo $LANG['UI_COPY_SEARCH_AS_KEYWORD'] ?>" class="form-control" id="searchAgent" style="margin: 0" onkeyup="customInputValidate('string', this.value, $(this))" >
																</div>
															</div>
														</div>
													</div>
										...
										<div class="col-md-8">
											<div class="alert alert-block alert-info fade in" id="step1tips">
												...
												<h4 class="alert-heading"><strong><?php echo $LANG['UI_PUBLIC_TIPS'] ?></strong></h4>
												<ol class="alert-ol">
													<li><?php echo $LANG['UI_BACKUP_FILE_BAK_TIPS1'] ?></li>
													<li><?php echo $LANG['UI_BACKUP_FILE_BAK_TIPS2'] ?></li>
													<li><?php echo $LANG['UI_BACKUP_FILE_BAK_TIPS3'] ?></li>
													<li><?php echo $LANG['UI_BACKUP_FILE_BAK_TIPS4'] ?></li>
												</ol>
											</div>
										</div>
											...
											<div class="tab-content hover-scroll-y">
												<div class="tab-pane active" id="tab_common">
													<div class="panel-body">
														...
														<!-- 保留策略 -->
														<div class="form-group reserveStrategyDiv">
															<div class="col-md-offset-1 col-md-10 ">
														...
														<div class="advance-config-wrap__row row m0">
															<div class="col-md-2 col-sm-2 col-xs-2 nav-tab-radios">
																<ul class="nav nav-tabs tabs-left">
																	...
																	if ($authfun['fileArchiveMode']) {
																		echo '
																			<li class="">
																				<a href="#archive_handle_pane"
																					data-toggle="tab" aria-expanded="true">
																					' . $LANG['UI_PLATFORM_ARCHIVE'] . '
																				</a>
																			</li>
																			';
																	}
															...
															<div class="col-md-10 col-sm-10 col-xs-10 pe-0 advance-config-wrap__row__content">
																<div class="tab-content level1">
																	...
																	<div class="tab-pane fade" id="archive_handle_pane">
																		<div class="abnormal-handle-form">
																			<?php
																			if ($authfun['fileArchiveMode']) {
																				echo '
																						<!-- 归档 -->
																						<div class="form-group archivediv">
																							<label class="control-label col-md-4 archivelabel form-group-label">' . $LANG["UI_PLATFORM_ARCHIVE"] . '</label>
																							<div class="col-md-3 form-group-content">
																								<input type="checkbox" id="archivecheck"  class="make-switch" data-on-color="primary" data-size="small" data-off-color="info" 
																								...
																								<a class="popovers ml15" data-container="body" data-trigger="hover" data-html="true" data-placement="right" 
																										data-content="' . $LANG["UI_FILE_BAK_ARCHIVE_TIPS"] . '" >
																										<i class="viconfont vicon-tishi"></i>
																									</a>
																							</div>
																						</div>
																						<!-- 归档目标选择 -->
																						<div class="form-group archiveselectdiv display-none">
																							<label class="control-label col-md-4 archiveselectdivlabel">' . $LANG["UI_FILE_ARCHIVE_DESTINATION"] . '</label>
																							<div class="col-md-3">
																							<select name="" id="archiveSelect" class="form-control select2me">
																								<option value="3">' . $LANG['UI_FILE_FILE'] . '</option>
																								<option value="1">' . $LANG['UI_FILE_FILE_DIRECTORY'] . '</option>
																							</select>
																							</div>
																						</div>
																						<div class="form-group archivedes display-none" style="color: red;">
																							<label class="control-label col-md-4"></label>
																							<div class="col-md-4">' . $LANG["UI_FILE_PERMANENT_DES"] . '</div>
																						</div>
																						';
																			}
																			?>
																	...
																	<div class="tab-pane fade" id="abnormal_handle_pane">
																		<div class="abnormal-handle-form">
																			<!-- 跳过文件告警智能判断 -->
...
<script src="./scripts/fs/filebackup.js" type="text/javascript"></script>