	...
	<div class="col-md-12">
		...
		<div class="portlet box blue-hoki">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-vmdata"></i><?php echo $LANG['UI_DATA_FILE']?>
				</div>
			</div>
			     ...
			     <div class="row">
			         <div class="col-md-4">
			             <div class="portlet" id="timepointdiv">
			                <div class="portlet-title">
                				<div class="caption">
                					<i class="viconfont vicon-ge_time_point"></i><?php echo $LANG['UI_FILE_RECOVERY_BACKUP_POINT']?>
                				</div>
                			</div>
			         ...
			         <div class="col-md-8">
			             <div class="portlet ">
			                <div class="portlet-title">
                				<div class="caption">
                					<i class="viconfont viconfont vicon-ge_backup_file"></i><?php echo $LANG['UI_FILE_BACKUP_POINT']?>
							...
							<div class="alert alert-block alert-info fade in" id="tabletips">
								...
								<ol class = "alert-ol">
									...
									<li><?php echo $LANG['UI_FILE_TIMEPOINT_MANAGER_TWO']?></li>
									<li><?php echo $LANG['UI_DATA_VM_TIPS3']?></li>
									<li><?php echo $LANG['UI_DATA_VM_TIPS4']?></li>
								</ol>
							</div>
                			<div class="portlet-body display-none" id="filetablediv">
								<!-- search -->
...
<script type="text/javascript" src="./scripts/fs/filedata.js"></script>
