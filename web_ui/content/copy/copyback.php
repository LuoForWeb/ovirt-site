...
<!-- BEGIN PAGE HEADER-->
<!--<h3 class="page-title">
<?php echo $LANG['UI_COPY_BACK'] ?> <small><?php echo $LANG['UI_COPY_BACK_CREATE'] ?></small>
</h3>-->
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<h3 class="breadcrumb">
	...
	<span class="curent">
		...
		if ($_SESSION['language'] == "zh-cn" || $_SESSION['language'] == "zh-tw") {
			$page_name .= $LANG['UI_PLATFORM_VM_COPY_RECOVERY'];
		}else{
			$page_name .= ' ' . $LANG['UI_PLATFORM_VM_COPY_RECOVERY'];
		}
...
<div class="recover-page">
	<div class="col-md-12" style="height: 100%;">
		...
		<div class="portlet box blue-hoki backup-page" id="copyBackContent" style="height: 100%; margin-bottom:0;">
			<div class="portlet-title">
				<div class="caption">
					<i class="levelchild viconfont vicon-vmcopyback"></i><?php echo $LANG['UI_COPY_BACK_NEW_JOB'] ?>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="#" class="form-horizontal" id="submitForm" method="POST">
								...
								<ul class="nav nav-pills steps">
									<li>
										<a href="#tab1" data-toggle="tab" class="step">
											...
											<span class="desc">
												<?php echo $LANG['UI_COPY_BACK_SOURCE'] ?>
									...
									<li>
										<a href="#tab2" data-toggle="tab" class="step">
											...
											<span class="desc">
												<?php echo $LANG['UI_COPY_BACK_TARGET'] ?>
												<i class="fa fa-check"></i>
											</span>
										</a>
									</li>
									<li>
										<a href="#tab3" data-toggle="tab" class="step active">
											...
											<span class="desc">
												<?php echo $LANG['UI_COPY_BACK_TYPE'] ?>
												<i class="fa fa-check"></i>
											</span>
										</a>
									</li>
											...
											<div class="col-md-4 tab-pane__row__source">
												<div class="form-group src-wrap">
													<div class="src-wrap__title">
														<span><?php echo $LANG['UI_COPY_BACK_SOURCE'] ?></span>
													</div>
													<div class="src-wrap__content">
														<div class="src-wrap__content__search">
															<div class="src-search_wrapper src-data_type">
																...
																<select class="bs-select form-control dataType input-sm" data-show-subtext="true" id="dataType">
																	<option data-icon="timetasktype icon-default" value="3"> <?php echo $LANG['UI_COPY_BACK_NEW_SELECT_TASK'] ?></option>
															...
															<div class="src-search_wrapper src-storage">
																...
																<select class="bs-select form-control  storage input-sm" data-show-subtext="true" id="storage">
																</select>
														...
														<div class="src-wrap__content__ztree" style="height:calc(100% - 184px)">
															<div class="three_tree copyTreeDiv">
																<ul id="copySourceTree" class="ztree bd1de5 ztree-fa tree_div"></ul>
															</div>
															<div class="alert alert-block alert-info fade in display-hide" id="noDataTips">
																...
																<ol class="alert-ol">
																	...
																	<li>
																		<a id="toBackup" class="alert-link"><?php echo $LANG['UI_COPY_BACK_NO_VM_TIPS'] ?></a>
																	</li>
																</ol>
															</div>
...
<script src="./scripts/copy/copyback.js" type="text/javascript"></script>