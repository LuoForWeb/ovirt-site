            ...
            <div class="drawer-body">
                ...
                <div class="form-group mt30">
                    ...
                    <div class="col-md-1 form-group-content">
                        <a>
                            <i class="viconfont vicon-tishi" data-container="body" data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $LANG['UI_RECOVERY_AWS_VPC_TIPS'] ?>"></i>
                        </a>
                    </div>
                </div>
                <!-- 子网 -->
                <div class="form-group mt30">
                    ...
                    <div class="col-md-1 form-group-content">
                        <a>
                            <i class="viconfont vicon-tishi" data-container="body" data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $LANG['UI_RECOVERY_AWS_SUBNET_TIPS'] ?>"></i>
                        </a>
                    </div>
                </div>
                <!-- 安全组 -->
                <div class="form-group mt30">
                    ...
                    <div class="col-md-1 form-group-content">
                        <a>
                            <i class="viconfont vicon-tishi" data-container="body" data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $LANG['UI_RECOVERY_AWS_SECURITY_GROUP_TIPS'] ?>"></i>
                        </a>
                    </div>
                </div>
                <!-- 加密密码 -->
                ...
                <div class="form-group mt30">
                    ...
                    <div class="col-md-1" style="margin-top: -8px">
                        <a>
                            <i class="viconfont vicon-tishi" data-container="body" data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $LANG['UI_RECOVERY_AWS_ALLOCATE_PUBLIC_IP_TIPS'] ?>"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="form-group mt30 display-none public-ip-billing">
                    ...
                    <div class="col-md-1 form-group-content">
                        <a>
                            <i class="viconfont vicon-tishi" data-container="body" data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $LANG['UI_RECOVERY_CLOUD_BILLING_TIPS'] ?>"></i>
                        </a>
                    </div>
                </div>
                <!-- 带宽/流量大小 -->
        ...
        <div class="drawer-content drawer-content-scrollable" role="document">
            ...
            <div class="drawer-body">
                ...
                <div class="form-group mt30 kms-div">
                    ...
                    <div class="col-md-1 kms-tips form-group-content">
                        <a>
                            <i class="viconfont vicon-tishi" data-container="body" data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $LANG['UI_RECOVERY_AWS_KMS_KEY_TIPS'] ?>"></i>
                        </a>
                    </div>
                </div>
                <!-- 加密密码 -->
                ...
                <div class="form-group mt30 display-none">
                    ...
                    <div class="col-md-1 ddot-tips form-group-content display-none">
                        <a>
                            <i class="viconfont vicon-tishi" data-container="body" data-toggle="tooltip" data-placement="top" data-html="true" title="<?php echo $LANG['UI_RECOVERY_CLOUD_DISK_DELETE_ON_TERMINATION_HUAWEICLOUD_TIPS'] ?>"></i>
                        </a>
                    </div>
                </div>
            </div>
