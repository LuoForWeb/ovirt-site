            ...
            <div class="drawer-body">
                ...
                <div class="form-group mt30 display-none" id="verify_pwd">
                    ...
                    <div class="col-md-3 mt7">
                        <a>
                            <i class="viconfont vicon-tishi" data-container="body" data-toggle="tooltip" data-placement="right" data-html="true" title="<?php echo $LANG['WEB_VM_VCENTER_VERIFY_ACCOUNT_PASSWORD_TIPS']?>"></i>
                        </a>
                    </div>
                </div>
            </div>
