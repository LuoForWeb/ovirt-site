        ...
        $(`#${id}`).html(`
                            <div class="form-group display-none">
                               ...
                               <div class="col-md-3 form-group-content flex-items-center">
                                  ...
                                  <a class="ml12 mb-5" data-toggle="tooltip" data-placement="right" data-html="true" title="${LANG.WEB_OS_TRANSFER_ENCRY_TIPS}">
                                     ...
                                     <div class="panel panel-default strategy-panel">
                                         <div class="panel-heading">
                                            <h4 class="panel-title">
                                               <a class="accordion-toggle accordion-toggle-styled" data-container="body" data-trigger="hover" data-placement="top" data-toggle="collapse" data-parent=".strategyOne" href="#backupTim" aria-expanded="true">
    ...
    $.fn.completeStrategyApply = function (precent = 'col-md-3', integrity_check_flag = true) {
		...
		<div class="form-group">
           ...
           <div class="col-md-3 form-group-content flex-items-center">
               ...
               <a class="ml12 mb-5" data-toggle="tooltip" data-placement="top" data-html="true" title=${LANG.UI_SAFE_STRATEGY_BACKUP_POINT_CHECK}>
                   <i class="viconfont vicon-tishi"></i>
               </a>
           </div>
        </div>
           		...
           		<div class="bodyComplete">
			    	<div class="complete-item__wrapper complete__wrapper">
			    		...
			    		<div class="virus-item">
           		    	...
           		    	<div class="virus-item ${hide_recovery_to_no_network ? 'display-none' : ''}">
