...
<head>
    ...
    <link href="/system/login/css/loginbackground.css" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
...
<input type="text" class="systemLang display-none" value="<?php echo $_SESSION['language']?>">
    <div class="content">
        ...
        <?php
           if($_SESSION['language'] == "zh-cn" || $_SESSION['language'] == "zh-tw"){
                echo '<img src="/system/login/img/lockImg.png" alt="">';
           }
           else{
                echo '<img src="/system/login/img/lockImg_en.png" alt="">';
           }
        ...
        <div class="lock">
                    ...
                    <a class="brand" href="<?php echo $app['REMOTE']['website']?>" target="_black">
                        ...
                        if($app['SOFTWARE_VERSION']['FREE_EDITION'] == $softwareType){
                            ...
                            if(file_exists($app['SPECIAL_DIR'] . "logo.png")){
                                ...
                                $logo = "/system/login/img/logoLock.png";
                            }
                ...
                <form class="lock-form" action="./">
                    ...
                    <div class="lockLine">
                        ...
                        ?>
                        <a href="/login"><?php echo $LANG['UI_LOCK_OTHER_USER']?> </a>
                        <?php
                                 if($_SESSION['language'] == "zh-cn" || $_SESSION['language'] == "zh-tw"){
                                            echo '<span class="line"></span>';
                                    }
    ...
    <div class="copyright">
        ...
        <script src="/system/login/js/lock.js"></script>
</body>
</html>