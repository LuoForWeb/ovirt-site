var VMGrainRecover = function () {
	var pointtypetree, pointtypetreeInitFlag = false, vmtypetree, vmTypetreeInitFlag = false, hostTree;
	...
	var submitCheck = function(){
		...
		let p = {
			...
			job_name: $('input[name=taskname]').val()
		};
		Metronic.blockUI({target: '#recovercontent',animate: true, cenrerY: true,});
		pAjaxRequest(p, "/api/v1/vm/jobs/granular_restore", "POST", function (res) {
