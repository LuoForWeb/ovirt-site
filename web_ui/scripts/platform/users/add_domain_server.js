var AddDomainServer = function(){
    ...
    var handleValidation = function() {
        // for more info visit the official plugin documentation:
            ...
            var form2 = $('#form_addDomainServer');
...
//		        		 ipv4Ordomain: true
    ...
    var submit = function(){
		...
		data.password = encrypt.encrypt(($('#password').val()));
		Metronic.blockUI({target: '#adddomainContent',animate: true,cenrerY: true,});
		pAjaxRequest(data,'/api/v1/domains','POST',registerResult);
    };

    var registerResult = function(data){
		Metronic.unblockUI('#adddomainContent');
