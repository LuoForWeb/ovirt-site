    ...
    const getDefaultTypeContent = options => {
        ...
        <div class="networkConfigWrapper">
            <ul class="nav nav-tabs">
                <li class="ipv4Li active">
                    <a href="#${options.element_set.ipv4_tab_id}" class="popovers" data-content="${LANG.UI_PUBLIC_IPV4_CONFIG}" data-container="body"
                        data-trigger="hover" data-placement="top" data-toggle="tab">${LANG.UI_PUBLIC_IPV4_CONFIG}</a>
                </li>
                <li class="ipv6Li">
                    <a href="#${options.element_set.ipv6_tab_id}" class="popovers" data-content="${LANG.UI_PUBLIC_IPV6_CONFIG}" data-container="body"
                        data-trigger="hover" data-placement="top" data-toggle="tab">${LANG.UI_PUBLIC_IPV6_CONFIG}</a>
                </li>
            </ul>
                        ...
                        <div class="col-md-9 control-item networkConfigWrapper__parent">
                            <div class="networkConfigWrapper">
                                <ul class="nav nav-tabs" id="${row.ip_config_id}__nav_tabs">
                                    <li class="ipv4Li active">
                                        <a href="#${row.ipv4_tab_id}" class="popovers" data-content="${LANG.UI_PUBLIC_IPV4_CONFIG}" data-container="body"
                                            data-trigger="hover" data-placement="top" data-toggle="tab">${LANG.UI_PUBLIC_IPV4_CONFIG}</a>
                                    </li>
                                    <li class="ipv6Li">
                                        <a href="#${row.ipv6_tab_id}" class="popovers" data-content="${LANG.UI_PUBLIC_IPV6_CONFIG}" data-container="body"
                                            data-trigger="hover" data-placement="top" data-toggle="tab">${LANG.UI_PUBLIC_IPV6_CONFIG}</a>
                                    </li>
                                </ul>
