...
<body class="page-header-fixed overflowy-hide page-quick-sidebar-over-content <?php echo $sidebarClass; ?>">
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-logo">
            ...
            <div class="sidebar-toggle" data-toggle="tooltip" data-placement="bottom" title="<?php echo $LANG['UI_FOLD'] ?>" id="sidebar_toggle">
        ...
        <span class="product-name text-overflow-ellipsis <?php echo $_SESSION['softwareNameDiy'] ? '' : 'hide' ?>">
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-extended dropdown-notification dropdown-warning" id="surveyalarm" style="display: <?php echo $surveyalarmShow ?>">
                    <a href="#" class="dropdown-toggle"  data-toggle="dropdown" data-hover="dropdown" data-close-others="true" id="alarmtotal">
                        ...
                        <span class="badge badge-danger display-hide">
                    </span>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                ...
                if (empty($_SESSION['tenantuuid'])) {
                    ...
                    echo '<li class="dropdown dropdown-extended dropdown-notification" id="visualscreen" style="' . $hide . '">
                                <a title="' . $LANG['UI_VISUAL_SCREEN'] . '" href="/visualscreen" class= "dropdown-toggle visualization" target="_blank"  data-hover="dropdown"  ><i class="viconfont vicon-a-Computerdiannao"></i></a>
                            </li>';
                }
                ?>
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="./content/platform/users/userinfo.php" name="userinfo" class="ajaxify">
                                <i class="viconfont vicon-a-Peoplerenyuan"></i> <?php echo $LANG['UI_USER_SELF_INFO'] ?>
                            </a>
                        </li>
<!--                        --><?php
...
//                                    <i class="viconfont vicon-a-Editbianji1"></i> ' . $LANG['UI_USER_MODIFY_PASS'] . ' </a>
//                            </li>';
//                        }
//                        ?>
                        <li>
                            <a href="javascript:void(0)" onclick="loginOut()">
                                <i class="viconfont vicon-ge_lock"></i> <?php echo $LANG['UI_USER_LOCK_SCREEN'] ?>
                            </a>
                        </li>
                            ...
                            echo '
                                <li>
                                    <a href="./content/platform/users/aboutus.php" name="aboutus" class="ajaxify">
                                        <i class="viconfont vicon-guanyu"></i> ' . $LANG['UI_USER_ABOUT_US'] . ' 
                                    </a>
                                </li>';
                        }
                        ?>
                        ...
                        <li>
                            <a href="javascript:void(0)" onclick="loginOut(1)">
                                <i class="viconfont vicon-a-Logouttuichu"></i> <?php echo $LANG['UI_USER_LOGIN_OUT'] ?>
                            </a>
                        </li>
                    </ul>
                </li>
