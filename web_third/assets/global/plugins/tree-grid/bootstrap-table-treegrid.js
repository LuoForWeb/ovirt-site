    ...
    for (; i < args.length; i++) {
      ...
      for (const name in options) {
        ...
        if (deep && copy && (isObject(copy) || copyIsArray)) {
          ...
          target[name] = customExtend(deep, clone, copy)
  ...
  $$4.BootstrapTable = /*#__PURE__*/function (_$$BootstrapTable) {
    ...
    return _createClass(_class, [{
      ...
      value: function initTr(item, idx, data, parentDom) {
        ...
        for (var i = 0; i <= len; i++) {
          var node = nodes[i];
          var defaultItem = customExtend(true, {}, item);
          ...
          this.options.rowStyle = function (item, idx) {
            ...
            res.classes = [res.classes || '', "treegrid-".concat(id), "treegrid-parent-".concat(pid), "treegrid-child"].join(' ');
            return res;
          };
