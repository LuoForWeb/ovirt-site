...
;(function ($) {
    ...
    $.fn.inputSpinner = function (methodOrProps) {
        ...
        const props = {
            decrementButton: "<i class='viconfont vicon-spinner-minus'></i>", // button text
            incrementButton: "<i class='viconfont vicon-spinner-plus'></i>", // ..
            groupClass: "spinner-group", // css class of the resulting input-group
        ...
        this.each(function () {
            ...
            if (this["bootstrap-input-spinner"]) {
                ...
                onPointerDown($buttonDecrement[0], function () {
                    if (!$buttonDecrement.prop("disabled")) {
                        pointerState = true
                        stepHandling(-step, $input[0].value)
                    }
                })
                // increment button
            ...
            function stepHandling(step, newVal) {
                calcStep(step, newVal)
                resetTimer()
            ...
            function calcStep(step, newVal) {
                if (isNaN(value)) {
                    value = 0
                }
                
                setValue(Math.round(newVal) + step)
