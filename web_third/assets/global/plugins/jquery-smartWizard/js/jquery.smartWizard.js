...
(function (factory) {
  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      key: "_showContent",
      value: function _showContent(idx, stepDirection) {
        var _this4 = smartWizard;
        _this4._loadContent(idx, function () {
      ...
      value: function _showStep(idx) {
        ...
        if (this.current_index !== -1) {
          ...
          if (this._triggerEvent("leaveStep", [this._getStepAnchor(this.current_index), this.current_index, idx, stepDirection, this._showContent]) === false) {
            return false;
          }
        }
        this._showContent(idx, stepDirection);
      }
    }, {
      key: "_getShowable",
