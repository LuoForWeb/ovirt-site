...
S2.define('select2/selection/multiple',[
  ...
  MultipleSelection.prototype.update = function (data) {
    ...
    var maximumSelectionDisplay = this.options.get('maximumSelectionDisplay');

    var displayData = data;
    var hasMore = false;

    if (maximumSelectionDisplay && data.length > maximumSelectionDisplay) {
      displayData = data.slice(0, maximumSelectionDisplay);
      hasMore = true;
    }

    for (var d = 0; d < displayData.length; d++) {
      var selection = displayData[d];
    ...
    if (hasMore) {
      var numMore = data.length - maximumSelectionDisplay;
      var $more = $(
        '<li class="select2-selection__choice">' +
          '+' + numMore +
        '</li>'
      ...
      var hiddenTitles = [];
      for (var i = maximumSelectionDisplay; i < data.length; i++) {
        hiddenTitles.push(data[i].title || data[i].text);
      }
      $more.attr('title', hiddenTitles.join(', '));
...
S2.define('select2/options',[
  ...
  Options.prototype.fromElement = function ($e) {
    ...
    if (this.options.maximumSelectionDisplay == null) {
      if ($e.data('maximum-selection-display')) {
        this.options.maximumSelectionDisplay = $e.data('maximum-selection-display');
      }
    }
