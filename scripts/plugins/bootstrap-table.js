(function (global, factory) {
  ...
  */
  ...
  var EN = {
    ...
    formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalNotFiltered, des = '') {
    ...
    _createClass(BootstrapTable, [{
      ...
      value: function initTable() {
        ...
        if (!this.$header.length) {
          ...
          //尝试修复resizeable时表头无法固定的问题（吴宜航）
          // this.$header.css(position:sticky);
      ...
      value: function initToolbar() {
        ...
        this.buttons = Object.assign(this.buttons, {
          ...
          columns: {
            ...
            html: function html() {
              var html = [];
              html.push("<div class=\"keep-open ".concat(_this4.constants.classes.buttonsDropdown, "\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-trigger=\"hover\" title=\"").concat(opts.formatColumns(), "\">\n            <button class=\"").concat(_this4.constants.buttonsClass, " dropdown-toggle\" type=\"button\" ").concat(_this4.constants.dataToggle, "=\"dropdown\"\n            aria-label=\"").concat(opts.formatColumns(), "\">\n            ").concat(opts.showButtonIcons ? Utils.sprintf(_this4.constants.html.icon, opts.iconsPrefix, opts.icons.columns) : '', "\n            ").concat(opts.showButtonText ? opts.formatColumns() : '', "\n            ").concat("\n            </button>\n            ").concat(_this4.constants.html.toolbarDropdown[0]));
      ...
      value: function initPagination() {
        ...
        if (this.paginationParts.includes('pageInfo') || this.paginationParts.includes('pageInfoShort')) {
          var paginationInfo = this.paginationParts.includes('pageInfoShort') ? opts.formatDetailPagination(opts.totalRows) : opts.formatShowingRows(this.pageFrom, this.pageTo, opts.totalRows, opts.totalNotFiltered,opts.pageUnit);
      ...
      value: function initBody(fixedScroll, updatedUid) {
        ...
        // show no records
        if (!hasTr) {
          this.$body.html("<tr class=\"no-records-found\">".concat(Utils.sprintf('<td colspan="%s">%s</td>', this.getVisibleFields().length + Utils.getDetailViewIndexOffset(this.options), this.options.formatNoMatches()), "<div class='no-records-found-border'></div></tr>"));
