var modifyPwd=function () {
    ...
    var addListeners = function (){
        //切换到大写给出提示
        //检测键盘事件
        $('input[name=oldpass]').on('keyup', function(e) {
            const capslockWarning = document.getElementById('old-capslock-warning');
            // 获取原生事件对象
        ...
        $('input[name=password]').on('keyup', function(e) {
            const capslockWarning = document.getElementById('new-capslock-warning');
            // 获取原生事件对象
            const originalEvent = e.originalEvent || e;
        ...
        $('input[name=newPassword]').on('keyup', function(e) {
        ...
        // 当输入框失去焦点时隐藏警告
        $('input[name=oldpass]').on('blur', function() {
            const capslockWarning = document.getElementById('old-capslock-warning');
            capslockWarning.style.display = 'none';
        });
