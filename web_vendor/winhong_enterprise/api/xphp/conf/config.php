...
(
		...
		/*系统信息*/
		'SYSTEM_INFO' => array(
		    'system_name' => 'winhong backup and recovery system',
		    'company' => 'winhong information technology co. LTD',
		    'copyright' => 'Copyright',
		    'years' => '2019',
		    ...
		    //授权处使用
		    'company_name' => '云宏信息科技股份有限公司',               
		    'company_tel' => '400-6300-003',
		    'company_email' => 'marketing@winhong.com',
		),
    
        //远程地址
        'REMOTE' => array(
            'website' => "http://www.winhong.com",
