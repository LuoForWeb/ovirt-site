					...
					<div class="col-md-12">
						<div id="aboutus" style="border: 1px solid #eee;line-height: 28px;">
							<div style="padding: 20px;border-bottom: 1px solid #eee;" class="">
								...
								<div class="">
    				                <label class="width120_cn width130_en"><i class="viconfont vicon-ge_copyright"></i> <?php echo $LANG['UI_SETTINGS_AUTH_VERSION']?>：</label><?php echo 'V' . substr(explode(' ', $CONF['SYSTEM_INFO']['version'])[1], 0, 3)?></span>
    				            </div>
    				            <div class="">
