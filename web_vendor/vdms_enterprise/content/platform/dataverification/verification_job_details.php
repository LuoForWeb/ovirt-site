...
<div class="row job-details" id="jobDetail">
    ...
    <div class="col-md-12 main-contents">
        <div class="main-job-client">
            ...
            <div >
                <div class="batch-btn batch-disabled">启动</div>
            </div>
            ...
            <div class="content-verify-result">
                ...
                <div class="result-div">
                    ...
                    <div class="result-div-m">
                        ...
                        <div class="result-div-desc" style="margin-bottom: 0">
                            <div class="label-desc" style="text-align: left"><?php echo $LANG['UI_HOMEPAGE_TOTAL_NUM']?><span class="span-desc" id="file_total_num" style="float: right;">--</span></div>
                            <div class="label-desc" style="text-align: left;"><?php echo $LANG['WEB_PLATFORM_GMP_JOB_COMPARES']?><span class="span-desc" id="file_total_compare_num" style="float: right;">--</span></div>
                        </div>
                    ...
                    <div class="result-div-r">
                        ...
                        <div class="result-div-desc" style="margin-bottom: 0">
                            <div class="label-desc" style="text-align: left"><?php echo $LANG['UI_HOMEPAGE_TOTAL_NUM']?><span class="span-desc" id="screen_total_num" style="float: right;">--</span></div>
                            <div class="label-desc" style="text-align: left;"><?php echo $LANG['WEB_PLATFORM_GMP_JOB_COMPARES']?><span class="span-desc" id="screen_total_compare_num" style="float: right;">--</span></div>
                        </div>
                        <div class="result-div-con">
        ...
        <div class="main-job-right">
            <div class="right-contents">
                <div class="block-item">
                    <div class="tit"></div>
                    <div class="titles-desc" style="margin-top:-3px;"><?php echo $LANG['UI_PLATFORM_INDUSTRY_SCREEN_COMPARE']?>
                        <a class="popovers"  data-container="body" data-trigger="hover" data-html="true" data-placement="right" data-content="生产与验证主机必须是活跃状态不能息屏</br>生产截屏是通过客户端会话截取，不能最小化" data-original-title="" title="">
                ...
                <div class="block-item-bottom" id="block_calc_page">
                    ...
                    <div class="screen-bottom" data-index="1">
                        <!--<a href="###"> < </a>
                        <a href="###">1</a>
                        <a href="###">2</a>
                        <a href="###">3</a>
    ...
    <!--全屏展示-->
    <div class="full-screen-block-job display-none" id="full-screen-block" style="z-index: 10001;">
        <div class="close-btn">
    ...
    <div class="full-screen-block-job display-none" id="full-machine-block">
        ...
        <div class="title-btn-block">
            <label id="verify_vir" class="in-active">
                <?php echo $LANG['WEB_PLATFORM_GMP_JOB_VERIFY_VIR']?>
                <i class="viconfont vicon-jiepingyanzheng"></i>
            </label>
            <label id="product_vir" class="in-default display-none" style="margin-left:-4px;">
                <?php echo $LANG['WEB_PLATFORM_GMP_JOB_PRODUCT_VIR']?>
                <i class="viconfont vicon-jiepingyanzheng"></i>
            </label>
        </div>
        <div class="content-div-job content-div2" style="height:86%;border-radius:0 !important;">
            <div class="contnt-url" id="show_iframe_url">

            </div>
            <div class="contnt-url display-none" id="show_iframe_url2">

            </div>
            <div class="main-job-right" style="width: 22%;">
                <div class="right-contents">
                    <div class="block-item">
                        <div class="tit"></div>
                        <div class="titles-desc" style="margin-top:-3px;"><?php echo $LANG['UI_PLATFORM_INDUSTRY_SCREEN_COMPARE']?>
                    ...
                    <div class="block-item2">
                        <button type="button" id="allScreen_job2" class="btn green-haze"><?php echo $LANG['WEB_PLATFORM_GMP_JOB_SCREENS']?></button>
                        <button type="button" id="productScreen_job2" class="btn default"><?php echo $LANG['WEB_PLATFORM_GMP_JOB_SCREENS_PRODUCT']?></button>
                        <button type="button" id="verifyScreen_job2" class="btn default"><?php echo $LANG['WEB_PLATFORM_GMP_JOB_SCREENS_VERIFY']?></button>
                    </div>
    ...
    <div class="drawer slide" data-placement="right" tabindex="-1" role="dialog" aria-labelledby="drawer-1-title" aria-hidden="true"
        ...
        <div class="drawer-content drawer-content-scrollable" role="document">
            ...
            <div class="drawer-body">
                ...
                <div class="row static-info">
                    <div class="col-md-4 name">
                        <?php echo $LANG['UI_PLATFORM_INDUSTRY_FILE_PRODUCT_PATH'] ?>
                    </div>
                    <div class="col-md-8 value" id="filePath" style="height:60px;overflow-y:scroll;background:#f8f9fb;">
...
<!--任务详情信息抽屉-->
<div class="drawer slide" data-placement="right" tabindex="-1" role="dialog" aria-labelledby="drawer-1-title" aria-hidden="true"
     id="drawer-job_detail_config" style="width: 1000px;">
    <div class="drawer-content drawer-content-scrollable" role="document">
        <div class="drawer-body">
            <div style="height: 100%;">
                ...
                <div class="portlet box blue-hoki" style="border: none;">
                    ...
                    <div class="portlet-body form">
                        <div class="tab-content" style="padding:20px 0;height: 100%;">
                            ...
                            <div class="tab-pane running-log-pane" id="log_div" style="height: 100%;">
                                <div class="logs-container" id="logs_container" style="height: 100%;">
                                    <div class="header-marginh20">
                                        <label class="detail-header-tit-time">
                                            <div id="running_log_daterangepicker_wrapper" class="btn btn-dropdown-daterange">
                                    ...
                                    <div style="width:100%;height: calc(100% - 40px);overflow: auto;">
                                        <div class="show_log-component" id="runninglog">
