    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse scrollbar">
            <ul class="page-sidebar-menu <?php echo $sidebarClass . $sideMenuClass; ?>" data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200">
                ...
                $arr = array_merge(
                    $arr,
                    ['homepage', 'p_homepage','system', 'p_system_list', 'p_system_rule', 'todo_list', 'p_todo_list', 'industry_report',
                        'p_industry_report_pending', 'p_industry_report_pending_list', 'p_industry_report_pending_approve',
                        'p_industry_report_pending_share', 'p_industry_report_pending_look_comment',
                        'p_industry_report_share', 'p_industry_report_share_list','p_industry_report_share_operation',
                        'industry_template','industry_plan','p_industry_plan','p_industry_plan_list','p_industry_plan_approve','p_industry_plan_approve_look',
                        'p_industry_plan_function','p_industry_plan_list_function','p_industry_plan_approve_function','p_industry_plan_approve_look_function',
                    ]
                );
