...
return array(
    ...
    array(
        'name' => "todo_list",
        'path' => "./content/platform/todo_list.php",
        'class' => "viconfont vicon-daiban",
        'title' => "UI_PLATFORM_TODO_LIST",
        'level' => 0,
        'child' => array(
            // 查看
            array(
    ...
    array(
        'name' => "monitor",
        'path' => "javascript:;",
        'class' => "viconfont vicon-a-Analysisfenxi",
        'title' => "UI_PLATFORM_MONITORS",
        'level' => 0,
        'showChild' => true,
        'child' => array(
            //日志
            ...
            array(
                'name' => "message",
                'path' => "./content/platform/message_center.php",
                'class' => "viconfont vicon-xiaoxituisong",
                'title' => "UI_PLATFORM_MESSAGE",
                'level' => 1,
                'child' => array(
                    // 查看
                    array(
    ...
    array(
        ...
        'path' => "./content/platform/jobs/verify_jobs.php",
        'class' => "viconfont vicon-a-Protectbaohu1",
        'title' => "UI_PLATFORM_JOB_MONITOR_VERIFY",
        'level' => 0,
        'child' => array(
            // 数据验证计划
            array(
                ...
                'child' => array(
                    ...
                    // operate
                    array(
                        'name' => "p_verification_job_operate",
            ...
            // 历史任务
            array(
                'name' => "verify_history_job",
                'path' => "./content/platform/jobs/verify_history_job.php?job_type=37",
                ...
                'child' => array(
                    // 查看
                    array(
                        'name' => "p_verify_history_job_list",
                        'title' => "UI_PUBLIC_LOOK",
                        'function' => array(
                            '15-getAllHypervisorType',
                            '16-getNodeList',
                    ...
                    /*// 删除
                    array(
                        'name' => "p_verify_history_job_delete",
                        'title' => "UI_PUBLIC_DELETE",
                        'function' => array(
                            '5-deleteHistoryTask',
                            'delete-jobs_history',
                    ...
                    // 下载任务日志
                    array(
                        'name' => "p_verify_history_job_download",
                        'title' => "UI_ALARM_LOG_DOWNLOAD",
                        'function' => array(
                            '5-downLoadPassFile',
    ...
    array(
        ...
        'class' => "viconfont vicon-a-Check-correctduigou1",
        'title' => "UI_VM_MACHINE_PLATFORM",
        'level' => 0,
        'child' => array(
            array(
                'name' => "vm_machine_manager",
    ...
    array(
        ...
        'path' => "./content/platform/industry/report_list.php",
        'class' => "viconfont vicon-baogao",
        'title' => "WEB_INDUSTRY_REPORT",
        'level' => 0,
        'child' => array(
            // 待审批
            array(
                'name' => "p_industry_report_pending",
                'path' => "./content/platform/industry/report_list_pending.php",
                'class' => "viconfont vicon-a-Group1000003105",
                'title' => "UI_GMP_REPORT_PENDING",
                'level' => 1,
                'child' => array(
                    // 查看
                    array(
                        'name' => "p_industry_report_pending_list",
                        'title' => "UI_PUBLIC_LOOK",
                        'function' => array(
                        ),
                        'level' => 10,
                    ...
                    // edit
                    array(
                        'name' => "p_industry_report_pending_edit",
                        'title' => "UI_VERIFY_REPORT_TEMPLATE_EDIT",
                        'function' => array(
                        ),
                        'level' => 10,
                        'is_operate' => 1,
                    ...
                    // 审批
                    array(
                        'name' => "p_industry_report_pending_approve",
                    ...
                    // 更改审批流
                    array(
                        'name' => "p_industry_report_pending_approve_change",
                        'title' => "UI_GMP_APPROVAL_CHANGE",
                        'function' => array(
                        ),
                        'level' => 10,
                        'is_operate' => 1,
                    ...
                    // 更改审批人
                    array(
                        'name' => "p_industry_report_pending_approve_user_change",
                        'title' => "UI_GMP_APPROVAL_USER_CHANGE",
                        'function' => array(
                        ),
                        'level' => 10,
                        'is_operate' => 1,
                    ...
                    // 撤销
                    array(
                        'name' => "p_industry_report_pending_approve_back",
                    ...
                    // 分享
                    array(
                        'name' => "p_industry_report_pending_share",
                        'title' => "UI_GMP_REPORT_SHARE",
                        'function' => array(
                        ),
                        'level' => 10,
                        'is_operate' => 1,
                    ...
                    // 查看评论
                    array(
                        'name' => "p_industry_report_pending_look_comment",
                        'title' => "UI_GMP_REPORT_COMMENT_VIEW",
                        'function' => array(
                        ),
                        'level' => 10,
                        'is_operate' => 1,
            ...
            // 已归档
            array(
                'name' => "p_industry_report_archived",
                'path' => "./content/platform/industry/report_list_archived.php",
                'class' => "viconfont vicon-shenpiguidang",
                'title' => "UI_GMP_REPORT_ARCHIVED",
                'level' => 1,
                'child' => array(
                    // 查看
                    array(
                        'name' => "p_industry_report_archived_list",
                        'title' => "UI_PUBLIC_LOOK",
                        'function' => array(
                        ),
                        'level' => 10,
                    ...
                    // 下载
                    array(
                        'name' => "p_industry_report_archived_download",
                    ...
                    // 审批流程
                    array(
                        'name' => "p_industry_report_archived_approve",
                        'title' => "WEB_INDUSTRY_APPROVAL_LIST",
                        'function' => array(
                        ),
                        'level' => 10,
                        'is_operate' => 1,
                    ...
                    // 查看评论
                    array(
                        'name' => "p_industry_report_archived_comment",
                        'title' => "UI_GMP_REPORT_COMMENT_VIEW",
                        'function' => array(
                        ),
                        'level' => 10,
            ...
            // 分享/抄送
            array(
                'name' => "p_industry_report_share",
                'path' => "./content/platform/industry/report_list_share.php",
                'class' => "viconfont vicon-fenxiang",
                'title' => "UI_GMP_REPORT_SHARE_OR_COPYSEND",
                'level' => 1,
                'child' => array(
                    // 查看
                    array(
                        'name' => "p_industry_report_share_list",
                        'title' => "UI_PUBLIC_LOOK",
                        'function' => array(
                        ),
                        'level' => 10,
                    ...
                    // 评论
                    array(
                        'name' => "p_industry_report_share_operation",
                        'title' => "UI_PUBLIC_OPERATION",
                        'function' => array(
                        ),
                        'level' => 10,
    ...
    array(
        ...
        'path' => "javascript:;",
        'class' => "viconfont vicon-a-File-editing-onebianjiwenjian1",
        ...
        'child' => array(
            // 报告模板
            array(
                'name' => "industry_template_list",
                'title' => "WEB_INDUSTRY_TEMPLATE_REPORT",
                'class' => "viconfont vicon-a-File-editing-onebianjiwenjian1",
                'path' => "./content/platform/industry/template_list.php",
                'level' => 1,
                'child' => array(
                    // 查看
                    array(
                    ...
                    // 修改
                    array(
                        'name' => "p_industry_template_modify",
                        'title' => "UI_PUBLIC_MODIFY",
                        'function' => array(
                        ),
                        'level' => 10,
            ...
            array(
                'name' => "industry_plan",
                'path' => "./content/platform/industry/plan_list.php",
                'class' => "viconfont vicon-fangan",
                'title' => "UI_INDUSTRY_PLAN",
                'level' => 1,
                'child' => array(
                    // 数据验证
                    array(
                        'name' => "p_industry_plan",
                        'path' => "./content/platform/industry/plan_list_data.php",
                        'class' => "viconfont vicon-a-Group1000003105",
                        'title' => "UI_INDUSTRY_PLAN_DATA",
                        'level' => 2,
                        'child' => array(
                            // 方案详情 查看
                            array(
                                'name' => "p_industry_plan_list",
                                'title' => "UI_PUBLIC_LOOK",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 查看子版本
                            array(
                                'name' => "p_industry_plan_look_version",
                                'title' => "UI_INDUSTRY_PLAN_LOOK_VERSION",
                                'function' => array(
                                ),
                                'level' => 10,
                                'is_operate' => 1,
                            ...
                            // 查看审批流
                            array(
                                'name' => "p_industry_plan_approve_look",
                                'title' => "UI_GMP_APPROVAL_LOOK",
                                'function' => array(
                                ),
                                'level' => 10,
                                'is_operate' => 1,
                            ...
                            // 更改审批流
                            array(
                                'name' => "p_industry_plan_approve_change",
                                'title' => "UI_GMP_APPROVAL_CHANGE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 更改审批人
                            array(
                                'name' => "p_industry_plan_approve_user_change",
                                'title' => "UI_GMP_APPROVAL_USER_CHANGE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 撤销
                            array(
                                'name' => "p_industry_plan_approve_back",
                                'title' => "WEB_INDUSTRY_REVOKE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 查看评论
                            array(
                                'name' => "p_industry_plan_look_comment",
                                'title' => "UI_GMP_REPORT_COMMENT_VIEW",
                                'function' => array(
                                ),
                                'level' => 10,
                    ...
                    // 功能验证
                    /*array(
                        'name' => "p_industry_plan_function",
                        'path' => "./content/platform/industry/plan_list_function.php",
                        'class' => "viconfont vicon-a-Group1000003105",
                        'title' => "UI_INDUSTRY_PLAN_FUNCTION",
                        'level' => 2,
                        'child' => array(
                            // 方案详情
                            array(
                                'name' => "p_industry_plan_list_function",
                                'title' => "UI_INDUSTRY_PLAN_DETAIL",
                                'function' => array(
                                ),
                                'level' => 10,
                            ),
                            // 新建
                            array(
                                'name' => "p_industry_plan_add_function",
                                'title' => "UI_PUBLIC_ADD",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 编辑
                            array(
                                'name' => "p_industry_plan_edit_function",
                                'title' => "UI_VERIFY_REPORT_TEMPLATE_EDIT",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 复制
                            array(
                                'name' => "p_industry_plan_copy_function",
                                'title' => "UI_PUBLIC_COPY",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 查看子版本
                            array(
                                'name' => "p_industry_plan_look_version_function",
                                'title' => "UI_INDUSTRY_PLAN_LOOK_VERSION",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 审批
                            array(
                                'name' => "p_industry_plan_approve_function",
                                'title' => "WEB_INDUSTRY_APPROVE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 查看审批流
                            array(
                                'name' => "p_industry_plan_approve_look_function",
                                'title' => "UI_GMP_APPROVAL_LOOK",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 更改审批流
                            array(
                                'name' => "p_industry_plan_approve_change_function",
                                'title' => "UI_GMP_APPROVAL_CHANGE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 更改审批人
                            array(
                                'name' => "p_industry_plan_approve_user_change_function",
                                'title' => "UI_GMP_APPROVAL_USER_CHANGE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 撤销
                            array(
                                'name' => "p_industry_plan_approve_back_function",
                                'title' => "WEB_INDUSTRY_REVOKE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 分享
                             array(
                                 'name' => "p_industry_plan_share_function",
                                 'title' => "UI_GMP_REPORT_SHARE",
                                 'function' => array(
                                 ),
                                 'level' => 10,
                             ...
                             // 查看评论
                             array(
                                 'name' => "p_industry_plan_look_comment_function",
                                 'title' => "UI_GMP_REPORT_COMMENT_VIEW",
                                 'function' => array(
                                 ),
                                 'level' => 10,
                    ...
                    /*array(
                        'name' => "p_industry_plan_share",
                        'path' => "./content/platform/industry/plan_list_share.php",
                        'class' => "viconfont vicon-fenxiang",
                        'title' => "UI_GMP_REPORT_SHARE_OR_COPYSEND",
                        'level' => 2,
                        'child' => array(
                            // 方案详情
                            array(
                                'name' => "p_industry_plan_share_list",
                                'title' => "UI_INDUSTRY_PLAN_DETAIL",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 评论
                            array(
                                'name' => "p_industry_plan_share_operation",
                                'title' => "UI_PUBLIC_OPERATION",
                                'function' => array(
                                ),
                                'level' => 10,
            ...
            // 审批流程
            array(
                'name' => "industry_approval",
                'title' => "WEB_INDUSTRY_APPROVAL_LIST",
                'class' => "viconfont vicon-shenpiliu",
                'path' => "./content/platform/industry/approval.php",
                'level' => 1,
                'child' => array(
                    // 流程管理
                    array(
                        'name' => "industry_approval_list",
                        'title' => "WEB_INDUSTRY_APPROVAL_LIST",
                        'class' => "viconfont vicon-shenpiliu",
                        'level' => 2,
                        'child' => array(
                            ...
                            // 修改
                            array(
                                'name' => "p_industry_approval_modify",
                                'title' => "UI_PUBLIC_MODIFY",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 启用
                            array(
                                'name' => "p_industry_approval_enable",
                                'title' => "WEB_PLATFORM_ENABLE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 禁用
                            array(
                                'name' => "p_industry_approval_disable",
                                'title' => "WEB_PLATFORM_DISABLE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 删除
                            array(
                                'name' => "p_industry_approval_delete",
                                'title' => "UI_PUBLIC_DELETE",
                                'function' => array(
                                ),
                                'level' => 10,
                    ...
                    // 分组管理
                    array(
                        'name' => "industry_approval_group",
                        'title' => "WEB_INDUSTRY_APPROVAL_CLASSIFY",
                        'class' => "viconfont vicon-fenlei",
                        'level' => 2,
                        'child' => array(
                            // 查看
                            array(
                                'name' => "p_industry_approval_group_list",
                                'title' => "UI_PUBLIC_LOOK",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 新建
                            array(
                                'name' => "p_industry_approval_group_add",
                                'title' => "UI_PUBLIC_ADD",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 修改
                            array(
                                'name' => "p_industry_approval_group_modify",
                                'title' => "UI_PUBLIC_MODIFY",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 启用
                            array(
                                'name' => "p_industry_approval_group_enable",
                                'title' => "WEB_PLATFORM_ENABLE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 禁用
                            array(
                                'name' => "p_industry_approval_group_disable",
                                'title' => "WEB_PLATFORM_DISABLE",
                                'function' => array(
                                ),
                                'level' => 10,
                            ...
                            // 删除
                            array(
                                'name' => "p_industry_approval_group_delete",
                                'title' => "UI_PUBLIC_DELETE",
                                'function' => array(
                                ),
                                'level' => 10,
    ...
    array(
        'name' => "data_manager",
        'path' => "javascript:;",
        'class' => "viconfont vicon-a-Data-fourshuju",
        'title' => "UI_PALTFORM_DATE_PROTECTION",
        'level' => 0,
        'showChild' => true,
        'child' => array(
            //任务
                    ...
                    array(
                        ...
                        'child' => array(
                            ...
                            array(
                                ...
                                'class' => "viconfont vicon-overview-m365",
    ...
    array(
        ...
        'class' => "viconfont vicon-a-Serverfuwuqi",
        'title' => "UI_EQUIQMENT_MANAGER",
        'level' => 0,
        'child' => array(
            // 客户端管理
            array(
    ...
    array(
        ...
        'child' => array(
                    ...
                    array(
                        ...
                        'child' => array(
                            ...
                            array(
                                ...
                                'path' => "./content/platform/storage/storage.php",
                                'class' => "viconfont vicon-beifencunchu",
                                'title' => "UI_PLATFORM_STORAGE_BACKUP",
                                'level' => 3,
                                'child' => array(
            ...
            array(
                ...
                'title' => "UI_PLATFORM_VERIFICATION_RESOURCE",
                'level' => 1,
                'showChild' => true,
                'child' => array(
                    // 虚拟实验室
    ...
    array(
        'name' => "sysmanagement",
        'path' => "javascript:;",
        'class' => "viconfont vicon-a-Setting-twoshezhi",
            ...
            array(
                ...
                'child' => array(
                    ...
                    array(
                        ...
                        'title' => "UI_PLATFORM_PERSONAL_CONFIG",
                        'class' => "viconfont vicon-setting_manager",
                        'level' => 2,
                        'is_operate' => 1,
                        'child' => array(
                            // 操作
                            array(
                                'name' => "p_setting_manager_settings",
                                'title' => "UI_PUBLIC_OPERATION",
                                'function' => array(
                                ),
                                'level' => 10,
                ...
                'child' => array(
                    ...
                    array(
                        ...
                        'child' => array(
                            ...
                            // 重置独立密码
                            array(
                                'name' => "p_safety_user_reset_safe_pwd",
                                'title' => "UI_USER_RESET_SAFE_PWD",
                                'function' => array(
