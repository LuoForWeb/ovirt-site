var CurrentJob = function () {
    ...
    const addListeners = function () {
        ...
        //批量操作
        $(".batchOperation").on('click', '.batch_start_active', batchStart);
        $(".batchOperation").on('click', '.batch_stop_active', batchStop);
        $(".batchOperation").on('click', '.batch_delete_active', batchDelete);
