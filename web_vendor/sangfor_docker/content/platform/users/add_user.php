...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
<?php echo $LANG['UI_USER_NEW_USER']?> <small><?php echo $LANG['UI_USER_NEW_USER_DESCRIPTION']?></small>
</h3>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="row">
				...
				<form action="#" id="form_sample_2" class="form-horizontal">
					<div class="form-body">
						...
						<div id="user-auth" >
    							...
    							* </span>
    							...
    							<div class="col-md-4">
    								<div class="radio-list">
    									...
    									<input type="radio" name="auth_type" checked value="1"/>
    						...
    						<div class="form-group display-none auth">
