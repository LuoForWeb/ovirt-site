        ...
        <div class="content">
            ...
            <div class="contentlogin">
                ...
                <form class="forget-form" action="index.html" method="post"
                      style="padding-top: 1.5rem;font-size: 14px;position:relative;width: 400px;margin: 0 auto;">
                    <div style="width: 400px;height: 116px;font-size: 14px;color:#495060;text-align: center;background: rgba(23,193,197,0.1);border-radius: 4px 4px 4px 4px !important;margin-bottom: 55px;padding-top: 40px;">
                        恭喜您，系统已成功向您的邮箱发送说明！<br>请移至邮箱操作
                    </div>
                    <div class="form-actions">
                        <button class="btn blue btn-green"
                                style="width: 252px; font-size: 16px;background: #40BAC1; padding: 15px 0;color:#fff;border-radius: 4px !important;float: right">
                            <a href="/login.php" style="color: #FFFFFF">返回登录页面</a>
                        </button>
                        <button class="btn btn-white"
                                style="width: 134px; font-size: 16px;background: #F0F0F0; padding: 15px 0;border-radius: 4px !important;float: right;margin-right: 14px">
                            <i class="viconfont vicon-arrow"></i>
                            <a href="./forget_pwd.php" style="color: #495060">上一步</a>
                        </button>
        ...
        <div class="content">
            ...
            <div class="contentlogin">
                ...
                <form class="forget-form" action="index.html" method="post"
                    ...
                    <div style="width: 400px;height: 116px;font-size: 14px;color:#495060;text-align: center;background: rgba(23,193,197,0.1);border-radius: 4px 4px 4px 4px !important;margin-bottom: 55px;padding-top: 40px;">
                        恭喜您，密码重置成功！<br> <span class="second"></span>秒后自动跳转至登录页面
                    </div>
                    <div class="form-actions">
                        <button class="btn blue btn-green"
                                style="width: 400px; background: #40BAC1; padding: 15px 0;font-size: 16px;color:#fff;border-radius: 4px !important;float: right">
                            <a href="./login.php" style="color: #FFFFFF">立即登录</a>
                        </button>
                    </div>
                </form>
                <!-- END LOGIN FORM -->
