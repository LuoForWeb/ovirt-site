    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                checkbox:true,
                dataTable: {
                    // dom定义表格控件在页面的显示顺序,每个控件元素在数据表都有一个关联的单个字母
                    "dom": "<'row'<'col-md-12'B>><'table-scrollable't><'row table-page'<'col-md-12 page-right' iplpi>r>", // datatable layout
...
//                        "metronicGroupActions": "_TOTAL_ records selected:  ",
                        ...
                        "lengthMenu": LANG.UI_TOOLS_TABLE_LENGTH_MENU_SANGFOR,
                        "info": LANG.UI_TOOLS_TABLE_INFO_SANGFOR,
                        "infoEmpty": "",
                        ...
                        "paginate": {
                            ...
                            "pageOf": LANG.UI_TOOLS_TOTAL_SANGFOR
                        }
                    },
